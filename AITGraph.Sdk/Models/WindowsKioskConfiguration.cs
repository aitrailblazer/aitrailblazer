...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class WindowsKioskConfiguration : global::AITGraph.Sdk.Models.DeviceConfiguration, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.WindowsKioskProfile>? KioskProfiles { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.WindowsKioskProfile> KioskProfiles { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.WindowsKioskForceUpdateSchedule? WindowsKioskForceUpdateSchedule { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.WindowsKioskForceUpdateSchedule WindowsKioskForceUpdateSchedule { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.WindowsKioskConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.WindowsKioskConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.WindowsKioskConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.WindowsKioskConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "kioskProfiles", n => { KioskProfiles = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.WindowsKioskProfile>(global::AITGraph.Sdk.Models.WindowsKioskProfile.CreateFromDiscriminatorValue)?.AsList(); } },
                { "windowsKioskForceUpdateSchedule", n => { WindowsKioskForceUpdateSchedule = n.GetObjectValue<global::AITGraph.Sdk.Models.WindowsKioskForceUpdateSchedule>(global::AITGraph.Sdk.Models.WindowsKioskForceUpdateSchedule.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.WindowsKioskProfile>("kioskProfiles", KioskProfiles);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.WindowsKioskForceUpdateSchedule>("windowsKioskForceUpdateSchedule", WindowsKioskForceUpdateSchedule);
        }
    }
}
