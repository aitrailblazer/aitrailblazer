...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Security.ExportFileMetadata? ExportFileMetadata { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Security.ExportFileMetadata ExportFileMetadata { get; set; }
#endif
        ...
        public AITGraph.Sdk.Models.Security.ExportOptions? ExportOptions { get; set; }
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"exportFileMetadata", n => { ExportFileMetadata = n.GetObjectValue<AITGraph.Sdk.Models.Security.ExportFileMetadata>(AITGraph.Sdk.Models.Security.ExportFileMetadata.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Security.ExportFileMetadata>("exportFileMetadata", ExportFileMetadata);
