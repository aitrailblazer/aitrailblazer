...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.FileHash? FileHash { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.FileHash FileHash { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"fileHash", n => { FileHash = n.GetObjectValue<AITGraph.Sdk.Models.FileHash>(AITGraph.Sdk.Models.FileHash.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.FileHash>("fileHash", FileHash);
