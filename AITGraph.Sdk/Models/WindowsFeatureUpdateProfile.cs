...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class WindowsFeatureUpdateProfile : global::AITGraph.Sdk.Models.Entity, IParsable
    {
        /// <summary>The list of group assignments of the profile.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.WindowsFeatureUpdateProfileAssignment>? Assignments { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.WindowsFeatureUpdateProfileAssignment> Assignments { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.WindowsUpdateRolloutSettings? RolloutSettings { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.WindowsUpdateRolloutSettings RolloutSettings { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.WindowsFeatureUpdateProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.WindowsFeatureUpdateProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.WindowsFeatureUpdateProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "assignments", n => { Assignments = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.WindowsFeatureUpdateProfileAssignment>(global::AITGraph.Sdk.Models.WindowsFeatureUpdateProfileAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "rolloutSettings", n => { RolloutSettings = n.GetObjectValue<global::AITGraph.Sdk.Models.WindowsUpdateRolloutSettings>(global::AITGraph.Sdk.Models.WindowsUpdateRolloutSettings.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.WindowsFeatureUpdateProfileAssignment>("assignments", Assignments);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.WindowsUpdateRolloutSettings>("rolloutSettings", RolloutSettings);
        }
    }
}
