...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class CloudPcSnapshot : global::AITGraph.Sdk.Models.Entity, IParsable
...
#nullable restore
        ...
        /// <summary>The snapshotType property</summary>
        public global::AITGraph.Sdk.Models.CloudPcSnapshotType? SnapshotType { get; set; }
        /// <summary>The status of the Cloud PC snapshot. The possible values are: ready, unknownFutureValue.</summary>
        public global::AITGraph.Sdk.Models.CloudPcSnapshotStatus? Status { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.CloudPcSnapshot"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.CloudPcSnapshot CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.CloudPcSnapshot();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "snapshotType", n => { SnapshotType = n.GetEnumValue<global::AITGraph.Sdk.Models.CloudPcSnapshotType>(); } },
                { "status", n => { Status = n.GetEnumValue<global::AITGraph.Sdk.Models.CloudPcSnapshotStatus>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.CloudPcSnapshotType>("snapshotType", SnapshotType);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.CloudPcSnapshotStatus>("status", Status);
        }
    }
}
