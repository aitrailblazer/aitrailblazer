...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class GroupPolicyMigrationReport : global::AITGraph.Sdk.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.GroupPolicySettingMapping>? GroupPolicySettingMappings { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.GroupPolicySettingMapping> GroupPolicySettingMappings { get; set; }
#endif
        ...
        public global::AITGraph.Sdk.Models.GroupPolicyMigrationReadiness? MigrationReadiness { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.UnsupportedGroupPolicyExtension>? UnsupportedGroupPolicyExtensions { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.UnsupportedGroupPolicyExtension> UnsupportedGroupPolicyExtensions { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.GroupPolicyMigrationReport"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.GroupPolicyMigrationReport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.GroupPolicyMigrationReport();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "groupPolicySettingMappings", n => { GroupPolicySettingMappings = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.GroupPolicySettingMapping>(global::AITGraph.Sdk.Models.GroupPolicySettingMapping.CreateFromDiscriminatorValue)?.AsList(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "migrationReadiness", n => { MigrationReadiness = n.GetEnumValue<global::AITGraph.Sdk.Models.GroupPolicyMigrationReadiness>(); } },
                ...
                { "unsupportedGroupPolicyExtensions", n => { UnsupportedGroupPolicyExtensions = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.UnsupportedGroupPolicyExtension>(global::AITGraph.Sdk.Models.UnsupportedGroupPolicyExtension.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.GroupPolicySettingMapping>("groupPolicySettingMappings", GroupPolicySettingMappings);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.GroupPolicyMigrationReadiness>("migrationReadiness", MigrationReadiness);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.UnsupportedGroupPolicyExtension>("unsupportedGroupPolicyExtensions", UnsupportedGroupPolicyExtensions);
        }
    }
}
