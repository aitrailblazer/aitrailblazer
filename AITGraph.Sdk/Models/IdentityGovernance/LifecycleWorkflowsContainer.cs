...
namespace AITGraph.Sdk.Models.IdentityGovernance {
    public class LifecycleWorkflowsContainer : AITGraph.Sdk.Models.Entity, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.DeletedItemContainer? DeletedItems { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.DeletedItemContainer DeletedItems { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"deletedItems", n => { DeletedItems = n.GetObjectValue<AITGraph.Sdk.Models.DeletedItemContainer>(AITGraph.Sdk.Models.DeletedItemContainer.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.DeletedItemContainer>("deletedItems", DeletedItems);
