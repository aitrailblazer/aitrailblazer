...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.Recipient>? FromAddresses { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.Recipient> FromAddresses { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.MessageActionFlag? MessageActionFlag { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.Recipient>? SentToAddresses { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.Recipient> SentToAddresses { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.SizeRange? WithinSizeRange { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.SizeRange WithinSizeRange { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.MessageRulePredicates"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.MessageRulePredicates"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.MessageRulePredicates CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.MessageRulePredicates();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "fromAddresses", n => { FromAddresses = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.Recipient>(global::AITGraph.Sdk.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "messageActionFlag", n => { MessageActionFlag = n.GetEnumValue<global::AITGraph.Sdk.Models.MessageActionFlag>(); } },
                ...
                { "sentToAddresses", n => { SentToAddresses = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.Recipient>(global::AITGraph.Sdk.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "withinSizeRange", n => { WithinSizeRange = n.GetObjectValue<global::AITGraph.Sdk.Models.SizeRange>(global::AITGraph.Sdk.Models.SizeRange.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.Recipient>("fromAddresses", FromAddresses);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.MessageActionFlag>("messageActionFlag", MessageActionFlag);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.Recipient>("sentToAddresses", SentToAddresses);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.SizeRange>("withinSizeRange", WithinSizeRange);
