...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class Agreement : global::AITGraph.Sdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Read-only. Information about acceptances of this agreement.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.AgreementAcceptance>? Acceptances { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AgreementAcceptance> Acceptances { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.AgreementFile? File { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AgreementFile File { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.AgreementFileLocalization>? Files { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AgreementFileLocalization> Files { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.TermsExpiration? TermsExpiration { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.TermsExpiration TermsExpiration { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Agreement"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.Agreement CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Agreement();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "acceptances", n => { Acceptances = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AgreementAcceptance>(global::AITGraph.Sdk.Models.AgreementAcceptance.CreateFromDiscriminatorValue)?.AsList(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "file", n => { File = n.GetObjectValue<global::AITGraph.Sdk.Models.AgreementFile>(global::AITGraph.Sdk.Models.AgreementFile.CreateFromDiscriminatorValue); } },
                { "files", n => { Files = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AgreementFileLocalization>(global::AITGraph.Sdk.Models.AgreementFileLocalization.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "termsExpiration", n => { TermsExpiration = n.GetObjectValue<global::AITGraph.Sdk.Models.TermsExpiration>(global::AITGraph.Sdk.Models.TermsExpiration.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AgreementAcceptance>("acceptances", Acceptances);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AgreementFile>("file", File);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AgreementFileLocalization>("files", Files);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.TermsExpiration>("termsExpiration", TermsExpiration);
