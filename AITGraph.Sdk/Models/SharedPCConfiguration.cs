...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class SharedPCConfiguration : global::AITGraph.Sdk.Models.DeviceConfiguration, IParsable
    {
...
#nullable enable
        public global::AITGraph.Sdk.Models.SharedPCAccountManagerPolicy? AccountManagerPolicy { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.SharedPCAccountManagerPolicy AccountManagerPolicy { get; set; }
#endif
        /// <summary>Type of accounts that are allowed to share the PC.</summary>
        public global::AITGraph.Sdk.Models.SharedPCAllowedAccountType? AllowedAccounts { get; set; }
        ...
        public global::AITGraph.Sdk.Models.Enablement? FastFirstSignIn { get; set; }
...
#nullable restore
...
#endif
        /// <summary>Possible values of a property</summary>
        public global::AITGraph.Sdk.Models.Enablement? LocalStorage { get; set; }
        /// <summary>Specifies the daily start time of maintenance hour.</summary>
        public Time? MaintenanceStartTime { get; set; }
        /// <summary>Possible values of a property</summary>
        public global::AITGraph.Sdk.Models.Enablement? SetAccountManager { get; set; }
        /// <summary>Possible values of a property</summary>
        public global::AITGraph.Sdk.Models.Enablement? SetEduPolicies { get; set; }
        /// <summary>Possible values of a property</summary>
        public global::AITGraph.Sdk.Models.Enablement? SetPowerPolicies { get; set; }
        /// <summary>Possible values of a property</summary>
        public global::AITGraph.Sdk.Models.Enablement? SignInOnResume { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.SharedPCConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.SharedPCConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.SharedPCConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.SharedPCConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "accountManagerPolicy", n => { AccountManagerPolicy = n.GetObjectValue<global::AITGraph.Sdk.Models.SharedPCAccountManagerPolicy>(global::AITGraph.Sdk.Models.SharedPCAccountManagerPolicy.CreateFromDiscriminatorValue); } },
                { "allowLocalStorage", n => { AllowLocalStorage = n.GetBoolValue(); } },
                { "allowedAccounts", n => { AllowedAccounts = n.GetEnumValue<global::AITGraph.Sdk.Models.SharedPCAllowedAccountType>(); } },
                ...
                { "fastFirstSignIn", n => { FastFirstSignIn = n.GetEnumValue<global::AITGraph.Sdk.Models.Enablement>(); } },
                ...
                { "localStorage", n => { LocalStorage = n.GetEnumValue<global::AITGraph.Sdk.Models.Enablement>(); } },
                { "maintenanceStartTime", n => { MaintenanceStartTime = n.GetTimeValue(); } },
                { "setAccountManager", n => { SetAccountManager = n.GetEnumValue<global::AITGraph.Sdk.Models.Enablement>(); } },
                { "setEduPolicies", n => { SetEduPolicies = n.GetEnumValue<global::AITGraph.Sdk.Models.Enablement>(); } },
                { "setPowerPolicies", n => { SetPowerPolicies = n.GetEnumValue<global::AITGraph.Sdk.Models.Enablement>(); } },
                { "signInOnResume", n => { SignInOnResume = n.GetEnumValue<global::AITGraph.Sdk.Models.Enablement>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.SharedPCAccountManagerPolicy>("accountManagerPolicy", AccountManagerPolicy);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.SharedPCAllowedAccountType>("allowedAccounts", AllowedAccounts);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Enablement>("fastFirstSignIn", FastFirstSignIn);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Enablement>("localStorage", LocalStorage);
            writer.WriteTimeValue("maintenanceStartTime", MaintenanceStartTime);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Enablement>("setAccountManager", SetAccountManager);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Enablement>("setEduPolicies", SetEduPolicies);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Enablement>("setPowerPolicies", SetPowerPolicies);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Enablement>("signInOnResume", SignInOnResume);
        }
    }
}
