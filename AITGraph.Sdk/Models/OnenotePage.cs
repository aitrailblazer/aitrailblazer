...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class OnenotePage : global::AITGraph.Sdk.Models.OnenoteEntitySchemaObjectModel, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.PageLinks? Links { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.PageLinks Links { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.OnenoteSection? ParentSection { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.OnenoteSection ParentSection { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.OnenotePage"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.OnenotePage"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.OnenotePage CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.OnenotePage();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "links", n => { Links = n.GetObjectValue<global::AITGraph.Sdk.Models.PageLinks>(global::AITGraph.Sdk.Models.PageLinks.CreateFromDiscriminatorValue); } },
                ...
                { "parentSection", n => { ParentSection = n.GetObjectValue<global::AITGraph.Sdk.Models.OnenoteSection>(global::AITGraph.Sdk.Models.OnenoteSection.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.PageLinks>("links", Links);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.OnenoteSection>("parentSection", ParentSection);
