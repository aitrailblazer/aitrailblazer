...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AndroidForWorkVpnConfiguration : global::AITGraph.Sdk.Models.DeviceConfiguration, IParsable
    {
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.AndroidForWorkVpnConnectionType? ConnectionType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.AndroidForWorkCertificateProfileBase? IdentityCertificate { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AndroidForWorkCertificateProfileBase IdentityCertificate { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.AndroidForWorkVpnConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AndroidForWorkVpnConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.AndroidForWorkVpnConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AndroidForWorkVpnConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "connectionType", n => { ConnectionType = n.GetEnumValue<global::AITGraph.Sdk.Models.AndroidForWorkVpnConnectionType>(); } },
                ...
                { "identityCertificate", n => { IdentityCertificate = n.GetObjectValue<global::AITGraph.Sdk.Models.AndroidForWorkCertificateProfileBase>(global::AITGraph.Sdk.Models.AndroidForWorkCertificateProfileBase.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AndroidForWorkVpnConnectionType>("connectionType", ConnectionType);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AndroidForWorkCertificateProfileBase>("identityCertificate", IdentityCertificate);
