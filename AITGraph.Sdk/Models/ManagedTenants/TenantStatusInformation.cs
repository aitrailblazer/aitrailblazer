...
namespace AITGraph.Sdk.Models.ManagedTenants
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::AITGraph.Sdk.Models.ManagedTenants.DelegatedPrivilegeStatus? DelegatedPrivilegeStatus { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.ManagedTenants.TenantOnboardingStatus? OnboardingStatus { get; set; }
        ...
        public global::AITGraph.Sdk.Models.ManagedTenants.TenantOnboardingEligibilityReason? TenantOnboardingEligibilityReason { get; set; }
        /// <summary>The collection of workload statues for the managed tenant. Optional. Read-only.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.ManagedTenants.WorkloadStatus>? WorkloadStatuses { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.ManagedTenants.WorkloadStatus> WorkloadStatuses { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.ManagedTenants.TenantStatusInformation"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.ManagedTenants.TenantStatusInformation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.ManagedTenants.TenantStatusInformation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.ManagedTenants.TenantStatusInformation();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "delegatedPrivilegeStatus", n => { DelegatedPrivilegeStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedTenants.DelegatedPrivilegeStatus>(); } },
                ...
                { "onboardingStatus", n => { OnboardingStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedTenants.TenantOnboardingStatus>(); } },
                { "tenantOnboardingEligibilityReason", n => { TenantOnboardingEligibilityReason = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedTenants.TenantOnboardingEligibilityReason>(); } },
                { "workloadStatuses", n => { WorkloadStatuses = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.ManagedTenants.WorkloadStatus>(global::AITGraph.Sdk.Models.ManagedTenants.WorkloadStatus.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedTenants.DelegatedPrivilegeStatus>("delegatedPrivilegeStatus", DelegatedPrivilegeStatus);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedTenants.TenantOnboardingStatus>("onboardingStatus", OnboardingStatus);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedTenants.TenantOnboardingEligibilityReason>("tenantOnboardingEligibilityReason", TenantOnboardingEligibilityReason);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.ManagedTenants.WorkloadStatus>("workloadStatuses", WorkloadStatuses);
