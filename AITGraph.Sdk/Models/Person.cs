...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class Person : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.RankedEmailAddress>? EmailAddresses { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.RankedEmailAddress> EmailAddresses { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.Location>? PostalAddresses { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.Location> PostalAddresses { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.PersonDataSource>? Sources { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.PersonDataSource> Sources { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.Website>? Websites { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.Website> Websites { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Person"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.Person CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Person();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "emailAddresses", n => { EmailAddresses = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.RankedEmailAddress>(global::AITGraph.Sdk.Models.RankedEmailAddress.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "postalAddresses", n => { PostalAddresses = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.Location>(global::AITGraph.Sdk.Models.Location.CreateFromDiscriminatorValue)?.AsList(); } },
                { "profession", n => { Profession = n.GetStringValue(); } },
                { "sources", n => { Sources = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.PersonDataSource>(global::AITGraph.Sdk.Models.PersonDataSource.CreateFromDiscriminatorValue)?.AsList(); } },
                { "surname", n => { Surname = n.GetStringValue(); } },
                { "title", n => { Title = n.GetStringValue(); } },
                { "userPrincipalName", n => { UserPrincipalName = n.GetStringValue(); } },
                { "websites", n => { Websites = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.Website>(global::AITGraph.Sdk.Models.Website.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.RankedEmailAddress>("emailAddresses", EmailAddresses);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.Location>("postalAddresses", PostalAddresses);
            writer.WriteStringValue("profession", Profession);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.PersonDataSource>("sources", Sources);
            writer.WriteStringValue("surname", Surname);
            writer.WriteStringValue("title", Title);
            writer.WriteStringValue("userPrincipalName", UserPrincipalName);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.Website>("websites", Websites);
