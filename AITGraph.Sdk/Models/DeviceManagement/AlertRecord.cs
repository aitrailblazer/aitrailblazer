...
namespace AITGraph.Sdk.Models.DeviceManagement {
    public class AlertRecord : AITGraph.Sdk.Models.Entity, IParsable {
...
#nullable enable
        public AITGraph.Sdk.Models.DeviceManagement.AlertImpact? AlertImpact { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.DeviceManagement.AlertImpact AlertImpact { get; set; }
#endif
...
#nullable restore
        ...
        public AITGraph.Sdk.Models.DeviceManagement.AlertRuleTemplate? AlertRuleTemplate { get; set; }
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"alertImpact", n => { AlertImpact = n.GetObjectValue<AITGraph.Sdk.Models.DeviceManagement.AlertImpact>(AITGraph.Sdk.Models.DeviceManagement.AlertImpact.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.DeviceManagement.AlertImpact>("alertImpact", AlertImpact);
