...
#nullable enable
        public List<global::AITGraph.Sdk.Models.StringKeyStringValuePair>? ApiExpressions { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.StringKeyStringValuePair> ApiExpressions { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.Mutability? Mutability { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.ReferencedObject>? ReferencedObjects { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.ReferencedObject> ReferencedObjects { get; set; }
#endif
        ...
        public global::AITGraph.Sdk.Models.AttributeType? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.AttributeDefinition"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AttributeDefinition"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.AttributeDefinition CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AttributeDefinition();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "apiExpressions", n => { ApiExpressions = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.StringKeyStringValuePair>(global::AITGraph.Sdk.Models.StringKeyStringValuePair.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "mutability", n => { Mutability = n.GetEnumValue<global::AITGraph.Sdk.Models.Mutability>(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "referencedObjects", n => { ReferencedObjects = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.ReferencedObject>(global::AITGraph.Sdk.Models.ReferencedObject.CreateFromDiscriminatorValue)?.AsList(); } },
                { "required", n => { Required = n.GetBoolValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::AITGraph.Sdk.Models.AttributeType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.StringKeyStringValuePair>("apiExpressions", ApiExpressions);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Mutability>("mutability", Mutability);
            writer.WriteStringValue("name", Name);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.ReferencedObject>("referencedObjects", ReferencedObjects);
            writer.WriteBoolValue("required", Required);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AttributeType>("type", Type);
