...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Json? Layout { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Json Layout { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"layout", n => { Layout = n.GetObjectValue<AITGraph.Sdk.Models.Json>(AITGraph.Sdk.Models.Json.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Json>("layout", Layout);
