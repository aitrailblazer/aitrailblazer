...
namespace AITGraph.Sdk.Models.ManagedTenants {
    public class ManagedTenantAlert : AITGraph.Sdk.Models.Entity, IParsable {
        /// <summary>The alertData property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ManagedTenants.AlertData? AlertData { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ManagedTenants.AlertData AlertData { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"alertData", n => { AlertData = n.GetObjectValue<AITGraph.Sdk.Models.ManagedTenants.AlertData>(AITGraph.Sdk.Models.ManagedTenants.AlertData.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ManagedTenants.AlertData>("alertData", AlertData);
