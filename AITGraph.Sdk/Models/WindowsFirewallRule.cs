...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class WindowsFirewallRule : IAdditionalDataHolder, IParsable
    {
        /// <summary>State Management Setting.</summary>
        public global::AITGraph.Sdk.Models.StateManagementSetting? Action { get; set; }
...
#endif
        /// <summary>State Management Setting.</summary>
        public global::AITGraph.Sdk.Models.StateManagementSetting? EdgeTraversal { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.WindowsFirewallRuleInterfaceTypes? InterfaceTypes { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.WindowsFirewallRuleNetworkProfileTypes? ProfileTypes { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.WindowsFirewallRuleTrafficDirectionType? TrafficDirection { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.WindowsFirewallRule"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.WindowsFirewallRule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.WindowsFirewallRule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.WindowsFirewallRule();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "action", n => { Action = n.GetEnumValue<global::AITGraph.Sdk.Models.StateManagementSetting>(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "edgeTraversal", n => { EdgeTraversal = n.GetEnumValue<global::AITGraph.Sdk.Models.StateManagementSetting>(); } },
                { "filePath", n => { FilePath = n.GetStringValue(); } },
                { "interfaceTypes", n => { InterfaceTypes = n.GetEnumValue<global::AITGraph.Sdk.Models.WindowsFirewallRuleInterfaceTypes>(); } },
                { "localAddressRanges", n => { LocalAddressRanges = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "localPortRanges", n => { LocalPortRanges = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                ...
                { "profileTypes", n => { ProfileTypes = n.GetEnumValue<global::AITGraph.Sdk.Models.WindowsFirewallRuleNetworkProfileTypes>(); } },
                { "protocol", n => { Protocol = n.GetIntValue(); } },
                { "remoteAddressRanges", n => { RemoteAddressRanges = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "remotePortRanges", n => { RemotePortRanges = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "serviceName", n => { ServiceName = n.GetStringValue(); } },
                { "trafficDirection", n => { TrafficDirection = n.GetEnumValue<global::AITGraph.Sdk.Models.WindowsFirewallRuleTrafficDirectionType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.StateManagementSetting>("action", Action);
            writer.WriteStringValue("description", Description);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.StateManagementSetting>("edgeTraversal", EdgeTraversal);
            writer.WriteStringValue("filePath", FilePath);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WindowsFirewallRuleInterfaceTypes>("interfaceTypes", InterfaceTypes);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WindowsFirewallRuleNetworkProfileTypes>("profileTypes", ProfileTypes);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WindowsFirewallRuleTrafficDirectionType>("trafficDirection", TrafficDirection);
