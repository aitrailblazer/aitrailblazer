...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class SecureScoreControlProfile : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.ComplianceInformation>? ComplianceInformation { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.ComplianceInformation> ComplianceInformation { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.SecureScoreControlStateUpdate>? ControlStateUpdates { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.SecureScoreControlStateUpdate> ControlStateUpdates { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.SecureScoreControlProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.SecureScoreControlProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.SecureScoreControlProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "complianceInformation", n => { ComplianceInformation = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.ComplianceInformation>(global::AITGraph.Sdk.Models.ComplianceInformation.CreateFromDiscriminatorValue)?.AsList(); } },
                { "controlCategory", n => { ControlCategory = n.GetStringValue(); } },
                { "controlStateUpdates", n => { ControlStateUpdates = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.SecureScoreControlStateUpdate>(global::AITGraph.Sdk.Models.SecureScoreControlStateUpdate.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.ComplianceInformation>("complianceInformation", ComplianceInformation);
            writer.WriteStringValue("controlCategory", ControlCategory);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.SecureScoreControlStateUpdate>("controlStateUpdates", ControlStateUpdates);
