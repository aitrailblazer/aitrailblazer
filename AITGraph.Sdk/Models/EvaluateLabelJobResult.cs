...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ResponsiblePolicy? ResponsiblePolicy { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ResponsiblePolicy ResponsiblePolicy { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"responsiblePolicy", n => { ResponsiblePolicy = n.GetObjectValue<AITGraph.Sdk.Models.ResponsiblePolicy>(AITGraph.Sdk.Models.ResponsiblePolicy.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ResponsiblePolicy>("responsiblePolicy", ResponsiblePolicy);
