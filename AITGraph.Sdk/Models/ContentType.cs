...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.DocumentSet? DocumentSet { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.DocumentSet DocumentSet { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"documentSet", n => { DocumentSet = n.GetObjectValue<AITGraph.Sdk.Models.DocumentSet>(AITGraph.Sdk.Models.DocumentSet.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.DocumentSet>("documentSet", DocumentSet);
