...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class MacOSLobApp : global::AITGraph.Sdk.Models.MobileLobApp, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.MacOSLobChildApp>? ChildApps { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.MacOSLobChildApp> ChildApps { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.MacOSLobApp"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.MacOSLobApp"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.MacOSLobApp CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.MacOSLobApp();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "childApps", n => { ChildApps = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.MacOSLobChildApp>(global::AITGraph.Sdk.Models.MacOSLobChildApp.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.MacOSLobChildApp>("childApps", ChildApps);
