...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class UserPFXCertificate : global::AITGraph.Sdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.UserPfxIntendedPurpose? IntendedPurpose { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.UserPfxPaddingScheme? PaddingScheme { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.UserPFXCertificate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.UserPFXCertificate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.UserPFXCertificate();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "intendedPurpose", n => { IntendedPurpose = n.GetEnumValue<global::AITGraph.Sdk.Models.UserPfxIntendedPurpose>(); } },
                { "keyName", n => { KeyName = n.GetStringValue(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "paddingScheme", n => { PaddingScheme = n.GetEnumValue<global::AITGraph.Sdk.Models.UserPfxPaddingScheme>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.UserPfxIntendedPurpose>("intendedPurpose", IntendedPurpose);
            writer.WriteStringValue("keyName", KeyName);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.UserPfxPaddingScheme>("paddingScheme", PaddingScheme);
