...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class ManagedAppProtection : global::AITGraph.Sdk.Models.ManagedAppPolicy, IParsable
    {
        /// <summary>Data storage locations where a user may store managed data.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.ManagedAppDataIngestionLocation?>? AllowedDataIngestionLocations { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.ManagedAppDataIngestionLocation?> AllowedDataIngestionLocations { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.ManagedAppDataStorageLocation?>? AllowedDataStorageLocations { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.ManagedAppDataStorageLocation?> AllowedDataStorageLocations { get; set; }
#endif
        /// <summary>Data can be transferred from/to these classes of apps</summary>
        public global::AITGraph.Sdk.Models.ManagedAppDataTransferLevel? AllowedInboundDataTransferSources { get; set; }
        ...
        public global::AITGraph.Sdk.Models.ManagedAppClipboardSharingLevel? AllowedOutboundClipboardSharingLevel { get; set; }
        /// <summary>Data can be transferred from/to these classes of apps</summary>
        public global::AITGraph.Sdk.Models.ManagedAppDataTransferLevel? AllowedOutboundDataTransferDestinations { get; set; }
        /// <summary>An admin initiated action to be applied on a managed app.</summary>
        public global::AITGraph.Sdk.Models.ManagedAppRemediationAction? AppActionIfDeviceComplianceRequired { get; set; }
        /// <summary>An admin initiated action to be applied on a managed app.</summary>
        public global::AITGraph.Sdk.Models.ManagedAppRemediationAction? AppActionIfMaximumPinRetriesExceeded { get; set; }
        ...
        public global::AITGraph.Sdk.Models.ManagedAppRemediationAction? AppActionIfUnableToAuthenticateUser { get; set; }
        ...
        public global::AITGraph.Sdk.Models.ManagedAppPhoneNumberRedirectLevel? DialerRestrictionLevel { get; set; }
        ...
        public global::AITGraph.Sdk.Models.ManagedBrowserType? ManagedBrowser { get; set; }
        ...
        public global::AITGraph.Sdk.Models.ManagedAppDeviceThreatLevel? MaximumAllowedDeviceThreatLevel { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.MobileThreatDefensePartnerPriority? MobileThreatDefensePartnerPriority { get; set; }
        /// <summary>An admin initiated action to be applied on a managed app.</summary>
        public global::AITGraph.Sdk.Models.ManagedAppRemediationAction? MobileThreatDefenseRemediationAction { get; set; }
        /// <summary>Restrict managed app notification</summary>
        public global::AITGraph.Sdk.Models.ManagedAppNotificationRestriction? NotificationRestriction { get; set; }
        ...
        public global::AITGraph.Sdk.Models.ManagedAppPinCharacterSet? PinCharacterSet { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.ManagedAppProtection"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.ManagedAppProtection"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.ManagedAppProtection CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::AITGraph.Sdk.Models.ManagedAppProtection(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedDataIngestionLocations", n => { AllowedDataIngestionLocations = n.GetCollectionOfEnumValues<global::AITGraph.Sdk.Models.ManagedAppDataIngestionLocation>()?.AsList(); } },
                { "allowedDataStorageLocations", n => { AllowedDataStorageLocations = n.GetCollectionOfEnumValues<global::AITGraph.Sdk.Models.ManagedAppDataStorageLocation>()?.AsList(); } },
                { "allowedInboundDataTransferSources", n => { AllowedInboundDataTransferSources = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedAppDataTransferLevel>(); } },
                { "allowedOutboundClipboardSharingExceptionLength", n => { AllowedOutboundClipboardSharingExceptionLength = n.GetIntValue(); } },
                { "allowedOutboundClipboardSharingLevel", n => { AllowedOutboundClipboardSharingLevel = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedAppClipboardSharingLevel>(); } },
                { "allowedOutboundDataTransferDestinations", n => { AllowedOutboundDataTransferDestinations = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedAppDataTransferLevel>(); } },
                { "appActionIfDeviceComplianceRequired", n => { AppActionIfDeviceComplianceRequired = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedAppRemediationAction>(); } },
                { "appActionIfMaximumPinRetriesExceeded", n => { AppActionIfMaximumPinRetriesExceeded = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedAppRemediationAction>(); } },
                { "appActionIfUnableToAuthenticateUser", n => { AppActionIfUnableToAuthenticateUser = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedAppRemediationAction>(); } },
                ...
                { "dialerRestrictionLevel", n => { DialerRestrictionLevel = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedAppPhoneNumberRedirectLevel>(); } },
                ...
                { "managedBrowser", n => { ManagedBrowser = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedBrowserType>(); } },
                { "managedBrowserToOpenLinksRequired", n => { ManagedBrowserToOpenLinksRequired = n.GetBoolValue(); } },
                { "maximumAllowedDeviceThreatLevel", n => { MaximumAllowedDeviceThreatLevel = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedAppDeviceThreatLevel>(); } },
                ...
                { "mobileThreatDefensePartnerPriority", n => { MobileThreatDefensePartnerPriority = n.GetEnumValue<global::AITGraph.Sdk.Models.MobileThreatDefensePartnerPriority>(); } },
                { "mobileThreatDefenseRemediationAction", n => { MobileThreatDefenseRemediationAction = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedAppRemediationAction>(); } },
                { "notificationRestriction", n => { NotificationRestriction = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedAppNotificationRestriction>(); } },
                ...
                { "pinCharacterSet", n => { PinCharacterSet = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedAppPinCharacterSet>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::AITGraph.Sdk.Models.ManagedAppDataIngestionLocation>("allowedDataIngestionLocations", AllowedDataIngestionLocations);
            writer.WriteCollectionOfEnumValues<global::AITGraph.Sdk.Models.ManagedAppDataStorageLocation>("allowedDataStorageLocations", AllowedDataStorageLocations);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedAppDataTransferLevel>("allowedInboundDataTransferSources", AllowedInboundDataTransferSources);
            writer.WriteIntValue("allowedOutboundClipboardSharingExceptionLength", AllowedOutboundClipboardSharingExceptionLength);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedAppClipboardSharingLevel>("allowedOutboundClipboardSharingLevel", AllowedOutboundClipboardSharingLevel);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedAppDataTransferLevel>("allowedOutboundDataTransferDestinations", AllowedOutboundDataTransferDestinations);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedAppRemediationAction>("appActionIfDeviceComplianceRequired", AppActionIfDeviceComplianceRequired);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedAppRemediationAction>("appActionIfMaximumPinRetriesExceeded", AppActionIfMaximumPinRetriesExceeded);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedAppRemediationAction>("appActionIfUnableToAuthenticateUser", AppActionIfUnableToAuthenticateUser);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedAppPhoneNumberRedirectLevel>("dialerRestrictionLevel", DialerRestrictionLevel);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedBrowserType>("managedBrowser", ManagedBrowser);
            writer.WriteBoolValue("managedBrowserToOpenLinksRequired", ManagedBrowserToOpenLinksRequired);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedAppDeviceThreatLevel>("maximumAllowedDeviceThreatLevel", MaximumAllowedDeviceThreatLevel);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.MobileThreatDefensePartnerPriority>("mobileThreatDefensePartnerPriority", MobileThreatDefensePartnerPriority);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedAppRemediationAction>("mobileThreatDefenseRemediationAction", MobileThreatDefenseRemediationAction);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedAppNotificationRestriction>("notificationRestriction", NotificationRestriction);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedAppPinCharacterSet>("pinCharacterSet", PinCharacterSet);
