...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class WindowsWifiConfiguration : global::AITGraph.Sdk.Models.DeviceConfiguration, IParsable
    {
        ...
        public global::AITGraph.Sdk.Models.MeteredConnectionLimitType? MeteredConnectionLimit { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.WiFiProxySetting? ProxySetting { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.WiFiSecurityType? WifiSecurityType { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.WindowsWifiConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.WindowsWifiConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.WindowsWifiConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::AITGraph.Sdk.Models.WindowsWifiConfiguration(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "meteredConnectionLimit", n => { MeteredConnectionLimit = n.GetEnumValue<global::AITGraph.Sdk.Models.MeteredConnectionLimitType>(); } },
                ...
                { "proxySetting", n => { ProxySetting = n.GetEnumValue<global::AITGraph.Sdk.Models.WiFiProxySetting>(); } },
                { "ssid", n => { Ssid = n.GetStringValue(); } },
                { "wifiSecurityType", n => { WifiSecurityType = n.GetEnumValue<global::AITGraph.Sdk.Models.WiFiSecurityType>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.MeteredConnectionLimitType>("meteredConnectionLimit", MeteredConnectionLimit);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WiFiProxySetting>("proxySetting", ProxySetting);
            writer.WriteStringValue("ssid", Ssid);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WiFiSecurityType>("wifiSecurityType", WifiSecurityType);
        }
    }
}
