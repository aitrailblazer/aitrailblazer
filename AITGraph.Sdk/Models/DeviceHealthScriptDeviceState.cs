...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ManagedDevice? ManagedDevice { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ManagedDevice ManagedDevice { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>Indicates the type of execution status of the device management script.</summary>
        public AITGraph.Sdk.Models.RemediationState? RemediationState { get; set; }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"managedDevice", n => { ManagedDevice = n.GetObjectValue<AITGraph.Sdk.Models.ManagedDevice>(AITGraph.Sdk.Models.ManagedDevice.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ManagedDevice>("managedDevice", ManagedDevice);
