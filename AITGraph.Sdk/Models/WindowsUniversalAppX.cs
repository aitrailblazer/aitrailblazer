...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class WindowsUniversalAppX : global::AITGraph.Sdk.Models.MobileLobApp, IParsable
    {
        ...
        public global::AITGraph.Sdk.Models.WindowsDeviceType? ApplicableDeviceTypes { get; set; }
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.MobileContainedApp>? CommittedContainedApps { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.MobileContainedApp> CommittedContainedApps { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.WindowsUniversalAppX"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.WindowsUniversalAppX"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.WindowsUniversalAppX CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.WindowsUniversalAppX();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "applicableDeviceTypes", n => { ApplicableDeviceTypes = n.GetEnumValue<global::AITGraph.Sdk.Models.WindowsDeviceType>(); } },
                { "committedContainedApps", n => { CommittedContainedApps = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.MobileContainedApp>(global::AITGraph.Sdk.Models.MobileContainedApp.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WindowsDeviceType>("applicableDeviceTypes", ApplicableDeviceTypes);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.MobileContainedApp>("committedContainedApps", CommittedContainedApps);
