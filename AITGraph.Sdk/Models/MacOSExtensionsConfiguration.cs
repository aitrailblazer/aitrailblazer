...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class MacOSExtensionsConfiguration : global::AITGraph.Sdk.Models.DeviceConfiguration, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.MacOSKernelExtension>? KernelExtensionsAllowed { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.MacOSKernelExtension> KernelExtensionsAllowed { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.MacOSSystemExtension>? SystemExtensionsAllowed { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.MacOSSystemExtension> SystemExtensionsAllowed { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.MacOSSystemExtensionTypeMapping>? SystemExtensionsAllowedTypes { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.MacOSSystemExtensionTypeMapping> SystemExtensionsAllowedTypes { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.MacOSExtensionsConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.MacOSExtensionsConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.MacOSExtensionsConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.MacOSExtensionsConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "kernelExtensionsAllowed", n => { KernelExtensionsAllowed = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.MacOSKernelExtension>(global::AITGraph.Sdk.Models.MacOSKernelExtension.CreateFromDiscriminatorValue)?.AsList(); } },
                { "systemExtensionsAllowed", n => { SystemExtensionsAllowed = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.MacOSSystemExtension>(global::AITGraph.Sdk.Models.MacOSSystemExtension.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "systemExtensionsAllowedTypes", n => { SystemExtensionsAllowedTypes = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.MacOSSystemExtensionTypeMapping>(global::AITGraph.Sdk.Models.MacOSSystemExtensionTypeMapping.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.MacOSKernelExtension>("kernelExtensionsAllowed", KernelExtensionsAllowed);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.MacOSSystemExtension>("systemExtensionsAllowed", SystemExtensionsAllowed);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.MacOSSystemExtensionTypeMapping>("systemExtensionsAllowedTypes", SystemExtensionsAllowedTypes);
