...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AndroidManagedStoreAppConfigurationSchemaItem : IAdditionalDataHolder, IParsable
    {
        ...
        public global::AITGraph.Sdk.Models.AndroidManagedStoreAppConfigurationSchemaItemDataType? DataType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.KeyValuePair>? Selections { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.KeyValuePair> Selections { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.AndroidManagedStoreAppConfigurationSchemaItem"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AndroidManagedStoreAppConfigurationSchemaItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.AndroidManagedStoreAppConfigurationSchemaItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AndroidManagedStoreAppConfigurationSchemaItem();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "dataType", n => { DataType = n.GetEnumValue<global::AITGraph.Sdk.Models.AndroidManagedStoreAppConfigurationSchemaItemDataType>(); } },
                ...
                { "selections", n => { Selections = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.KeyValuePair>(global::AITGraph.Sdk.Models.KeyValuePair.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AndroidManagedStoreAppConfigurationSchemaItemDataType>("dataType", DataType);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.KeyValuePair>("selections", Selections);
