...
namespace AITGraph.Sdk.Models.Ediscovery {
    public class SourceCollection : AITGraph.Sdk.Models.Entity, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Ediscovery.AddToReviewSetOperation? AddToReviewSetOperation { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Ediscovery.AddToReviewSetOperation AddToReviewSetOperation { get; set; }
#endif
...
#nullable restore
        ...
        public AITGraph.Sdk.Models.Ediscovery.DataSourceScopes? DataSourceScopes { get; set; }
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"addToReviewSetOperation", n => { AddToReviewSetOperation = n.GetObjectValue<AITGraph.Sdk.Models.Ediscovery.AddToReviewSetOperation>(AITGraph.Sdk.Models.Ediscovery.AddToReviewSetOperation.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Ediscovery.AddToReviewSetOperation>("addToReviewSetOperation", AddToReviewSetOperation);
