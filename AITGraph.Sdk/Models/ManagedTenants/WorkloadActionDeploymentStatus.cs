...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.GenericError? Error { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.GenericError Error { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.ManagedTenants.WorkloadActionStatus? Status { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.ManagedTenants.WorkloadActionDeploymentStatus"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.ManagedTenants.WorkloadActionDeploymentStatus"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.ManagedTenants.WorkloadActionDeploymentStatus CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.ManagedTenants.WorkloadActionDeploymentStatus();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "error", n => { Error = n.GetObjectValue<global::AITGraph.Sdk.Models.GenericError>(global::AITGraph.Sdk.Models.GenericError.CreateFromDiscriminatorValue); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::AITGraph.Sdk.Models.ManagedTenants.WorkloadActionStatus>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.GenericError>("error", Error);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ManagedTenants.WorkloadActionStatus>("status", Status);
