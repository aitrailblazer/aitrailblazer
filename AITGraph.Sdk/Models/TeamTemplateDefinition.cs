...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class TeamTemplateDefinition : global::AITGraph.Sdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The audience property</summary>
        public global::AITGraph.Sdk.Models.TeamTemplateAudience? Audience { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.Team? TeamDefinition { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.Team TeamDefinition { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.TeamTemplateDefinition"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.TeamTemplateDefinition CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.TeamTemplateDefinition();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "audience", n => { Audience = n.GetEnumValue<global::AITGraph.Sdk.Models.TeamTemplateAudience>(); } },
                ...
                { "teamDefinition", n => { TeamDefinition = n.GetObjectValue<global::AITGraph.Sdk.Models.Team>(global::AITGraph.Sdk.Models.Team.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.TeamTemplateAudience>("audience", Audience);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.Team>("teamDefinition", TeamDefinition);
        }
    }
}
