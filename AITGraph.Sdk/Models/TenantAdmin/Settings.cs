...
namespace AITGraph.Sdk.Models.TenantAdmin
{
    ...
    public partial class Settings : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.TenantAdmin.IdleSessionSignOut? IdleSessionSignOut { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.TenantAdmin.IdleSessionSignOut IdleSessionSignOut { get; set; }
#endif
        /// <summary>Specifies the image tagging option for the tenant. Possible values are: disabled, basic, enhanced.</summary>
        public global::AITGraph.Sdk.Models.TenantAdmin.ImageTaggingChoice? ImageTaggingOption { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.TenantAdmin.SharingCapabilities? SharingCapability { get; set; }
        /// <summary>Specifies the external sharing mode for domains. Possible values are: none, allowList, blockList.</summary>
        public global::AITGraph.Sdk.Models.TenantAdmin.SharingDomainRestrictionMode? SharingDomainRestrictionMode { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.TenantAdmin.Settings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.TenantAdmin.Settings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.TenantAdmin.Settings();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "idleSessionSignOut", n => { IdleSessionSignOut = n.GetObjectValue<global::AITGraph.Sdk.Models.TenantAdmin.IdleSessionSignOut>(global::AITGraph.Sdk.Models.TenantAdmin.IdleSessionSignOut.CreateFromDiscriminatorValue); } },
                { "imageTaggingOption", n => { ImageTaggingOption = n.GetEnumValue<global::AITGraph.Sdk.Models.TenantAdmin.ImageTaggingChoice>(); } },
                ...
                { "sharingCapability", n => { SharingCapability = n.GetEnumValue<global::AITGraph.Sdk.Models.TenantAdmin.SharingCapabilities>(); } },
                { "sharingDomainRestrictionMode", n => { SharingDomainRestrictionMode = n.GetEnumValue<global::AITGraph.Sdk.Models.TenantAdmin.SharingDomainRestrictionMode>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.TenantAdmin.IdleSessionSignOut>("idleSessionSignOut", IdleSessionSignOut);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.TenantAdmin.ImageTaggingChoice>("imageTaggingOption", ImageTaggingOption);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.TenantAdmin.SharingCapabilities>("sharingCapability", SharingCapability);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.TenantAdmin.SharingDomainRestrictionMode>("sharingDomainRestrictionMode", SharingDomainRestrictionMode);
