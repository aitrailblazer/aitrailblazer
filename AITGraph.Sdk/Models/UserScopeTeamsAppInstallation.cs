...
#nullable enable
        public AITGraph.Sdk.Models.Chat? Chat { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Chat Chat { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"chat", n => { Chat = n.GetObjectValue<AITGraph.Sdk.Models.Chat>(AITGraph.Sdk.Models.Chat.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Chat>("chat", Chat);
        }
    }
}
