...
#nullable enable
        public AITGraph.Sdk.Models.ContactMergeSuggestions? ContactMergeSuggestions { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ContactMergeSuggestions ContactMergeSuggestions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.RegionalAndLanguageSettings? RegionalAndLanguageSettings { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.RegionalAndLanguageSettings RegionalAndLanguageSettings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ShiftPreferences? ShiftPreferences { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ShiftPreferences ShiftPreferences { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"contactMergeSuggestions", n => { ContactMergeSuggestions = n.GetObjectValue<AITGraph.Sdk.Models.ContactMergeSuggestions>(AITGraph.Sdk.Models.ContactMergeSuggestions.CreateFromDiscriminatorValue); } },
                ...
                {"regionalAndLanguageSettings", n => { RegionalAndLanguageSettings = n.GetObjectValue<AITGraph.Sdk.Models.RegionalAndLanguageSettings>(AITGraph.Sdk.Models.RegionalAndLanguageSettings.CreateFromDiscriminatorValue); } },
                {"shiftPreferences", n => { ShiftPreferences = n.GetObjectValue<AITGraph.Sdk.Models.ShiftPreferences>(AITGraph.Sdk.Models.ShiftPreferences.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ContactMergeSuggestions>("contactMergeSuggestions", ContactMergeSuggestions);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.RegionalAndLanguageSettings>("regionalAndLanguageSettings", RegionalAndLanguageSettings);
            writer.WriteObjectValue<AITGraph.Sdk.Models.ShiftPreferences>("shiftPreferences", ShiftPreferences);
        }
    }
}
