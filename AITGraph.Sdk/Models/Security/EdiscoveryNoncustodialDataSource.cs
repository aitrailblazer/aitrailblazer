...
#nullable enable
        public AITGraph.Sdk.Models.Security.DataSource? DataSource { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Security.DataSource DataSource { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"dataSource", n => { DataSource = n.GetObjectValue<AITGraph.Sdk.Models.Security.DataSource>(AITGraph.Sdk.Models.Security.DataSource.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Security.DataSource>("dataSource", DataSource);
