...
#nullable enable
        public AITGraph.Sdk.Models.WindowsUpdates.ContentFilter? ContentFilter { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.WindowsUpdates.ContentFilter ContentFilter { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"contentFilter", n => { ContentFilter = n.GetObjectValue<AITGraph.Sdk.Models.WindowsUpdates.ContentFilter>(AITGraph.Sdk.Models.WindowsUpdates.ContentFilter.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.WindowsUpdates.ContentFilter>("contentFilter", ContentFilter);
