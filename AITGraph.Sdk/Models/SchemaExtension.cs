...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class SchemaExtension : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.ExtensionSchemaProperty>? Properties { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.ExtensionSchemaProperty> Properties { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.SchemaExtension"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.SchemaExtension CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.SchemaExtension();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "properties", n => { Properties = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.ExtensionSchemaProperty>(global::AITGraph.Sdk.Models.ExtensionSchemaProperty.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.ExtensionSchemaProperty>("properties", Properties);
