...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class MailFolder : global::AITGraph.Sdk.Models.Entity, IParsable
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.MailFolder>? ChildFolders { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.MailFolder> ChildFolders { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.MessageRule>? MessageRules { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.MessageRule> MessageRules { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.UserConfiguration>? UserConfigurations { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.UserConfiguration> UserConfigurations { get; set; }
#endif
...
#nullable restore
        ...
        public static new global::AITGraph.Sdk.Models.MailFolder CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::AITGraph.Sdk.Models.MailFolder(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "childFolders", n => { ChildFolders = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.MailFolder>(global::AITGraph.Sdk.Models.MailFolder.CreateFromDiscriminatorValue)?.AsList(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "isHidden", n => { IsHidden = n.GetBoolValue(); } },
                { "messageRules", n => { MessageRules = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.MessageRule>(global::AITGraph.Sdk.Models.MessageRule.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "userConfigurations", n => { UserConfigurations = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.UserConfiguration>(global::AITGraph.Sdk.Models.UserConfiguration.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.MailFolder>("childFolders", ChildFolders);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteBoolValue("isHidden", IsHidden);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.MessageRule>("messageRules", MessageRules);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.UserConfiguration>("userConfigurations", UserConfigurations);
