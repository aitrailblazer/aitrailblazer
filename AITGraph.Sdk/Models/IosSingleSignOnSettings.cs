...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class IosSingleSignOnSettings : IAdditionalDataHolder, IParsable
    {
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.AppListItem>? AllowedAppsList { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AppListItem> AllowedAppsList { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.IosSingleSignOnSettings"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.IosSingleSignOnSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.IosSingleSignOnSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.IosSingleSignOnSettings();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedAppsList", n => { AllowedAppsList = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AppListItem>(global::AITGraph.Sdk.Models.AppListItem.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AppListItem>("allowedAppsList", AllowedAppsList);
