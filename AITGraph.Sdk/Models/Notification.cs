...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class Notification : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.PayloadTypes? Payload { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.PayloadTypes Payload { get; set; }
#endif
        ...
        public global::AITGraph.Sdk.Models.Priority? Priority { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.TargetPolicyEndpoints? TargetPolicy { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.TargetPolicyEndpoints TargetPolicy { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Notification"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.Notification CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Notification();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "payload", n => { Payload = n.GetObjectValue<global::AITGraph.Sdk.Models.PayloadTypes>(global::AITGraph.Sdk.Models.PayloadTypes.CreateFromDiscriminatorValue); } },
                { "priority", n => { Priority = n.GetEnumValue<global::AITGraph.Sdk.Models.Priority>(); } },
                { "targetHostName", n => { TargetHostName = n.GetStringValue(); } },
                { "targetPolicy", n => { TargetPolicy = n.GetObjectValue<global::AITGraph.Sdk.Models.TargetPolicyEndpoints>(global::AITGraph.Sdk.Models.TargetPolicyEndpoints.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.PayloadTypes>("payload", Payload);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Priority>("priority", Priority);
            writer.WriteStringValue("targetHostName", TargetHostName);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.TargetPolicyEndpoints>("targetPolicy", TargetPolicy);
        }
    }
}
