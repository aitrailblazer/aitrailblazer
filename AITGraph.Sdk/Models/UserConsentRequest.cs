...
#nullable enable
        public AITGraph.Sdk.Models.Approval? Approval { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Approval Approval { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"approval", n => { Approval = n.GetObjectValue<AITGraph.Sdk.Models.Approval>(AITGraph.Sdk.Models.Approval.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Approval>("approval", Approval);
