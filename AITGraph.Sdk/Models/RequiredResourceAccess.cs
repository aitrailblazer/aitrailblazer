...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AITGraph.Sdk.Models.ResourceAccess>? ResourceAccess { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.ResourceAccess> ResourceAccess { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"resourceAccess", n => { ResourceAccess = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.ResourceAccess>(AITGraph.Sdk.Models.ResourceAccess.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.ResourceAccess>("resourceAccess", ResourceAccess);
