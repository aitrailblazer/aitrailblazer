...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AgreementFileProperties : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.AgreementFileData? FileData { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AgreementFileData FileData { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AgreementFileProperties"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.AgreementFileProperties CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::AITGraph.Sdk.Models.AgreementFileProperties(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "fileData", n => { FileData = n.GetObjectValue<global::AITGraph.Sdk.Models.AgreementFileData>(global::AITGraph.Sdk.Models.AgreementFileData.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AgreementFileData>("fileData", FileData);
