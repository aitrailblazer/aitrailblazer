...
namespace AITGraph.Sdk.Models.ExternalConnectors {
    public class ConnectionOperation : AITGraph.Sdk.Models.Entity, IParsable {
        /// <summary>If status is failed, provides more information about the error that caused the failure.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.PublicError? Error { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.PublicError Error { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"error", n => { Error = n.GetObjectValue<AITGraph.Sdk.Models.PublicError>(AITGraph.Sdk.Models.PublicError.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.PublicError>("error", Error);
