...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class CustomSecurityAttributeDefinition : global::AITGraph.Sdk.Models.Entity, IParsable
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.AllowedValue>? AllowedValues { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AllowedValue> AllowedValues { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.CustomSecurityAttributeDefinition"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.CustomSecurityAttributeDefinition CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.CustomSecurityAttributeDefinition();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedValues", n => { AllowedValues = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AllowedValue>(global::AITGraph.Sdk.Models.AllowedValue.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AllowedValue>("allowedValues", AllowedValues);
