...
namespace AITGraph.Sdk.Models.TermStore {
    public class Term : AITGraph.Sdk.Models.Entity, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AITGraph.Sdk.Models.KeyValue>? Properties { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.KeyValue> Properties { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.TermStore.Set? Set { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.TermStore.Set Set { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"properties", n => { Properties = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.KeyValue>(AITGraph.Sdk.Models.KeyValue.CreateFromDiscriminatorValue)?.ToList(); } },
                {"relations", n => { Relations = n.GetCollectionOfObjectValues<Relation>(Relation.CreateFromDiscriminatorValue)?.ToList(); } },
                {"set", n => { Set = n.GetObjectValue<AITGraph.Sdk.Models.TermStore.Set>(AITGraph.Sdk.Models.TermStore.Set.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.KeyValue>("properties", Properties);
            writer.WriteCollectionOfObjectValues<Relation>("relations", Relations);
            writer.WriteObjectValue<AITGraph.Sdk.Models.TermStore.Set>("set", Set);
        }
    }
}
