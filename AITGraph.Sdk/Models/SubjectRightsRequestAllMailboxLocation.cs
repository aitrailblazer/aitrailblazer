...
namespace AITGraph.Sdk.Models {
    public class SubjectRightsRequestAllMailboxLocation : SubjectRightsRequestMailboxLocation, IParsable {
        ...
        public static new SubjectRightsRequestAllMailboxLocation CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SubjectRightsRequestAllMailboxLocation();
        }
        /// <summary>
