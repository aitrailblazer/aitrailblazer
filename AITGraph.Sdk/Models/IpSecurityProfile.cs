...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class IpSecurityProfile : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.IpCategory>? IpCategories { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.IpCategory> IpCategories { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.IpReferenceData>? IpReferenceData { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.IpReferenceData> IpReferenceData { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.IpSecurityProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.IpSecurityProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.IpSecurityProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "ipCategories", n => { IpCategories = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.IpCategory>(global::AITGraph.Sdk.Models.IpCategory.CreateFromDiscriminatorValue)?.AsList(); } },
                { "ipReferenceData", n => { IpReferenceData = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.IpReferenceData>(global::AITGraph.Sdk.Models.IpReferenceData.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.IpCategory>("ipCategories", IpCategories);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.IpReferenceData>("ipReferenceData", IpReferenceData);
