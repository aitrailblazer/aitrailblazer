...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class ManagedDeviceMobileAppConfigurationSettingState : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.SettingSource>? Sources { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.SettingSource> Sources { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.ManagedDeviceMobileAppConfigurationSettingState"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.ManagedDeviceMobileAppConfigurationSettingState"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.ManagedDeviceMobileAppConfigurationSettingState CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.ManagedDeviceMobileAppConfigurationSettingState();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "sources", n => { Sources = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.SettingSource>(global::AITGraph.Sdk.Models.SettingSource.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.SettingSource>("sources", Sources);
