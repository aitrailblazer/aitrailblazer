...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class ExactMatchSession : global::AITGraph.Sdk.Models.ExactMatchSessionBase, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.ExactMatchUploadAgent? UploadAgent { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.ExactMatchUploadAgent UploadAgent { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.ExactMatchSession"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.ExactMatchSession CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.ExactMatchSession();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "uploadAgent", n => { UploadAgent = n.GetObjectValue<global::AITGraph.Sdk.Models.ExactMatchUploadAgent>(global::AITGraph.Sdk.Models.ExactMatchUploadAgent.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.ExactMatchUploadAgent>("uploadAgent", UploadAgent);
