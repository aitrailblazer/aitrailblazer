...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class RemoteAssistanceSettings : global::AITGraph.Sdk.Models.Entity, IParsable
    {
        ...
        public global::AITGraph.Sdk.Models.RemoteAssistanceState? RemoteAssistanceState { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.RemoteAssistanceSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.RemoteAssistanceSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.RemoteAssistanceSettings();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "remoteAssistanceState", n => { RemoteAssistanceState = n.GetEnumValue<global::AITGraph.Sdk.Models.RemoteAssistanceState>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.RemoteAssistanceState>("remoteAssistanceState", RemoteAssistanceState);
        }
    }
}
