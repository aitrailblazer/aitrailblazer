...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Schedule? Schedule { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Schedule Schedule { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"schedule", n => { Schedule = n.GetObjectValue<AITGraph.Sdk.Models.Schedule>(AITGraph.Sdk.Models.Schedule.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Schedule>("schedule", Schedule);
