...
namespace AITGraph.Sdk.Models.ManagedTenants {
    public class ManagementTemplate : AITGraph.Sdk.Models.Entity, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AITGraph.Sdk.Models.ActionUrl>? InformationLinks { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.ActionUrl> InformationLinks { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"informationLinks", n => { InformationLinks = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.ActionUrl>(AITGraph.Sdk.Models.ActionUrl.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.ActionUrl>("informationLinks", InformationLinks);
