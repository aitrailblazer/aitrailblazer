...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AITGraph.Sdk.Models.AgedAccountsPayable>? AgedAccountsPayable { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.AgedAccountsPayable> AgedAccountsPayable { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AITGraph.Sdk.Models.AgedAccountsReceivable>? AgedAccountsReceivable { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.AgedAccountsReceivable> AgedAccountsReceivable { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AITGraph.Sdk.Models.CompanyInformation>? CompanyInformation { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.CompanyInformation> CompanyInformation { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"agedAccountsPayable", n => { AgedAccountsPayable = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.AgedAccountsPayable>(AITGraph.Sdk.Models.AgedAccountsPayable.CreateFromDiscriminatorValue)?.ToList(); } },
                {"agedAccountsReceivable", n => { AgedAccountsReceivable = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.AgedAccountsReceivable>(AITGraph.Sdk.Models.AgedAccountsReceivable.CreateFromDiscriminatorValue)?.ToList(); } },
                {"businessProfileId", n => { BusinessProfileId = n.GetStringValue(); } },
                {"companyInformation", n => { CompanyInformation = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.CompanyInformation>(AITGraph.Sdk.Models.CompanyInformation.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.AgedAccountsPayable>("agedAccountsPayable", AgedAccountsPayable);
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.AgedAccountsReceivable>("agedAccountsReceivable", AgedAccountsReceivable);
            writer.WriteStringValue("businessProfileId", BusinessProfileId);
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.CompanyInformation>("companyInformation", CompanyInformation);
