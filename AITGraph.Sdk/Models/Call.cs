...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.CallOptions? CallOptions { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.CallOptions CallOptions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.IncomingContext? IncomingContext { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.IncomingContext IncomingContext { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.MediaConfig? MediaConfig { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.MediaConfig MediaConfig { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.MeetingCapability? MeetingCapability { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.MeetingCapability MeetingCapability { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.MeetingInfo? MeetingInfo { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.MeetingInfo MeetingInfo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ResultInfo? ResultInfo { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ResultInfo ResultInfo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ToneInfo? ToneInfo { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ToneInfo ToneInfo { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"callOptions", n => { CallOptions = n.GetObjectValue<AITGraph.Sdk.Models.CallOptions>(AITGraph.Sdk.Models.CallOptions.CreateFromDiscriminatorValue); } },
                ...
                {"incomingContext", n => { IncomingContext = n.GetObjectValue<AITGraph.Sdk.Models.IncomingContext>(AITGraph.Sdk.Models.IncomingContext.CreateFromDiscriminatorValue); } },
                {"mediaConfig", n => { MediaConfig = n.GetObjectValue<AITGraph.Sdk.Models.MediaConfig>(AITGraph.Sdk.Models.MediaConfig.CreateFromDiscriminatorValue); } },
                {"mediaState", n => { MediaState = n.GetObjectValue<CallMediaState>(CallMediaState.CreateFromDiscriminatorValue); } },
                {"meetingCapability", n => { MeetingCapability = n.GetObjectValue<AITGraph.Sdk.Models.MeetingCapability>(AITGraph.Sdk.Models.MeetingCapability.CreateFromDiscriminatorValue); } },
                {"meetingInfo", n => { MeetingInfo = n.GetObjectValue<AITGraph.Sdk.Models.MeetingInfo>(AITGraph.Sdk.Models.MeetingInfo.CreateFromDiscriminatorValue); } },
                ...
                {"resultInfo", n => { ResultInfo = n.GetObjectValue<AITGraph.Sdk.Models.ResultInfo>(AITGraph.Sdk.Models.ResultInfo.CreateFromDiscriminatorValue); } },
                ...
                {"toneInfo", n => { ToneInfo = n.GetObjectValue<AITGraph.Sdk.Models.ToneInfo>(AITGraph.Sdk.Models.ToneInfo.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.CallOptions>("callOptions", CallOptions);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.IncomingContext>("incomingContext", IncomingContext);
            writer.WriteObjectValue<AITGraph.Sdk.Models.MediaConfig>("mediaConfig", MediaConfig);
            writer.WriteObjectValue<CallMediaState>("mediaState", MediaState);
            writer.WriteObjectValue<AITGraph.Sdk.Models.MeetingCapability>("meetingCapability", MeetingCapability);
            writer.WriteObjectValue<AITGraph.Sdk.Models.MeetingInfo>("meetingInfo", MeetingInfo);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ResultInfo>("resultInfo", ResultInfo);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ToneInfo>("toneInfo", ToneInfo);
