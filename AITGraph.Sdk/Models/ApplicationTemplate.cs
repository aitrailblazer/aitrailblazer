...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class ApplicationTemplate : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.InformationalUrls? InformationalUrls { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.InformationalUrls InformationalUrls { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.SupportedClaimConfiguration? SupportedClaimConfiguration { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.SupportedClaimConfiguration SupportedClaimConfiguration { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.ApplicationTemplate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.ApplicationTemplate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.ApplicationTemplate();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "informationalUrls", n => { InformationalUrls = n.GetObjectValue<global::AITGraph.Sdk.Models.InformationalUrls>(global::AITGraph.Sdk.Models.InformationalUrls.CreateFromDiscriminatorValue); } },
                { "logoUrl", n => { LogoUrl = n.GetStringValue(); } },
                { "publisher", n => { Publisher = n.GetStringValue(); } },
                { "supportedClaimConfiguration", n => { SupportedClaimConfiguration = n.GetObjectValue<global::AITGraph.Sdk.Models.SupportedClaimConfiguration>(global::AITGraph.Sdk.Models.SupportedClaimConfiguration.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.InformationalUrls>("informationalUrls", InformationalUrls);
            writer.WriteStringValue("logoUrl", LogoUrl);
            writer.WriteStringValue("publisher", Publisher);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.SupportedClaimConfiguration>("supportedClaimConfiguration", SupportedClaimConfiguration);
