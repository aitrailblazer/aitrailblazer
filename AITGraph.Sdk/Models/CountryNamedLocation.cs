...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class CountryNamedLocation : global::AITGraph.Sdk.Models.NamedLocation, IParsable
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.CountryLookupMethodType? CountryLookupMethod { get; set; }
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.CountryNamedLocation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.CountryNamedLocation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.CountryNamedLocation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "countryLookupMethod", n => { CountryLookupMethod = n.GetEnumValue<global::AITGraph.Sdk.Models.CountryLookupMethodType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.CountryLookupMethodType>("countryLookupMethod", CountryLookupMethod);
