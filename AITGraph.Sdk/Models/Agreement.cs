...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.TermsExpiration? TermsExpiration { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.TermsExpiration TermsExpiration { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"termsExpiration", n => { TermsExpiration = n.GetObjectValue<AITGraph.Sdk.Models.TermsExpiration>(AITGraph.Sdk.Models.TermsExpiration.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.TermsExpiration>("termsExpiration", TermsExpiration);
