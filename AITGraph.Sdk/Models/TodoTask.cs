...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class TodoTask : global::AITGraph.Sdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>A collection of file attachments for the task.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.AttachmentBase>? Attachments { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AttachmentBase> Attachments { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.AttachmentSession>? AttachmentSessions { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AttachmentSession> AttachmentSessions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.ChecklistItem>? ChecklistItems { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.ChecklistItem> ChecklistItems { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.LinkedResource>? LinkedResources { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.LinkedResource> LinkedResources { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.TodoTask"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.TodoTask CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.TodoTask();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "attachmentSessions", n => { AttachmentSessions = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AttachmentSession>(global::AITGraph.Sdk.Models.AttachmentSession.CreateFromDiscriminatorValue)?.AsList(); } },
                { "attachments", n => { Attachments = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AttachmentBase>(global::AITGraph.Sdk.Models.AttachmentBase.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "checklistItems", n => { ChecklistItems = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.ChecklistItem>(global::AITGraph.Sdk.Models.ChecklistItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "linkedResources", n => { LinkedResources = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.LinkedResource>(global::AITGraph.Sdk.Models.LinkedResource.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AttachmentBase>("attachments", Attachments);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AttachmentSession>("attachmentSessions", AttachmentSessions);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.ChecklistItem>("checklistItems", ChecklistItems);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.LinkedResource>("linkedResources", LinkedResources);
