...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class MicrosoftTunnelSite : global::AITGraph.Sdk.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.MicrosoftTunnelConfiguration? MicrosoftTunnelConfiguration { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.MicrosoftTunnelConfiguration MicrosoftTunnelConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.MicrosoftTunnelServer>? MicrosoftTunnelServers { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.MicrosoftTunnelServer> MicrosoftTunnelServers { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.MicrosoftTunnelSite"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.MicrosoftTunnelSite CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.MicrosoftTunnelSite();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "microsoftTunnelConfiguration", n => { MicrosoftTunnelConfiguration = n.GetObjectValue<global::AITGraph.Sdk.Models.MicrosoftTunnelConfiguration>(global::AITGraph.Sdk.Models.MicrosoftTunnelConfiguration.CreateFromDiscriminatorValue); } },
                { "microsoftTunnelServers", n => { MicrosoftTunnelServers = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.MicrosoftTunnelServer>(global::AITGraph.Sdk.Models.MicrosoftTunnelServer.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.MicrosoftTunnelConfiguration>("microsoftTunnelConfiguration", MicrosoftTunnelConfiguration);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.MicrosoftTunnelServer>("microsoftTunnelServers", MicrosoftTunnelServers);
