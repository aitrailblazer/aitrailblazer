...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.DeviceHealth? DeviceHealth { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.DeviceHealth DeviceHealth { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"deviceHealth", n => { DeviceHealth = n.GetObjectValue<AITGraph.Sdk.Models.DeviceHealth>(AITGraph.Sdk.Models.DeviceHealth.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.DeviceHealth>("deviceHealth", DeviceHealth);
