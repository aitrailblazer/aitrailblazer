...
namespace AITGraph.Sdk.Models.Security
{
    ...
    public partial class DeviceEvidence : global::AITGraph.Sdk.Models.Security.AlertEvidence, IParsable
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.Security.DefenderAvStatus? DefenderAvStatus { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.Security.DeviceHealthStatus? HealthStatus { get; set; }
        /// <summary>Users that were logged on the machine during the time of the alert.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.Security.LoggedOnUser>? LoggedOnUsers { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.Security.LoggedOnUser> LoggedOnUsers { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.Security.OnboardingStatus? OnboardingStatus { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.Security.DeviceRiskScore? RiskScore { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.Security.VmMetadata? VmMetadata { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.Security.VmMetadata VmMetadata { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Security.DeviceEvidence"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.Security.DeviceEvidence CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Security.DeviceEvidence();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "defenderAvStatus", n => { DefenderAvStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.Security.DefenderAvStatus>(); } },
                { "deviceDnsName", n => { DeviceDnsName = n.GetStringValue(); } },
                { "firstSeenDateTime", n => { FirstSeenDateTime = n.GetDateTimeOffsetValue(); } },
                { "healthStatus", n => { HealthStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.Security.DeviceHealthStatus>(); } },
                { "loggedOnUsers", n => { LoggedOnUsers = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.Security.LoggedOnUser>(global::AITGraph.Sdk.Models.Security.LoggedOnUser.CreateFromDiscriminatorValue)?.AsList(); } },
                { "mdeDeviceId", n => { MdeDeviceId = n.GetStringValue(); } },
                { "onboardingStatus", n => { OnboardingStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.Security.OnboardingStatus>(); } },
                ...
                { "riskScore", n => { RiskScore = n.GetEnumValue<global::AITGraph.Sdk.Models.Security.DeviceRiskScore>(); } },
                { "version", n => { Version = n.GetStringValue(); } },
                { "vmMetadata", n => { VmMetadata = n.GetObjectValue<global::AITGraph.Sdk.Models.Security.VmMetadata>(global::AITGraph.Sdk.Models.Security.VmMetadata.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Security.DefenderAvStatus>("defenderAvStatus", DefenderAvStatus);
            writer.WriteStringValue("deviceDnsName", DeviceDnsName);
            writer.WriteDateTimeOffsetValue("firstSeenDateTime", FirstSeenDateTime);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Security.DeviceHealthStatus>("healthStatus", HealthStatus);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.Security.LoggedOnUser>("loggedOnUsers", LoggedOnUsers);
            writer.WriteStringValue("mdeDeviceId", MdeDeviceId);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Security.OnboardingStatus>("onboardingStatus", OnboardingStatus);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Security.DeviceRiskScore>("riskScore", RiskScore);
            writer.WriteStringValue("version", Version);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.Security.VmMetadata>("vmMetadata", VmMetadata);
        }
    }
}
