...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ResourceReference? ResourceReference { get; private set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ResourceReference ResourceReference { get; private set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ResourceVisualization? ResourceVisualization { get; private set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ResourceVisualization ResourceVisualization { get; private set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"resourceReference", n => { ResourceReference = n.GetObjectValue<AITGraph.Sdk.Models.ResourceReference>(AITGraph.Sdk.Models.ResourceReference.CreateFromDiscriminatorValue); } },
                {"resourceVisualization", n => { ResourceVisualization = n.GetObjectValue<AITGraph.Sdk.Models.ResourceVisualization>(AITGraph.Sdk.Models.ResourceVisualization.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
