...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class RequestSchedule : IAdditionalDataHolder, IParsable
...
#nullable enable
        public global::AITGraph.Sdk.Models.ExpirationPattern? Expiration { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.ExpirationPattern Expiration { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.RequestSchedule"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.RequestSchedule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.RequestSchedule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.RequestSchedule();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "expiration", n => { Expiration = n.GetObjectValue<global::AITGraph.Sdk.Models.ExpirationPattern>(global::AITGraph.Sdk.Models.ExpirationPattern.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.ExpirationPattern>("expiration", Expiration);
