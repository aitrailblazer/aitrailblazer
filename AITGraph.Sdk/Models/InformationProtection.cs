...
#nullable enable
        public AITGraph.Sdk.Models.Bitlocker? Bitlocker { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Bitlocker Bitlocker { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.SensitivityPolicySettings? SensitivityPolicySettings { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.SensitivityPolicySettings SensitivityPolicySettings { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"bitlocker", n => { Bitlocker = n.GetObjectValue<AITGraph.Sdk.Models.Bitlocker>(AITGraph.Sdk.Models.Bitlocker.CreateFromDiscriminatorValue); } },
                ...
                {"sensitivityPolicySettings", n => { SensitivityPolicySettings = n.GetObjectValue<AITGraph.Sdk.Models.SensitivityPolicySettings>(AITGraph.Sdk.Models.SensitivityPolicySettings.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Bitlocker>("bitlocker", Bitlocker);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.SensitivityPolicySettings>("sensitivityPolicySettings", SensitivityPolicySettings);
