...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AndroidWorkProfileGeneralDeviceConfiguration : global::AITGraph.Sdk.Models.DeviceConfiguration, IParsable
    {
        ...
        public global::AITGraph.Sdk.Models.AndroidWorkProfileRequiredPasswordType? PasswordRequiredType { get; set; }
        ...
        public global::AITGraph.Sdk.Models.AndroidRequiredPasswordComplexity? RequiredPasswordComplexity { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.AndroidWorkProfileCrossProfileDataSharingType? WorkProfileDataSharingType { get; set; }
        /// <summary>Android Work Profile default app permission policy type.</summary>
        public global::AITGraph.Sdk.Models.AndroidWorkProfileDefaultAppPermissionPolicyType? WorkProfileDefaultAppPermissionPolicy { get; set; }
        ...
        /// <summary>Android Work Profile required password type.</summary>
        public global::AITGraph.Sdk.Models.AndroidWorkProfileRequiredPasswordType? WorkProfilePasswordRequiredType { get; set; }
        ...
        /// <summary>The password complexity types that can be set on Android. One of: NONE, LOW, MEDIUM, HIGH. This is an API targeted to Android 11+.</summary>
        public global::AITGraph.Sdk.Models.AndroidRequiredPasswordComplexity? WorkProfileRequiredPasswordComplexity { get; set; }
        /// <summary>Password is required or not for work profile</summary>
        public bool? WorkProfileRequirePassword { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.AndroidWorkProfileGeneralDeviceConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AndroidWorkProfileGeneralDeviceConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.AndroidWorkProfileGeneralDeviceConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AndroidWorkProfileGeneralDeviceConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "passwordRequiredType", n => { PasswordRequiredType = n.GetEnumValue<global::AITGraph.Sdk.Models.AndroidWorkProfileRequiredPasswordType>(); } },
                { "passwordSignInFailureCountBeforeFactoryReset", n => { PasswordSignInFailureCountBeforeFactoryReset = n.GetIntValue(); } },
                { "requiredPasswordComplexity", n => { RequiredPasswordComplexity = n.GetEnumValue<global::AITGraph.Sdk.Models.AndroidRequiredPasswordComplexity>(); } },
                ...
                { "workProfileDataSharingType", n => { WorkProfileDataSharingType = n.GetEnumValue<global::AITGraph.Sdk.Models.AndroidWorkProfileCrossProfileDataSharingType>(); } },
                { "workProfileDefaultAppPermissionPolicy", n => { WorkProfileDefaultAppPermissionPolicy = n.GetEnumValue<global::AITGraph.Sdk.Models.AndroidWorkProfileDefaultAppPermissionPolicyType>(); } },
                ...
                { "workProfilePasswordRequiredType", n => { WorkProfilePasswordRequiredType = n.GetEnumValue<global::AITGraph.Sdk.Models.AndroidWorkProfileRequiredPasswordType>(); } },
                ...
                { "workProfileRequiredPasswordComplexity", n => { WorkProfileRequiredPasswordComplexity = n.GetEnumValue<global::AITGraph.Sdk.Models.AndroidRequiredPasswordComplexity>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AndroidWorkProfileRequiredPasswordType>("passwordRequiredType", PasswordRequiredType);
            writer.WriteIntValue("passwordSignInFailureCountBeforeFactoryReset", PasswordSignInFailureCountBeforeFactoryReset);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AndroidRequiredPasswordComplexity>("requiredPasswordComplexity", RequiredPasswordComplexity);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AndroidWorkProfileCrossProfileDataSharingType>("workProfileDataSharingType", WorkProfileDataSharingType);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AndroidWorkProfileDefaultAppPermissionPolicyType>("workProfileDefaultAppPermissionPolicy", WorkProfileDefaultAppPermissionPolicy);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AndroidWorkProfileRequiredPasswordType>("workProfilePasswordRequiredType", WorkProfilePasswordRequiredType);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AndroidRequiredPasswordComplexity>("workProfileRequiredPasswordComplexity", WorkProfileRequiredPasswordComplexity);
