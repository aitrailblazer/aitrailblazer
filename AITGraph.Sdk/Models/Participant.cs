...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.RecordingInfo? RecordingInfo { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.RecordingInfo RecordingInfo { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"recordingInfo", n => { RecordingInfo = n.GetObjectValue<AITGraph.Sdk.Models.RecordingInfo>(AITGraph.Sdk.Models.RecordingInfo.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.RecordingInfo>("recordingInfo", RecordingInfo);
