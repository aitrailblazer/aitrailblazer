...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AndroidDeviceOwnerEnrollmentProfile : global::AITGraph.Sdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.AndroidDeviceOwnerEnrollmentMode? EnrollmentMode { get; set; }
        /// <summary>The enrollment token type for an enrollment profile.</summary>
        public global::AITGraph.Sdk.Models.AndroidDeviceOwnerEnrollmentTokenType? EnrollmentTokenType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.MimeContent? QrCodeImage { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.MimeContent QrCodeImage { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.AospWifiSecurityType? WifiSecurityType { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AndroidDeviceOwnerEnrollmentProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.AndroidDeviceOwnerEnrollmentProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AndroidDeviceOwnerEnrollmentProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "enrollmentMode", n => { EnrollmentMode = n.GetEnumValue<global::AITGraph.Sdk.Models.AndroidDeviceOwnerEnrollmentMode>(); } },
                { "enrollmentTokenType", n => { EnrollmentTokenType = n.GetEnumValue<global::AITGraph.Sdk.Models.AndroidDeviceOwnerEnrollmentTokenType>(); } },
                ...
                { "qrCodeImage", n => { QrCodeImage = n.GetObjectValue<global::AITGraph.Sdk.Models.MimeContent>(global::AITGraph.Sdk.Models.MimeContent.CreateFromDiscriminatorValue); } },
                ...
                { "wifiSecurityType", n => { WifiSecurityType = n.GetEnumValue<global::AITGraph.Sdk.Models.AospWifiSecurityType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AndroidDeviceOwnerEnrollmentMode>("enrollmentMode", EnrollmentMode);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AndroidDeviceOwnerEnrollmentTokenType>("enrollmentTokenType", EnrollmentTokenType);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.MimeContent>("qrCodeImage", QrCodeImage);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AospWifiSecurityType>("wifiSecurityType", WifiSecurityType);
