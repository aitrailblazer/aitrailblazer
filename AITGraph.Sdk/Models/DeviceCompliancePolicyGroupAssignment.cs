...
#nullable enable
        public AITGraph.Sdk.Models.DeviceCompliancePolicy? DeviceCompliancePolicy { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.DeviceCompliancePolicy DeviceCompliancePolicy { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"deviceCompliancePolicy", n => { DeviceCompliancePolicy = n.GetObjectValue<AITGraph.Sdk.Models.DeviceCompliancePolicy>(AITGraph.Sdk.Models.DeviceCompliancePolicy.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.DeviceCompliancePolicy>("deviceCompliancePolicy", DeviceCompliancePolicy);
