...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AccessPackageAssignmentResourceRole : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.AccessPackageSubject? AccessPackageSubject { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AccessPackageSubject AccessPackageSubject { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AccessPackageAssignmentResourceRole"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.AccessPackageAssignmentResourceRole CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AccessPackageAssignmentResourceRole();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "accessPackageSubject", n => { AccessPackageSubject = n.GetObjectValue<global::AITGraph.Sdk.Models.AccessPackageSubject>(global::AITGraph.Sdk.Models.AccessPackageSubject.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AccessPackageSubject>("accessPackageSubject", AccessPackageSubject);
