...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class UserExperienceAnalyticsDeviceScope : global::AITGraph.Sdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.DeviceScopeOperator? Operator { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.DeviceScopeParameter? Parameter { get; set; }
        ...
        public global::AITGraph.Sdk.Models.DeviceScopeStatus? Status { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.UserExperienceAnalyticsDeviceScope"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.UserExperienceAnalyticsDeviceScope CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.UserExperienceAnalyticsDeviceScope();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "operator", n => { Operator = n.GetEnumValue<global::AITGraph.Sdk.Models.DeviceScopeOperator>(); } },
                { "ownerId", n => { OwnerId = n.GetStringValue(); } },
                { "parameter", n => { Parameter = n.GetEnumValue<global::AITGraph.Sdk.Models.DeviceScopeParameter>(); } },
                { "status", n => { Status = n.GetEnumValue<global::AITGraph.Sdk.Models.DeviceScopeStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceScopeOperator>("operator", Operator);
            writer.WriteStringValue("ownerId", OwnerId);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceScopeParameter>("parameter", Parameter);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceScopeStatus>("status", Status);
