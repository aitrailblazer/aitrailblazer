...
namespace AITGraph.Sdk.Models.DeviceManagement
{
    ...
    public partial class AlertRecord : global::AITGraph.Sdk.Models.Entity, IParsable
...
#nullable enable
        public global::AITGraph.Sdk.Models.DeviceManagement.AlertImpact? AlertImpact { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.DeviceManagement.AlertImpact AlertImpact { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.DeviceManagement.AlertStatusType? Status { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.DeviceManagement.AlertRecord"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.DeviceManagement.AlertRecord CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.DeviceManagement.AlertRecord();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "alertImpact", n => { AlertImpact = n.GetObjectValue<global::AITGraph.Sdk.Models.DeviceManagement.AlertImpact>(global::AITGraph.Sdk.Models.DeviceManagement.AlertImpact.CreateFromDiscriminatorValue); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::AITGraph.Sdk.Models.DeviceManagement.AlertStatusType>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.DeviceManagement.AlertImpact>("alertImpact", AlertImpact);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceManagement.AlertStatusType>("status", Status);
        }
    }
}
