...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.StringKeyStringValuePair>? Metadata { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.StringKeyStringValuePair> Metadata { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.ObjectMapping>? ObjectMappings { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.ObjectMapping> ObjectMappings { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.SynchronizationRule"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.SynchronizationRule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.SynchronizationRule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.SynchronizationRule();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "metadata", n => { Metadata = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.StringKeyStringValuePair>(global::AITGraph.Sdk.Models.StringKeyStringValuePair.CreateFromDiscriminatorValue)?.AsList(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "objectMappings", n => { ObjectMappings = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.ObjectMapping>(global::AITGraph.Sdk.Models.ObjectMapping.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.StringKeyStringValuePair>("metadata", Metadata);
            writer.WriteStringValue("name", Name);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.ObjectMapping>("objectMappings", ObjectMappings);
