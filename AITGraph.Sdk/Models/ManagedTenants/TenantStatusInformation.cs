...
namespace AITGraph.Sdk.Models.ManagedTenants {
    public class TenantStatusInformation : IAdditionalDataHolder, IParsable {
        ...
        public AITGraph.Sdk.Models.ManagedTenants.DelegatedPrivilegeStatus? DelegatedPrivilegeStatus { get; set; }
...
#nullable restore
        ...
        public AITGraph.Sdk.Models.ManagedTenants.TenantOnboardingEligibilityReason? TenantOnboardingEligibilityReason { get; set; }
