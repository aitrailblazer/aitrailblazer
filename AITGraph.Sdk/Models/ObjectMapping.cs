...
#nullable enable
        public List<global::AITGraph.Sdk.Models.AttributeMapping>? AttributeMappings { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AttributeMapping> AttributeMappings { get; set; }
#endif
        ...
        public global::AITGraph.Sdk.Models.ObjectFlowTypes? FlowTypes { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.Filter? Scope { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.Filter Scope { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.ObjectMapping"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.ObjectMapping"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.ObjectMapping CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.ObjectMapping();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "attributeMappings", n => { AttributeMappings = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AttributeMapping>(global::AITGraph.Sdk.Models.AttributeMapping.CreateFromDiscriminatorValue)?.AsList(); } },
                { "enabled", n => { Enabled = n.GetBoolValue(); } },
                { "flowTypes", n => { FlowTypes = n.GetEnumValue<global::AITGraph.Sdk.Models.ObjectFlowTypes>(); } },
                ...
                { "scope", n => { Scope = n.GetObjectValue<global::AITGraph.Sdk.Models.Filter>(global::AITGraph.Sdk.Models.Filter.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AttributeMapping>("attributeMappings", AttributeMappings);
            writer.WriteBoolValue("enabled", Enabled);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ObjectFlowTypes>("flowTypes", FlowTypes);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.MetadataEntry>("metadata", Metadata);
            writer.WriteStringValue("name", Name);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.Filter>("scope", Scope);
