...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class BookingAppointment : global::AITGraph.Sdk.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.Location? CustomerLocation { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.Location CustomerLocation { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.BookingCustomerInformationBase>? Customers { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.BookingCustomerInformationBase> Customers { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.DateTimeTimeZone? InvoiceDate { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.DateTimeTimeZone InvoiceDate { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.BookingInvoiceStatus? InvoiceStatus { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.BookingPriceType? PriceType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.BookingReminder>? Reminders { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.BookingReminder> Reminders { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.Location? ServiceLocation { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.Location ServiceLocation { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.BookingAppointment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.BookingAppointment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.BookingAppointment();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "customerLocation", n => { CustomerLocation = n.GetObjectValue<global::AITGraph.Sdk.Models.Location>(global::AITGraph.Sdk.Models.Location.CreateFromDiscriminatorValue); } },
                ...
                { "customers", n => { Customers = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.BookingCustomerInformationBase>(global::AITGraph.Sdk.Models.BookingCustomerInformationBase.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "invoiceDate", n => { InvoiceDate = n.GetObjectValue<global::AITGraph.Sdk.Models.DateTimeTimeZone>(global::AITGraph.Sdk.Models.DateTimeTimeZone.CreateFromDiscriminatorValue); } },
                { "invoiceId", n => { InvoiceId = n.GetStringValue(); } },
                { "invoiceStatus", n => { InvoiceStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.BookingInvoiceStatus>(); } },
                ...
                { "priceType", n => { PriceType = n.GetEnumValue<global::AITGraph.Sdk.Models.BookingPriceType>(); } },
                { "reminders", n => { Reminders = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.BookingReminder>(global::AITGraph.Sdk.Models.BookingReminder.CreateFromDiscriminatorValue)?.AsList(); } },
                { "selfServiceAppointmentId", n => { SelfServiceAppointmentId = n.GetStringValue(); } },
                { "serviceId", n => { ServiceId = n.GetStringValue(); } },
                { "serviceLocation", n => { ServiceLocation = n.GetObjectValue<global::AITGraph.Sdk.Models.Location>(global::AITGraph.Sdk.Models.Location.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.Location>("customerLocation", CustomerLocation);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.BookingCustomerInformationBase>("customers", Customers);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.DateTimeTimeZone>("invoiceDate", InvoiceDate);
            writer.WriteStringValue("invoiceId", InvoiceId);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.BookingInvoiceStatus>("invoiceStatus", InvoiceStatus);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.BookingPriceType>("priceType", PriceType);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.BookingReminder>("reminders", Reminders);
            writer.WriteStringValue("selfServiceAppointmentId", SelfServiceAppointmentId);
            writer.WriteStringValue("serviceId", ServiceId);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.Location>("serviceLocation", ServiceLocation);
