...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.PendingContentUpdate? PendingContentUpdate { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.PendingContentUpdate PendingContentUpdate { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"pendingContentUpdate", n => { PendingContentUpdate = n.GetObjectValue<AITGraph.Sdk.Models.PendingContentUpdate>(AITGraph.Sdk.Models.PendingContentUpdate.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.PendingContentUpdate>("pendingContentUpdate", PendingContentUpdate);
