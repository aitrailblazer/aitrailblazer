...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.AutomaticRepliesSetting? AutomaticRepliesSetting { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.AutomaticRepliesSetting AutomaticRepliesSetting { get; set; }
#endif
...
#nullable restore
        ...
        public AITGraph.Sdk.Models.DelegateMeetingMessageDeliveryOptions? DelegateMeetingMessageDeliveryOptions { get; set; }
...
#nullable restore
        ...
        public AITGraph.Sdk.Models.UserPurpose? UserPurpose { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.WorkingHours? WorkingHours { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.WorkingHours WorkingHours { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"automaticRepliesSetting", n => { AutomaticRepliesSetting = n.GetObjectValue<AITGraph.Sdk.Models.AutomaticRepliesSetting>(AITGraph.Sdk.Models.AutomaticRepliesSetting.CreateFromDiscriminatorValue); } },
                ...
                {"workingHours", n => { WorkingHours = n.GetObjectValue<AITGraph.Sdk.Models.WorkingHours>(AITGraph.Sdk.Models.WorkingHours.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.AutomaticRepliesSetting>("automaticRepliesSetting", AutomaticRepliesSetting);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.WorkingHours>("workingHours", WorkingHours);
