...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class WindowsDriverUpdateInventory : global::AITGraph.Sdk.Models.Entity, IParsable
    {
        ...
        public global::AITGraph.Sdk.Models.DriverApprovalStatus? ApprovalStatus { get; set; }
        /// <summary>An enum type to represent which category a driver belongs to.</summary>
        public global::AITGraph.Sdk.Models.DriverCategory? Category { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.WindowsDriverUpdateInventory"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.WindowsDriverUpdateInventory CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.WindowsDriverUpdateInventory();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "approvalStatus", n => { ApprovalStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.DriverApprovalStatus>(); } },
                { "category", n => { Category = n.GetEnumValue<global::AITGraph.Sdk.Models.DriverCategory>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DriverApprovalStatus>("approvalStatus", ApprovalStatus);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DriverCategory>("category", Category);
