...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class Fido2AuthenticationMethod : global::AITGraph.Sdk.Models.AuthenticationMethod, IParsable
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.AttestationLevel? AttestationLevel { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.Fido2AuthenticationMethod"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Fido2AuthenticationMethod"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.Fido2AuthenticationMethod CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Fido2AuthenticationMethod();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "attestationLevel", n => { AttestationLevel = n.GetEnumValue<global::AITGraph.Sdk.Models.AttestationLevel>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AttestationLevel>("attestationLevel", AttestationLevel);
