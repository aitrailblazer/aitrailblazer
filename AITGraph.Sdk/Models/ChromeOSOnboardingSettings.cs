...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class ChromeOSOnboardingSettings : global::AITGraph.Sdk.Models.Entity, IParsable
    {
        ...
        public global::AITGraph.Sdk.Models.OnboardingStatus? OnboardingStatus { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.ChromeOSOnboardingSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.ChromeOSOnboardingSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.ChromeOSOnboardingSettings();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "onboardingStatus", n => { OnboardingStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.OnboardingStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.OnboardingStatus>("onboardingStatus", OnboardingStatus);
