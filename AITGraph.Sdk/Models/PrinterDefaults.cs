...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.PrintDuplexConfiguration? DuplexConfiguration { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.PrintPresentationDirection? PresentationDirection { get; set; }
        /// <summary>The printColorConfiguration property</summary>
        public global::AITGraph.Sdk.Models.PrintColorConfiguration? PrintColorConfiguration { get; set; }
        /// <summary>The printQuality property</summary>
        public global::AITGraph.Sdk.Models.PrintQuality? PrintQuality { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.PrinterDefaults"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.PrinterDefaults"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.PrinterDefaults CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.PrinterDefaults();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "duplexConfiguration", n => { DuplexConfiguration = n.GetEnumValue<global::AITGraph.Sdk.Models.PrintDuplexConfiguration>(); } },
                ...
                { "presentationDirection", n => { PresentationDirection = n.GetEnumValue<global::AITGraph.Sdk.Models.PrintPresentationDirection>(); } },
                { "printColorConfiguration", n => { PrintColorConfiguration = n.GetEnumValue<global::AITGraph.Sdk.Models.PrintColorConfiguration>(); } },
                { "printQuality", n => { PrintQuality = n.GetEnumValue<global::AITGraph.Sdk.Models.PrintQuality>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.PrintDuplexConfiguration>("duplexConfiguration", DuplexConfiguration);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.PrintPresentationDirection>("presentationDirection", PresentationDirection);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.PrintColorConfiguration>("printColorConfiguration", PrintColorConfiguration);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.PrintQuality>("printQuality", PrintQuality);
