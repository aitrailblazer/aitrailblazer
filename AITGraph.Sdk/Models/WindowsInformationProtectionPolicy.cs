...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class WindowsInformationProtectionPolicy : global::AITGraph.Sdk.Models.WindowsInformationProtection, IParsable
    {
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.WindowsInformationProtectionPinCharacterRequirements? PinLowercaseLetters { get; set; }
        ...
        /// <summary>Pin Character Requirements</summary>
        public global::AITGraph.Sdk.Models.WindowsInformationProtectionPinCharacterRequirements? PinSpecialCharacters { get; set; }
        /// <summary>Pin Character Requirements</summary>
        public global::AITGraph.Sdk.Models.WindowsInformationProtectionPinCharacterRequirements? PinUppercaseLetters { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.WindowsInformationProtectionPolicy"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.WindowsInformationProtectionPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.WindowsInformationProtectionPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.WindowsInformationProtectionPolicy();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "pinLowercaseLetters", n => { PinLowercaseLetters = n.GetEnumValue<global::AITGraph.Sdk.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
                { "pinMinimumLength", n => { PinMinimumLength = n.GetIntValue(); } },
                { "pinSpecialCharacters", n => { PinSpecialCharacters = n.GetEnumValue<global::AITGraph.Sdk.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
                { "pinUppercaseLetters", n => { PinUppercaseLetters = n.GetEnumValue<global::AITGraph.Sdk.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WindowsInformationProtectionPinCharacterRequirements>("pinLowercaseLetters", PinLowercaseLetters);
            writer.WriteIntValue("pinMinimumLength", PinMinimumLength);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WindowsInformationProtectionPinCharacterRequirements>("pinSpecialCharacters", PinSpecialCharacters);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WindowsInformationProtectionPinCharacterRequirements>("pinUppercaseLetters", PinUppercaseLetters);
