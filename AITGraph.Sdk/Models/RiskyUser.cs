...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class RiskyUser : global::AITGraph.Sdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The history property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.RiskyUserHistoryItem>? History { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.RiskyUserHistoryItem> History { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.RiskyUser"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.RiskyUser CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::AITGraph.Sdk.Models.RiskyUser(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "history", n => { History = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.RiskyUserHistoryItem>(global::AITGraph.Sdk.Models.RiskyUserHistoryItem.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.RiskyUserHistoryItem>("history", History);
