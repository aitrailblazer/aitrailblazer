...
#nullable enable
        public AITGraph.Sdk.Models.Call? Call { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Call Call { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"call", n => { Call = n.GetObjectValue<AITGraph.Sdk.Models.Call>(AITGraph.Sdk.Models.Call.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Call>("call", Call);
