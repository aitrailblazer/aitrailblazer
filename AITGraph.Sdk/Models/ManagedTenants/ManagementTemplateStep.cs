...
namespace AITGraph.Sdk.Models.ManagedTenants {
    public class ManagementTemplateStep : AITGraph.Sdk.Models.Entity, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ManagedTenants.ManagementTemplate? ManagementTemplate { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ManagedTenants.ManagementTemplate ManagementTemplate { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ActionUrl? PortalLink { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ActionUrl PortalLink { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"managementTemplate", n => { ManagementTemplate = n.GetObjectValue<AITGraph.Sdk.Models.ManagedTenants.ManagementTemplate>(AITGraph.Sdk.Models.ManagedTenants.ManagementTemplate.CreateFromDiscriminatorValue); } },
                {"portalLink", n => { PortalLink = n.GetObjectValue<AITGraph.Sdk.Models.ActionUrl>(AITGraph.Sdk.Models.ActionUrl.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ManagedTenants.ManagementTemplate>("managementTemplate", ManagementTemplate);
            writer.WriteObjectValue<AITGraph.Sdk.Models.ActionUrl>("portalLink", PortalLink);
