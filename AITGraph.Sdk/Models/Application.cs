...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Certification? Certification { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Certification Certification { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ConnectorGroup? ConnectorGroup { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ConnectorGroup ConnectorGroup { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.OnPremisesPublishing? OnPremisesPublishing { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.OnPremisesPublishing OnPremisesPublishing { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.OptionalClaims? OptionalClaims { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.OptionalClaims OptionalClaims { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ParentalControlSettings? ParentalControlSettings { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ParentalControlSettings ParentalControlSettings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.RequestSignatureVerification? RequestSignatureVerification { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.RequestSignatureVerification RequestSignatureVerification { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AITGraph.Sdk.Models.RequiredResourceAccess>? RequiredResourceAccess { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.RequiredResourceAccess> RequiredResourceAccess { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ServicePrincipalLockConfiguration? ServicePrincipalLockConfiguration { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ServicePrincipalLockConfiguration ServicePrincipalLockConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Synchronization? Synchronization { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Synchronization Synchronization { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.VerifiedPublisher? VerifiedPublisher { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.VerifiedPublisher VerifiedPublisher { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"certification", n => { Certification = n.GetObjectValue<AITGraph.Sdk.Models.Certification>(AITGraph.Sdk.Models.Certification.CreateFromDiscriminatorValue); } },
                {"connectorGroup", n => { ConnectorGroup = n.GetObjectValue<AITGraph.Sdk.Models.ConnectorGroup>(AITGraph.Sdk.Models.ConnectorGroup.CreateFromDiscriminatorValue); } },
                ...
                {"onPremisesPublishing", n => { OnPremisesPublishing = n.GetObjectValue<AITGraph.Sdk.Models.OnPremisesPublishing>(AITGraph.Sdk.Models.OnPremisesPublishing.CreateFromDiscriminatorValue); } },
                {"optionalClaims", n => { OptionalClaims = n.GetObjectValue<AITGraph.Sdk.Models.OptionalClaims>(AITGraph.Sdk.Models.OptionalClaims.CreateFromDiscriminatorValue); } },
                {"owners", n => { Owners = n.GetCollectionOfObjectValues<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue)?.ToList(); } },
                {"parentalControlSettings", n => { ParentalControlSettings = n.GetObjectValue<AITGraph.Sdk.Models.ParentalControlSettings>(AITGraph.Sdk.Models.ParentalControlSettings.CreateFromDiscriminatorValue); } },
                ...
                {"requestSignatureVerification", n => { RequestSignatureVerification = n.GetObjectValue<AITGraph.Sdk.Models.RequestSignatureVerification>(AITGraph.Sdk.Models.RequestSignatureVerification.CreateFromDiscriminatorValue); } },
                {"requiredResourceAccess", n => { RequiredResourceAccess = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.RequiredResourceAccess>(AITGraph.Sdk.Models.RequiredResourceAccess.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"servicePrincipalLockConfiguration", n => { ServicePrincipalLockConfiguration = n.GetObjectValue<AITGraph.Sdk.Models.ServicePrincipalLockConfiguration>(AITGraph.Sdk.Models.ServicePrincipalLockConfiguration.CreateFromDiscriminatorValue); } },
                ...
                {"synchronization", n => { Synchronization = n.GetObjectValue<AITGraph.Sdk.Models.Synchronization>(AITGraph.Sdk.Models.Synchronization.CreateFromDiscriminatorValue); } },
                ...
                {"verifiedPublisher", n => { VerifiedPublisher = n.GetObjectValue<AITGraph.Sdk.Models.VerifiedPublisher>(AITGraph.Sdk.Models.VerifiedPublisher.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Certification>("certification", Certification);
            writer.WriteObjectValue<AITGraph.Sdk.Models.ConnectorGroup>("connectorGroup", ConnectorGroup);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.OnPremisesPublishing>("onPremisesPublishing", OnPremisesPublishing);
            writer.WriteObjectValue<AITGraph.Sdk.Models.OptionalClaims>("optionalClaims", OptionalClaims);
            writer.WriteCollectionOfObjectValues<DirectoryObject>("owners", Owners);
            writer.WriteObjectValue<AITGraph.Sdk.Models.ParentalControlSettings>("parentalControlSettings", ParentalControlSettings);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.RequestSignatureVerification>("requestSignatureVerification", RequestSignatureVerification);
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.RequiredResourceAccess>("requiredResourceAccess", RequiredResourceAccess);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ServicePrincipalLockConfiguration>("servicePrincipalLockConfiguration", ServicePrincipalLockConfiguration);
            writer.WriteStringValue("signInAudience", SignInAudience);
            writer.WriteObjectValue<SpaApplication>("spa", Spa);
            writer.WriteObjectValue<AITGraph.Sdk.Models.Synchronization>("synchronization", Synchronization);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.VerifiedPublisher>("verifiedPublisher", VerifiedPublisher);
