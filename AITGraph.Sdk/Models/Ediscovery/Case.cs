...
namespace AITGraph.Sdk.Models.Ediscovery {
    public class Case : AITGraph.Sdk.Models.Entity, IParsable {
        /// <summary>The user who closed the case.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.IdentitySet? ClosedBy { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.IdentitySet ClosedBy { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"closedBy", n => { ClosedBy = n.GetObjectValue<AITGraph.Sdk.Models.IdentitySet>(AITGraph.Sdk.Models.IdentitySet.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.IdentitySet>("closedBy", ClosedBy);
