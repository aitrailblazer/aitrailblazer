...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class DeviceComplianceScript : global::AITGraph.Sdk.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.DeviceComplianceScriptDeviceState>? DeviceRunStates { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.DeviceComplianceScriptDeviceState> DeviceRunStates { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.DeviceComplianceScriptRunSummary? RunSummary { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.DeviceComplianceScriptRunSummary RunSummary { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.DeviceComplianceScript"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.DeviceComplianceScript CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.DeviceComplianceScript();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "deviceRunStates", n => { DeviceRunStates = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.DeviceComplianceScriptDeviceState>(global::AITGraph.Sdk.Models.DeviceComplianceScriptDeviceState.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "runSummary", n => { RunSummary = n.GetObjectValue<global::AITGraph.Sdk.Models.DeviceComplianceScriptRunSummary>(global::AITGraph.Sdk.Models.DeviceComplianceScriptRunSummary.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.DeviceComplianceScriptDeviceState>("deviceRunStates", DeviceRunStates);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.DeviceComplianceScriptRunSummary>("runSummary", RunSummary);
