...
namespace AITGraph.Sdk.Models.Security {
    public class RetentionLabel : AITGraph.Sdk.Models.Entity, IParsable {
        ...
        public AITGraph.Sdk.Models.Security.ActionAfterRetentionPeriod? ActionAfterRetentionPeriod { get; set; }
        ...
        public AITGraph.Sdk.Models.Security.BehaviorDuringRetentionPeriod? BehaviorDuringRetentionPeriod { get; set; }
...
#nullable restore
        ...
        public AITGraph.Sdk.Models.Security.DefaultRecordBehavior? DefaultRecordBehavior { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.IdentitySet? LastModifiedBy { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.IdentitySet LastModifiedBy { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Security.RetentionDuration? RetentionDuration { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Security.RetentionDuration RetentionDuration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Security.RetentionEventType? RetentionEventType { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Security.RetentionEventType RetentionEventType { get; set; }
#endif
        ...
        public AITGraph.Sdk.Models.Security.RetentionTrigger? RetentionTrigger { get; set; }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"lastModifiedBy", n => { LastModifiedBy = n.GetObjectValue<AITGraph.Sdk.Models.IdentitySet>(AITGraph.Sdk.Models.IdentitySet.CreateFromDiscriminatorValue); } },
                {"lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                {"retentionDuration", n => { RetentionDuration = n.GetObjectValue<AITGraph.Sdk.Models.Security.RetentionDuration>(AITGraph.Sdk.Models.Security.RetentionDuration.CreateFromDiscriminatorValue); } },
                {"retentionEventType", n => { RetentionEventType = n.GetObjectValue<AITGraph.Sdk.Models.Security.RetentionEventType>(AITGraph.Sdk.Models.Security.RetentionEventType.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.IdentitySet>("lastModifiedBy", LastModifiedBy);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteObjectValue<AITGraph.Sdk.Models.Security.RetentionDuration>("retentionDuration", RetentionDuration);
            writer.WriteObjectValue<AITGraph.Sdk.Models.Security.RetentionEventType>("retentionEventType", RetentionEventType);
