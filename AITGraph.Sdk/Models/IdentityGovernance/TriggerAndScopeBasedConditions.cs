...
#nullable enable
        public AITGraph.Sdk.Models.SubjectSet? Scope { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.SubjectSet Scope { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"scope", n => { Scope = n.GetObjectValue<AITGraph.Sdk.Models.SubjectSet>(AITGraph.Sdk.Models.SubjectSet.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.SubjectSet>("scope", Scope);
