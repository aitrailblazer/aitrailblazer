...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class BookingService : global::AITGraph.Sdk.Models.BookingNamedEntity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.BookingQuestionAssignment>? CustomQuestions { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.BookingQuestionAssignment> CustomQuestions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.Location? DefaultLocation { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.Location DefaultLocation { get; set; }
#endif
        ...
        public global::AITGraph.Sdk.Models.BookingPriceType? DefaultPriceType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.BookingReminder>? DefaultReminders { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.BookingReminder> DefaultReminders { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.BookingService"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.BookingService"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.BookingService CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.BookingService();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "customQuestions", n => { CustomQuestions = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.BookingQuestionAssignment>(global::AITGraph.Sdk.Models.BookingQuestionAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
                { "defaultDuration", n => { DefaultDuration = n.GetTimeSpanValue(); } },
                { "defaultLocation", n => { DefaultLocation = n.GetObjectValue<global::AITGraph.Sdk.Models.Location>(global::AITGraph.Sdk.Models.Location.CreateFromDiscriminatorValue); } },
                { "defaultPrice", n => { DefaultPrice = n.GetDoubleValue(); } },
                { "defaultPriceType", n => { DefaultPriceType = n.GetEnumValue<global::AITGraph.Sdk.Models.BookingPriceType>(); } },
                { "defaultReminders", n => { DefaultReminders = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.BookingReminder>(global::AITGraph.Sdk.Models.BookingReminder.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.BookingQuestionAssignment>("customQuestions", CustomQuestions);
            writer.WriteTimeSpanValue("defaultDuration", DefaultDuration);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.Location>("defaultLocation", DefaultLocation);
            writer.WriteDoubleValue("defaultPrice", DefaultPrice);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.BookingPriceType>("defaultPriceType", DefaultPriceType);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.BookingReminder>("defaultReminders", DefaultReminders);
