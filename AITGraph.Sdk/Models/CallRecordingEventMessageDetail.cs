...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class CallRecordingEventMessageDetail : global::AITGraph.Sdk.Models.EventMessageDetail, IParsable
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.CallRecordingStatus? CallRecordingStatus { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.IdentitySet? MeetingOrganizer { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.IdentitySet MeetingOrganizer { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.CallRecordingEventMessageDetail"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.CallRecordingEventMessageDetail"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.CallRecordingEventMessageDetail CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.CallRecordingEventMessageDetail();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "callRecordingStatus", n => { CallRecordingStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.CallRecordingStatus>(); } },
                ...
                { "meetingOrganizer", n => { MeetingOrganizer = n.GetObjectValue<global::AITGraph.Sdk.Models.IdentitySet>(global::AITGraph.Sdk.Models.IdentitySet.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.CallRecordingStatus>("callRecordingStatus", CallRecordingStatus);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.IdentitySet>("meetingOrganizer", MeetingOrganizer);
        }
    }
}
