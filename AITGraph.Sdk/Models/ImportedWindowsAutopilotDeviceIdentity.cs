...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class ImportedWindowsAutopilotDeviceIdentity : global::AITGraph.Sdk.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.ImportedWindowsAutopilotDeviceIdentityState? State { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.ImportedWindowsAutopilotDeviceIdentityState State { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.ImportedWindowsAutopilotDeviceIdentity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.ImportedWindowsAutopilotDeviceIdentity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.ImportedWindowsAutopilotDeviceIdentity();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "state", n => { State = n.GetObjectValue<global::AITGraph.Sdk.Models.ImportedWindowsAutopilotDeviceIdentityState>(global::AITGraph.Sdk.Models.ImportedWindowsAutopilotDeviceIdentityState.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.ImportedWindowsAutopilotDeviceIdentityState>("state", State);
        }
    }
}
