...
namespace AITGraph.Sdk.Models.IdentityGovernance {
    public class TaskObject : AITGraph.Sdk.Models.Entity, IParsable {
...
#nullable enable
        public List<AITGraph.Sdk.Models.KeyValuePair>? Arguments { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.KeyValuePair> Arguments { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"arguments", n => { Arguments = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.KeyValuePair>(AITGraph.Sdk.Models.KeyValuePair.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.KeyValuePair>("arguments", Arguments);
