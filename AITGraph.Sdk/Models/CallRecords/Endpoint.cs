...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.CallRecords.UserAgent? UserAgent { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.CallRecords.UserAgent UserAgent { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"userAgent", n => { UserAgent = n.GetObjectValue<AITGraph.Sdk.Models.CallRecords.UserAgent>(AITGraph.Sdk.Models.CallRecords.UserAgent.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.CallRecords.UserAgent>("userAgent", UserAgent);
