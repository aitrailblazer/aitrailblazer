...
namespace AITGraph.Sdk.Models {
    public class PlannerRuleOverride : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public static PlannerRuleOverride CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"rules", n => { Rules = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
            };
        }
        /// <summary>
