...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.SynchronizationError? Error { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.SynchronizationError Error { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.SynchronizationTaskExecutionResult? State { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.SynchronizationTaskExecution"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.SynchronizationTaskExecution"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.SynchronizationTaskExecution CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.SynchronizationTaskExecution();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "error", n => { Error = n.GetObjectValue<global::AITGraph.Sdk.Models.SynchronizationError>(global::AITGraph.Sdk.Models.SynchronizationError.CreateFromDiscriminatorValue); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "state", n => { State = n.GetEnumValue<global::AITGraph.Sdk.Models.SynchronizationTaskExecutionResult>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.SynchronizationError>("error", Error);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.SynchronizationTaskExecutionResult>("state", State);
