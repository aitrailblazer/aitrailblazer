...
#nullable enable
        public List<AITGraph.Sdk.Models.AuthenticationMethodModes?>? AuthenticationCombinations { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.AuthenticationMethodModes?> AuthenticationCombinations { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AITGraph.Sdk.Models.AuthenticationMethodModes?>? Combinations { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.AuthenticationMethodModes?> Combinations { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"authenticationCombinations", n => { AuthenticationCombinations = n.GetCollectionOfEnumValues<AITGraph.Sdk.Models.AuthenticationMethodModes>()?.ToList(); } },
                ...
                {"combinations", n => { Combinations = n.GetCollectionOfEnumValues<AITGraph.Sdk.Models.AuthenticationMethodModes>()?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfEnumValues<AITGraph.Sdk.Models.AuthenticationMethodModes>("authenticationCombinations", AuthenticationCombinations);
            writer.WriteCollectionOfObjectValues<AuthenticationMethodModeDetail>("authenticationMethodModes", AuthenticationMethodModes);
            writer.WriteCollectionOfEnumValues<AITGraph.Sdk.Models.AuthenticationMethodModes>("combinations", Combinations);
