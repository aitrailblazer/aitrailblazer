...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.StoragePlanInformation? StoragePlanInformation { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.StoragePlanInformation StoragePlanInformation { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.Quota"/> and sets the default values.
        /// </summary>
        public Quota()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Quota"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.Quota CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Quota();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "storagePlanInformation", n => { StoragePlanInformation = n.GetObjectValue<global::AITGraph.Sdk.Models.StoragePlanInformation>(global::AITGraph.Sdk.Models.StoragePlanInformation.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.StoragePlanInformation>("storagePlanInformation", StoragePlanInformation);
