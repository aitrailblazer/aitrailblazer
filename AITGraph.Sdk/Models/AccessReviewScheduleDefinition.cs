...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AccessReviewScheduleDefinition : global::AITGraph.Sdk.Models.Entity, IParsable
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.AccessReviewNotificationRecipientItem>? AdditionalNotificationRecipients { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AccessReviewNotificationRecipientItem> AdditionalNotificationRecipients { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.AccessReviewReviewerScope>? BackupReviewers { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AccessReviewReviewerScope> BackupReviewers { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.AccessReviewScope? InstanceEnumerationScope { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AccessReviewScope InstanceEnumerationScope { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.AccessReviewInstance>? Instances { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AccessReviewInstance> Instances { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.AccessReviewScheduleSettings? Settings { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AccessReviewScheduleSettings Settings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.AccessReviewStageSettings>? StageSettings { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AccessReviewStageSettings> StageSettings { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AccessReviewScheduleDefinition"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.AccessReviewScheduleDefinition CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AccessReviewScheduleDefinition();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "additionalNotificationRecipients", n => { AdditionalNotificationRecipients = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessReviewNotificationRecipientItem>(global::AITGraph.Sdk.Models.AccessReviewNotificationRecipientItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "backupReviewers", n => { BackupReviewers = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessReviewReviewerScope>(global::AITGraph.Sdk.Models.AccessReviewReviewerScope.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "instanceEnumerationScope", n => { InstanceEnumerationScope = n.GetObjectValue<global::AITGraph.Sdk.Models.AccessReviewScope>(global::AITGraph.Sdk.Models.AccessReviewScope.CreateFromDiscriminatorValue); } },
                { "instances", n => { Instances = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessReviewInstance>(global::AITGraph.Sdk.Models.AccessReviewInstance.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "settings", n => { Settings = n.GetObjectValue<global::AITGraph.Sdk.Models.AccessReviewScheduleSettings>(global::AITGraph.Sdk.Models.AccessReviewScheduleSettings.CreateFromDiscriminatorValue); } },
                { "stageSettings", n => { StageSettings = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessReviewStageSettings>(global::AITGraph.Sdk.Models.AccessReviewStageSettings.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessReviewNotificationRecipientItem>("additionalNotificationRecipients", AdditionalNotificationRecipients);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessReviewReviewerScope>("backupReviewers", BackupReviewers);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AccessReviewScope>("instanceEnumerationScope", InstanceEnumerationScope);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessReviewInstance>("instances", Instances);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AccessReviewScheduleSettings>("settings", Settings);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessReviewStageSettings>("stageSettings", StageSettings);
