...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class DeviceManagementExchangeConnector : global::AITGraph.Sdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.DeviceManagementExchangeConnectorType? ExchangeConnectorType { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.DeviceManagementExchangeConnectorStatus? Status { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.DeviceManagementExchangeConnector"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.DeviceManagementExchangeConnector CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.DeviceManagementExchangeConnector();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "exchangeConnectorType", n => { ExchangeConnectorType = n.GetEnumValue<global::AITGraph.Sdk.Models.DeviceManagementExchangeConnectorType>(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::AITGraph.Sdk.Models.DeviceManagementExchangeConnectorStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceManagementExchangeConnectorType>("exchangeConnectorType", ExchangeConnectorType);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceManagementExchangeConnectorStatus>("status", Status);
