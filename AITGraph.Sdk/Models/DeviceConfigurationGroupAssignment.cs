...
#nullable enable
        public AITGraph.Sdk.Models.DeviceConfiguration? DeviceConfiguration { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.DeviceConfiguration DeviceConfiguration { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"deviceConfiguration", n => { DeviceConfiguration = n.GetObjectValue<AITGraph.Sdk.Models.DeviceConfiguration>(AITGraph.Sdk.Models.DeviceConfiguration.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.DeviceConfiguration>("deviceConfiguration", DeviceConfiguration);
