...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class ServiceUpdateMessage : global::AITGraph.Sdk.Models.ServiceAnnouncementBase, IParsable
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.ServiceAnnouncementAttachment>? Attachments { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.ServiceAnnouncementAttachment> Attachments { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.ServiceUpdateCategory? Category { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.ServiceUpdateSeverity? Severity { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.ServiceUpdateMessageViewpoint? ViewPoint { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.ServiceUpdateMessageViewpoint ViewPoint { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.ServiceUpdateMessage"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.ServiceUpdateMessage"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.ServiceUpdateMessage CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.ServiceUpdateMessage();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "attachments", n => { Attachments = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.ServiceAnnouncementAttachment>(global::AITGraph.Sdk.Models.ServiceAnnouncementAttachment.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "category", n => { Category = n.GetEnumValue<global::AITGraph.Sdk.Models.ServiceUpdateCategory>(); } },
                { "hasAttachments", n => { HasAttachments = n.GetBoolValue(); } },
                { "isMajorChange", n => { IsMajorChange = n.GetBoolValue(); } },
                { "services", n => { Services = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "severity", n => { Severity = n.GetEnumValue<global::AITGraph.Sdk.Models.ServiceUpdateSeverity>(); } },
                { "tags", n => { Tags = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "viewPoint", n => { ViewPoint = n.GetObjectValue<global::AITGraph.Sdk.Models.ServiceUpdateMessageViewpoint>(global::AITGraph.Sdk.Models.ServiceUpdateMessageViewpoint.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.ServiceAnnouncementAttachment>("attachments", Attachments);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ServiceUpdateCategory>("category", Category);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ServiceUpdateSeverity>("severity", Severity);
            writer.WriteCollectionOfPrimitiveValues<string>("tags", Tags);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.ServiceUpdateMessageViewpoint>("viewPoint", ViewPoint);
        }
    }
}
