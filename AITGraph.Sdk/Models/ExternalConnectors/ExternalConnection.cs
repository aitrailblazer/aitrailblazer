...
namespace AITGraph.Sdk.Models.ExternalConnectors {
    public class ExternalConnection : AITGraph.Sdk.Models.Entity, IParsable {
        /// <summary>Collects configurable settings related to activities involving connector content.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ExternalConnectors.ActivitySettings? ActivitySettings { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ExternalConnectors.ActivitySettings ActivitySettings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ExternalConnectors.ComplianceSettings? ComplianceSettings { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ExternalConnectors.ComplianceSettings ComplianceSettings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ExternalConnectors.Configuration? Configuration { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ExternalConnectors.Configuration Configuration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ExternalConnectors.Schema? Schema { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ExternalConnectors.Schema Schema { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ExternalConnectors.SearchSettings? SearchSettings { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ExternalConnectors.SearchSettings SearchSettings { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"activitySettings", n => { ActivitySettings = n.GetObjectValue<AITGraph.Sdk.Models.ExternalConnectors.ActivitySettings>(AITGraph.Sdk.Models.ExternalConnectors.ActivitySettings.CreateFromDiscriminatorValue); } },
                {"complianceSettings", n => { ComplianceSettings = n.GetObjectValue<AITGraph.Sdk.Models.ExternalConnectors.ComplianceSettings>(AITGraph.Sdk.Models.ExternalConnectors.ComplianceSettings.CreateFromDiscriminatorValue); } },
                {"configuration", n => { Configuration = n.GetObjectValue<AITGraph.Sdk.Models.ExternalConnectors.Configuration>(AITGraph.Sdk.Models.ExternalConnectors.Configuration.CreateFromDiscriminatorValue); } },
                ...
                {"schema", n => { Schema = n.GetObjectValue<AITGraph.Sdk.Models.ExternalConnectors.Schema>(AITGraph.Sdk.Models.ExternalConnectors.Schema.CreateFromDiscriminatorValue); } },
                {"searchSettings", n => { SearchSettings = n.GetObjectValue<AITGraph.Sdk.Models.ExternalConnectors.SearchSettings>(AITGraph.Sdk.Models.ExternalConnectors.SearchSettings.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ExternalConnectors.ActivitySettings>("activitySettings", ActivitySettings);
            writer.WriteObjectValue<AITGraph.Sdk.Models.ExternalConnectors.ComplianceSettings>("complianceSettings", ComplianceSettings);
            writer.WriteObjectValue<AITGraph.Sdk.Models.ExternalConnectors.Configuration>("configuration", Configuration);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ExternalConnectors.Schema>("schema", Schema);
            writer.WriteObjectValue<AITGraph.Sdk.Models.ExternalConnectors.SearchSettings>("searchSettings", SearchSettings);
        }
    }
}
