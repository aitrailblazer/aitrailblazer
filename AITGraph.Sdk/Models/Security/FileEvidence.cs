...
namespace AITGraph.Sdk.Models.Security {
    public class FileEvidence : AlertEvidence, IParsable {
        ...
        public AITGraph.Sdk.Models.Security.DetectionStatus? DetectionStatus { get; set; }
        /// <summary>The file details.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Security.FileDetails? FileDetails { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Security.FileDetails FileDetails { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"fileDetails", n => { FileDetails = n.GetObjectValue<AITGraph.Sdk.Models.Security.FileDetails>(AITGraph.Sdk.Models.Security.FileDetails.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Security.FileDetails>("fileDetails", FileDetails);
