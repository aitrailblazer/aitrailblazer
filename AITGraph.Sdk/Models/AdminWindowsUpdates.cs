...
#nullable enable
        public AITGraph.Sdk.Models.WindowsUpdates.Catalog? Catalog { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.WindowsUpdates.Catalog Catalog { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"catalog", n => { Catalog = n.GetObjectValue<AITGraph.Sdk.Models.WindowsUpdates.Catalog>(AITGraph.Sdk.Models.WindowsUpdates.Catalog.CreateFromDiscriminatorValue); } },
                ...
                {"updatePolicies", n => { UpdatePolicies = n.GetCollectionOfObjectValues<UpdatePolicy>(UpdatePolicy.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.WindowsUpdates.Catalog>("catalog", Catalog);
            ...
            writer.WriteCollectionOfObjectValues<UpdatePolicy>("updatePolicies", UpdatePolicies);
        }
    }
}
