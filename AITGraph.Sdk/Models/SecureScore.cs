...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class SecureScore : global::AITGraph.Sdk.Models.Entity, IParsable
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.AverageComparativeScore>? AverageComparativeScores { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AverageComparativeScore> AverageComparativeScores { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.ControlScore>? ControlScores { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.ControlScore> ControlScores { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.SecureScore"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.SecureScore CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.SecureScore();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "averageComparativeScores", n => { AverageComparativeScores = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AverageComparativeScore>(global::AITGraph.Sdk.Models.AverageComparativeScore.CreateFromDiscriminatorValue)?.AsList(); } },
                { "azureTenantId", n => { AzureTenantId = n.GetStringValue(); } },
                { "controlScores", n => { ControlScores = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.ControlScore>(global::AITGraph.Sdk.Models.ControlScore.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AverageComparativeScore>("averageComparativeScores", AverageComparativeScores);
            writer.WriteStringValue("azureTenantId", AzureTenantId);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.ControlScore>("controlScores", ControlScores);
