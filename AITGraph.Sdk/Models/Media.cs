...
#nullable enable
        public AITGraph.Sdk.Models.MediaSource? MediaSource { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.MediaSource MediaSource { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"mediaSource", n => { MediaSource = n.GetObjectValue<AITGraph.Sdk.Models.MediaSource>(AITGraph.Sdk.Models.MediaSource.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.MediaSource>("mediaSource", MediaSource);
