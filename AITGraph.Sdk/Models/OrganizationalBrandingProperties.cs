...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class OrganizationalBrandingProperties : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.LoginPageLayoutConfiguration? LoginPageLayoutConfiguration { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.LoginPageLayoutConfiguration LoginPageLayoutConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.LoginPageTextVisibilitySettings? LoginPageTextVisibilitySettings { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.LoginPageTextVisibilitySettings LoginPageTextVisibilitySettings { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.OrganizationalBrandingProperties"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.OrganizationalBrandingProperties CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::AITGraph.Sdk.Models.OrganizationalBrandingProperties(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "loginPageLayoutConfiguration", n => { LoginPageLayoutConfiguration = n.GetObjectValue<global::AITGraph.Sdk.Models.LoginPageLayoutConfiguration>(global::AITGraph.Sdk.Models.LoginPageLayoutConfiguration.CreateFromDiscriminatorValue); } },
                { "loginPageTextVisibilitySettings", n => { LoginPageTextVisibilitySettings = n.GetObjectValue<global::AITGraph.Sdk.Models.LoginPageTextVisibilitySettings>(global::AITGraph.Sdk.Models.LoginPageTextVisibilitySettings.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.LoginPageLayoutConfiguration>("loginPageLayoutConfiguration", LoginPageLayoutConfiguration);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.LoginPageTextVisibilitySettings>("loginPageTextVisibilitySettings", LoginPageTextVisibilitySettings);
