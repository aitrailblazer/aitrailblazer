...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ImplicitGrantSettings? ImplicitGrantSettings { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ImplicitGrantSettings ImplicitGrantSettings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AITGraph.Sdk.Models.RedirectUriSettings>? RedirectUriSettings { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.RedirectUriSettings> RedirectUriSettings { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"implicitGrantSettings", n => { ImplicitGrantSettings = n.GetObjectValue<AITGraph.Sdk.Models.ImplicitGrantSettings>(AITGraph.Sdk.Models.ImplicitGrantSettings.CreateFromDiscriminatorValue); } },
                {"logoutUrl", n => { LogoutUrl = n.GetStringValue(); } },
                {"oauth2AllowImplicitFlow", n => { Oauth2AllowImplicitFlow = n.GetBoolValue(); } },
                {"@odata.type", n => { OdataType = n.GetStringValue(); } },
                {"redirectUriSettings", n => { RedirectUriSettings = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.RedirectUriSettings>(AITGraph.Sdk.Models.RedirectUriSettings.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ImplicitGrantSettings>("implicitGrantSettings", ImplicitGrantSettings);
            ...
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.RedirectUriSettings>("redirectUriSettings", RedirectUriSettings);
