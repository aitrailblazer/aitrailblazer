...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class InternalDomainFederation : global::AITGraph.Sdk.Models.SamlOrWsFedProvider, IParsable
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.FederatedIdpMfaBehavior? FederatedIdpMfaBehavior { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.PromptLoginBehavior? PromptLoginBehavior { get; set; }
        /// <summary>Provides status and timestamp of the last update of the signing certificate.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.SigningCertificateUpdateStatus? SigningCertificateUpdateStatus { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.SigningCertificateUpdateStatus SigningCertificateUpdateStatus { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.InternalDomainFederation"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.InternalDomainFederation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.InternalDomainFederation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.InternalDomainFederation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "federatedIdpMfaBehavior", n => { FederatedIdpMfaBehavior = n.GetEnumValue<global::AITGraph.Sdk.Models.FederatedIdpMfaBehavior>(); } },
                ...
                { "promptLoginBehavior", n => { PromptLoginBehavior = n.GetEnumValue<global::AITGraph.Sdk.Models.PromptLoginBehavior>(); } },
                { "signOutUri", n => { SignOutUri = n.GetStringValue(); } },
                { "signingCertificateUpdateStatus", n => { SigningCertificateUpdateStatus = n.GetObjectValue<global::AITGraph.Sdk.Models.SigningCertificateUpdateStatus>(global::AITGraph.Sdk.Models.SigningCertificateUpdateStatus.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.FederatedIdpMfaBehavior>("federatedIdpMfaBehavior", FederatedIdpMfaBehavior);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.PromptLoginBehavior>("promptLoginBehavior", PromptLoginBehavior);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.SigningCertificateUpdateStatus>("signingCertificateUpdateStatus", SigningCertificateUpdateStatus);
