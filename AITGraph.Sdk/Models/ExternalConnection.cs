...
#nullable enable
        public AITGraph.Sdk.Models.Configuration? Configuration { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Configuration Configuration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Schema? Schema { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Schema Schema { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"configuration", n => { Configuration = n.GetObjectValue<AITGraph.Sdk.Models.Configuration>(AITGraph.Sdk.Models.Configuration.CreateFromDiscriminatorValue); } },
                ...
                {"schema", n => { Schema = n.GetObjectValue<AITGraph.Sdk.Models.Schema>(AITGraph.Sdk.Models.Schema.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Configuration>("configuration", Configuration);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Schema>("schema", Schema);
        }
    }
}
