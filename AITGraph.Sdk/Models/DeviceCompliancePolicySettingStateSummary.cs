...
#nullable enable
        public List<global::AITGraph.Sdk.Models.DeviceComplianceSettingState>? DeviceComplianceSettingStates { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.DeviceComplianceSettingState> DeviceComplianceSettingStates { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.DeviceCompliancePolicySettingStateSummary"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.DeviceCompliancePolicySettingStateSummary CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.DeviceCompliancePolicySettingStateSummary();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "deviceComplianceSettingStates", n => { DeviceComplianceSettingStates = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.DeviceComplianceSettingState>(global::AITGraph.Sdk.Models.DeviceComplianceSettingState.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.DeviceComplianceSettingState>("deviceComplianceSettingStates", DeviceComplianceSettingStates);
