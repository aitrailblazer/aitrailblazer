...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class Payload : global::AITGraph.Sdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::AITGraph.Sdk.Models.PayloadBrand? Brand { get; set; }
        /// <summary>The complexity of a payload.Possible values are: unknown, low, medium, high, unknownFutureValue</summary>
        public global::AITGraph.Sdk.Models.PayloadComplexity? Complexity { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.PayloadDetail? Detail { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.PayloadDetail Detail { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.PayloadIndustry? Industry { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.PayloadDeliveryPlatform? Platform { get; set; }
        ...
        public global::AITGraph.Sdk.Models.SimulationAttackType? SimulationAttackType { get; set; }
        /// <summary>The source property</summary>
        public global::AITGraph.Sdk.Models.SimulationContentSource? Source { get; set; }
        ...
        public global::AITGraph.Sdk.Models.SimulationContentStatus? Status { get; set; }
        ...
        public global::AITGraph.Sdk.Models.SimulationAttackTechnique? Technique { get; set; }
        ...
        public global::AITGraph.Sdk.Models.PayloadTheme? Theme { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Payload"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.Payload CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Payload();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "brand", n => { Brand = n.GetEnumValue<global::AITGraph.Sdk.Models.PayloadBrand>(); } },
                { "complexity", n => { Complexity = n.GetEnumValue<global::AITGraph.Sdk.Models.PayloadComplexity>(); } },
                ...
                { "detail", n => { Detail = n.GetObjectValue<global::AITGraph.Sdk.Models.PayloadDetail>(global::AITGraph.Sdk.Models.PayloadDetail.CreateFromDiscriminatorValue); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "industry", n => { Industry = n.GetEnumValue<global::AITGraph.Sdk.Models.PayloadIndustry>(); } },
                ...
                { "platform", n => { Platform = n.GetEnumValue<global::AITGraph.Sdk.Models.PayloadDeliveryPlatform>(); } },
                { "predictedCompromiseRate", n => { PredictedCompromiseRate = n.GetDoubleValue(); } },
                { "simulationAttackType", n => { SimulationAttackType = n.GetEnumValue<global::AITGraph.Sdk.Models.SimulationAttackType>(); } },
                { "source", n => { Source = n.GetEnumValue<global::AITGraph.Sdk.Models.SimulationContentSource>(); } },
                { "status", n => { Status = n.GetEnumValue<global::AITGraph.Sdk.Models.SimulationContentStatus>(); } },
                { "technique", n => { Technique = n.GetEnumValue<global::AITGraph.Sdk.Models.SimulationAttackTechnique>(); } },
                { "theme", n => { Theme = n.GetEnumValue<global::AITGraph.Sdk.Models.PayloadTheme>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.PayloadBrand>("brand", Brand);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.PayloadComplexity>("complexity", Complexity);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.EmailIdentity>("createdBy", CreatedBy);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteStringValue("description", Description);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.PayloadDetail>("detail", Detail);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.PayloadIndustry>("industry", Industry);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.PayloadDeliveryPlatform>("platform", Platform);
            writer.WriteDoubleValue("predictedCompromiseRate", PredictedCompromiseRate);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.SimulationAttackType>("simulationAttackType", SimulationAttackType);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.SimulationContentSource>("source", Source);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.SimulationContentStatus>("status", Status);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.SimulationAttackTechnique>("technique", Technique);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.PayloadTheme>("theme", Theme);
        }
    }
}
