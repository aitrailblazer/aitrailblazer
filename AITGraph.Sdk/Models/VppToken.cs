...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class VppToken : global::AITGraph.Sdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.VppTokenSyncStatus? LastSyncStatus { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.VppTokenState? State { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.VppTokenActionResult>? TokenActionResults { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.VppTokenActionResult> TokenActionResults { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.VppToken"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.VppToken CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.VppToken();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "lastSyncStatus", n => { LastSyncStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.VppTokenSyncStatus>(); } },
                ...
                { "state", n => { State = n.GetEnumValue<global::AITGraph.Sdk.Models.VppTokenState>(); } },
                { "token", n => { Token = n.GetStringValue(); } },
                { "tokenActionResults", n => { TokenActionResults = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.VppTokenActionResult>(global::AITGraph.Sdk.Models.VppTokenActionResult.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.VppTokenSyncStatus>("lastSyncStatus", LastSyncStatus);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.VppTokenState>("state", State);
            writer.WriteStringValue("token", Token);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.VppTokenActionResult>("tokenActionResults", TokenActionResults);
