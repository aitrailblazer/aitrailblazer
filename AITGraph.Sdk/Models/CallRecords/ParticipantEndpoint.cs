...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.IdentitySet? Identity { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.IdentitySet Identity { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"identity", n => { Identity = n.GetObjectValue<AITGraph.Sdk.Models.IdentitySet>(AITGraph.Sdk.Models.IdentitySet.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.IdentitySet>("identity", Identity);
        }
    }
}
