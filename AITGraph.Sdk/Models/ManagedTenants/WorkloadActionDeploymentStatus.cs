...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.GenericError? Error { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.GenericError Error { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"error", n => { Error = n.GetObjectValue<AITGraph.Sdk.Models.GenericError>(AITGraph.Sdk.Models.GenericError.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.GenericError>("error", Error);
