...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.DataSubject? DataSubject { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.DataSubject DataSubject { get; set; }
#endif
        ...
        public AITGraph.Sdk.Models.DataSubjectType? DataSubjectType { get; set; }
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"dataSubject", n => { DataSubject = n.GetObjectValue<AITGraph.Sdk.Models.DataSubject>(AITGraph.Sdk.Models.DataSubject.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.DataSubject>("dataSubject", DataSubject);
