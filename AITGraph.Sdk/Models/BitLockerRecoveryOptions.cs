...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.BitLockerRecoveryInformationType? RecoveryInformationToStore { get; set; }
        /// <summary>Possible values of the ConfigurationUsage list.</summary>
        public global::AITGraph.Sdk.Models.ConfigurationUsage? RecoveryKeyUsage { get; set; }
        /// <summary>Possible values of the ConfigurationUsage list.</summary>
        public global::AITGraph.Sdk.Models.ConfigurationUsage? RecoveryPasswordUsage { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.BitLockerRecoveryOptions"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.BitLockerRecoveryOptions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.BitLockerRecoveryOptions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.BitLockerRecoveryOptions();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "recoveryInformationToStore", n => { RecoveryInformationToStore = n.GetEnumValue<global::AITGraph.Sdk.Models.BitLockerRecoveryInformationType>(); } },
                { "recoveryKeyUsage", n => { RecoveryKeyUsage = n.GetEnumValue<global::AITGraph.Sdk.Models.ConfigurationUsage>(); } },
                { "recoveryPasswordUsage", n => { RecoveryPasswordUsage = n.GetEnumValue<global::AITGraph.Sdk.Models.ConfigurationUsage>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.BitLockerRecoveryInformationType>("recoveryInformationToStore", RecoveryInformationToStore);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ConfigurationUsage>("recoveryKeyUsage", RecoveryKeyUsage);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ConfigurationUsage>("recoveryPasswordUsage", RecoveryPasswordUsage);
