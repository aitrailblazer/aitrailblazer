...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Printer? Printer { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Printer Printer { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"printer", n => { Printer = n.GetObjectValue<AITGraph.Sdk.Models.Printer>(AITGraph.Sdk.Models.Printer.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Printer>("printer", Printer);
