...
namespace AITGraph.Sdk.Models {
    public class PlannerPlanConfigurationBucketDefinition : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public static PlannerPlanConfigurationBucketDefinition CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PlannerPlanConfigurationBucketDefinition();
        }
        /// <summary>
