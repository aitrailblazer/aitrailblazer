...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class VpnOnDemandRule : IAdditionalDataHolder, IParsable
    {
        ...
        public global::AITGraph.Sdk.Models.VpnOnDemandRuleConnectionAction? Action { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.VpnOnDemandRuleConnectionDomainAction? DomainAction { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.VpnOnDemandRuleInterfaceTypeMatch? InterfaceTypeMatch { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.VpnOnDemandRule"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.VpnOnDemandRule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.VpnOnDemandRule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.VpnOnDemandRule();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "action", n => { Action = n.GetEnumValue<global::AITGraph.Sdk.Models.VpnOnDemandRuleConnectionAction>(); } },
                ...
                { "domainAction", n => { DomainAction = n.GetEnumValue<global::AITGraph.Sdk.Models.VpnOnDemandRuleConnectionDomainAction>(); } },
                { "domains", n => { Domains = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "interfaceTypeMatch", n => { InterfaceTypeMatch = n.GetEnumValue<global::AITGraph.Sdk.Models.VpnOnDemandRuleInterfaceTypeMatch>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.VpnOnDemandRuleConnectionAction>("action", Action);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.VpnOnDemandRuleConnectionDomainAction>("domainAction", DomainAction);
            writer.WriteCollectionOfPrimitiveValues<string>("domains", Domains);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.VpnOnDemandRuleInterfaceTypeMatch>("interfaceTypeMatch", InterfaceTypeMatch);
