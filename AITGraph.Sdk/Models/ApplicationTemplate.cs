...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.InformationalUrls? InformationalUrls { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.InformationalUrls InformationalUrls { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.SupportedClaimConfiguration? SupportedClaimConfiguration { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.SupportedClaimConfiguration SupportedClaimConfiguration { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"informationalUrls", n => { InformationalUrls = n.GetObjectValue<AITGraph.Sdk.Models.InformationalUrls>(AITGraph.Sdk.Models.InformationalUrls.CreateFromDiscriminatorValue); } },
                {"logoUrl", n => { LogoUrl = n.GetStringValue(); } },
                {"publisher", n => { Publisher = n.GetStringValue(); } },
                {"supportedClaimConfiguration", n => { SupportedClaimConfiguration = n.GetObjectValue<AITGraph.Sdk.Models.SupportedClaimConfiguration>(AITGraph.Sdk.Models.SupportedClaimConfiguration.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.InformationalUrls>("informationalUrls", InformationalUrls);
            writer.WriteStringValue("logoUrl", LogoUrl);
            writer.WriteStringValue("publisher", Publisher);
            writer.WriteObjectValue<AITGraph.Sdk.Models.SupportedClaimConfiguration>("supportedClaimConfiguration", SupportedClaimConfiguration);
