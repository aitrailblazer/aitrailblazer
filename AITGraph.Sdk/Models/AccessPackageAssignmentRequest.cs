...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AccessPackageAssignmentRequest : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.AccessPackageAssignment? AccessPackageAssignment { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AccessPackageAssignment AccessPackageAssignment { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.AccessPackageAnswer>? Answers { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AccessPackageAnswer> Answers { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.CustomExtensionHandlerInstance>? CustomExtensionHandlerInstances { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.CustomExtensionHandlerInstance> CustomExtensionHandlerInstances { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AccessPackageAssignmentRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.AccessPackageAssignmentRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AccessPackageAssignmentRequest();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "accessPackageAssignment", n => { AccessPackageAssignment = n.GetObjectValue<global::AITGraph.Sdk.Models.AccessPackageAssignment>(global::AITGraph.Sdk.Models.AccessPackageAssignment.CreateFromDiscriminatorValue); } },
                { "answers", n => { Answers = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessPackageAnswer>(global::AITGraph.Sdk.Models.AccessPackageAnswer.CreateFromDiscriminatorValue)?.AsList(); } },
                { "completedDate", n => { CompletedDate = n.GetDateTimeOffsetValue(); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "customExtensionHandlerInstances", n => { CustomExtensionHandlerInstances = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.CustomExtensionHandlerInstance>(global::AITGraph.Sdk.Models.CustomExtensionHandlerInstance.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AccessPackageAssignment>("accessPackageAssignment", AccessPackageAssignment);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessPackageAnswer>("answers", Answers);
            writer.WriteDateTimeOffsetValue("completedDate", CompletedDate);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.CustomExtensionHandlerInstance>("customExtensionHandlerInstances", CustomExtensionHandlerInstances);
