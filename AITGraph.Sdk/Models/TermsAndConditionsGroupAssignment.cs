...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.TermsAndConditions? TermsAndConditions { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.TermsAndConditions TermsAndConditions { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"termsAndConditions", n => { TermsAndConditions = n.GetObjectValue<AITGraph.Sdk.Models.TermsAndConditions>(AITGraph.Sdk.Models.TermsAndConditions.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.TermsAndConditions>("termsAndConditions", TermsAndConditions);
        }
    }
}
