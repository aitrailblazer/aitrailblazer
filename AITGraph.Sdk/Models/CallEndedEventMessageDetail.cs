...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class CallEndedEventMessageDetail : global::AITGraph.Sdk.Models.EventMessageDetail, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.CallParticipantInfo>? CallParticipants { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.CallParticipantInfo> CallParticipants { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.CallEndedEventMessageDetail"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.CallEndedEventMessageDetail"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.CallEndedEventMessageDetail CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.CallEndedEventMessageDetail();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "callParticipants", n => { CallParticipants = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.CallParticipantInfo>(global::AITGraph.Sdk.Models.CallParticipantInfo.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.CallParticipantInfo>("callParticipants", CallParticipants);
