...
#nullable restore
        ...
        public AITGraph.Sdk.Models.PrintColorConfiguration? PrintColorConfiguration { get; set; }
        /// <summary>The printQuality property</summary>
        public AITGraph.Sdk.Models.PrintQuality? PrintQuality { get; set; }
        /// <summary>The default quality to use when printing the document. Valid values are described in the following table.</summary>
        public AITGraph.Sdk.Models.PrintQuality? Quality { get; set; }
