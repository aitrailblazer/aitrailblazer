...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.SimulationEventsContent? SimulationEventsContent { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.SimulationEventsContent SimulationEventsContent { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.TrainingEventsContent? TrainingEventsContent { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.TrainingEventsContent TrainingEventsContent { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"simulationEventsContent", n => { SimulationEventsContent = n.GetObjectValue<AITGraph.Sdk.Models.SimulationEventsContent>(AITGraph.Sdk.Models.SimulationEventsContent.CreateFromDiscriminatorValue); } },
                {"trainingEventsContent", n => { TrainingEventsContent = n.GetObjectValue<AITGraph.Sdk.Models.TrainingEventsContent>(AITGraph.Sdk.Models.TrainingEventsContent.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.SimulationEventsContent>("simulationEventsContent", SimulationEventsContent);
            writer.WriteObjectValue<AITGraph.Sdk.Models.TrainingEventsContent>("trainingEventsContent", TrainingEventsContent);
