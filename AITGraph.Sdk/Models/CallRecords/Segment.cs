...
namespace AITGraph.Sdk.Models.CallRecords {
    public class Segment : AITGraph.Sdk.Models.Entity, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.CallRecords.FailureInfo? FailureInfo { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.CallRecords.FailureInfo FailureInfo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AITGraph.Sdk.Models.CallRecords.Media>? Media { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.CallRecords.Media> Media { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"failureInfo", n => { FailureInfo = n.GetObjectValue<AITGraph.Sdk.Models.CallRecords.FailureInfo>(AITGraph.Sdk.Models.CallRecords.FailureInfo.CreateFromDiscriminatorValue); } },
                {"media", n => { Media = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.CallRecords.Media>(AITGraph.Sdk.Models.CallRecords.Media.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.CallRecords.FailureInfo>("failureInfo", FailureInfo);
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.CallRecords.Media>("media", Media);
