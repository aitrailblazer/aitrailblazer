...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class WorkbookTable : global::AITGraph.Sdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Represents a collection of all the columns in the table. Read-only.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.WorkbookTableColumn>? Columns { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.WorkbookTableColumn> Columns { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.WorkbookTableRow>? Rows { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.WorkbookTableRow> Rows { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.WorkbookTableSort? Sort { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.WorkbookTableSort Sort { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.WorkbookTable"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.WorkbookTable CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.WorkbookTable();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "columns", n => { Columns = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.WorkbookTableColumn>(global::AITGraph.Sdk.Models.WorkbookTableColumn.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "rows", n => { Rows = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.WorkbookTableRow>(global::AITGraph.Sdk.Models.WorkbookTableRow.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "sort", n => { Sort = n.GetObjectValue<global::AITGraph.Sdk.Models.WorkbookTableSort>(global::AITGraph.Sdk.Models.WorkbookTableSort.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.WorkbookTableColumn>("columns", Columns);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.WorkbookTableRow>("rows", Rows);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.WorkbookTableSort>("sort", Sort);
