...
namespace AITGraph.Sdk.Models {
    public class AuthorizationPolicy : PolicyBase, IParsable {
        ...
        public AITGraph.Sdk.Models.AllowInvitesFrom? AllowInvitesFrom { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.DefaultUserRolePermissions? DefaultUserRolePermissions { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.DefaultUserRolePermissions DefaultUserRolePermissions { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"defaultUserRolePermissions", n => { DefaultUserRolePermissions = n.GetObjectValue<AITGraph.Sdk.Models.DefaultUserRolePermissions>(AITGraph.Sdk.Models.DefaultUserRolePermissions.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.DefaultUserRolePermissions>("defaultUserRolePermissions", DefaultUserRolePermissions);
