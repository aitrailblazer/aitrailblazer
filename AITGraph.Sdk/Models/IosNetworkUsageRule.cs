...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class IosNetworkUsageRule : IAdditionalDataHolder, IParsable
    {
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.AppListItem>? ManagedApps { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AppListItem> ManagedApps { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.IosNetworkUsageRule"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.IosNetworkUsageRule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.IosNetworkUsageRule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.IosNetworkUsageRule();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "managedApps", n => { ManagedApps = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AppListItem>(global::AITGraph.Sdk.Models.AppListItem.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AppListItem>("managedApps", ManagedApps);
