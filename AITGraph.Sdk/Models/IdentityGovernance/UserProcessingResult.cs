...
namespace AITGraph.Sdk.Models.IdentityGovernance {
    public class UserProcessingResult : AITGraph.Sdk.Models.Entity, IParsable {
...
#nullable enable
        public AITGraph.Sdk.Models.User? Subject { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.User Subject { get; set; }
#endif
...
#nullable restore
        ...
        public AITGraph.Sdk.Models.IdentityGovernance.WorkflowExecutionType? WorkflowExecutionType { get; set; }
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"subject", n => { Subject = n.GetObjectValue<AITGraph.Sdk.Models.User>(AITGraph.Sdk.Models.User.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.User>("subject", Subject);
