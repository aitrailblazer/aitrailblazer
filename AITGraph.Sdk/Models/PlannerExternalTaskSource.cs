...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class PlannerExternalTaskSource : global::AITGraph.Sdk.Models.PlannerTaskCreation, IParsable
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.PlannerExternalTaskSourceDisplayType? DisplayLinkType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.PlannerExternalTaskSource"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.PlannerExternalTaskSource"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.PlannerExternalTaskSource CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.PlannerExternalTaskSource();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "displayLinkType", n => { DisplayLinkType = n.GetEnumValue<global::AITGraph.Sdk.Models.PlannerExternalTaskSourceDisplayType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.PlannerExternalTaskSourceDisplayType>("displayLinkType", DisplayLinkType);
