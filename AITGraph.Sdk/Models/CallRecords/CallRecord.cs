...
namespace AITGraph.Sdk.Models.CallRecords {
    public class CallRecord : AITGraph.Sdk.Models.Entity, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.IdentitySet? Organizer { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.IdentitySet Organizer { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AITGraph.Sdk.Models.IdentitySet>? Participants { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.IdentitySet> Participants { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"organizer", n => { Organizer = n.GetObjectValue<AITGraph.Sdk.Models.IdentitySet>(AITGraph.Sdk.Models.IdentitySet.CreateFromDiscriminatorValue); } },
                {"participants", n => { Participants = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.IdentitySet>(AITGraph.Sdk.Models.IdentitySet.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.IdentitySet>("organizer", Organizer);
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.IdentitySet>("participants", Participants);
