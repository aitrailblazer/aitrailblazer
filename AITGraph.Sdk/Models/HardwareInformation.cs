...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.DeviceGuardLocalSystemAuthorityCredentialGuardState? DeviceGuardLocalSystemAuthorityCredentialGuardState { get; set; }
        /// <summary>The deviceGuardVirtualizationBasedSecurityHardwareRequirementState property</summary>
        public global::AITGraph.Sdk.Models.DeviceGuardVirtualizationBasedSecurityHardwareRequirementState? DeviceGuardVirtualizationBasedSecurityHardwareRequirementState { get; set; }
        /// <summary>The deviceGuardVirtualizationBasedSecurityState property</summary>
        public global::AITGraph.Sdk.Models.DeviceGuardVirtualizationBasedSecurityState? DeviceGuardVirtualizationBasedSecurityState { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.DeviceLicensingStatus? DeviceLicensingStatus { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.SharedAppleDeviceUser>? SharedDeviceCachedUsers { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.SharedAppleDeviceUser> SharedDeviceCachedUsers { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.HardwareInformation"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.HardwareInformation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.HardwareInformation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.HardwareInformation();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "deviceGuardLocalSystemAuthorityCredentialGuardState", n => { DeviceGuardLocalSystemAuthorityCredentialGuardState = n.GetEnumValue<global::AITGraph.Sdk.Models.DeviceGuardLocalSystemAuthorityCredentialGuardState>(); } },
                { "deviceGuardVirtualizationBasedSecurityHardwareRequirementState", n => { DeviceGuardVirtualizationBasedSecurityHardwareRequirementState = n.GetEnumValue<global::AITGraph.Sdk.Models.DeviceGuardVirtualizationBasedSecurityHardwareRequirementState>(); } },
                { "deviceGuardVirtualizationBasedSecurityState", n => { DeviceGuardVirtualizationBasedSecurityState = n.GetEnumValue<global::AITGraph.Sdk.Models.DeviceGuardVirtualizationBasedSecurityState>(); } },
                ...
                { "deviceLicensingStatus", n => { DeviceLicensingStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.DeviceLicensingStatus>(); } },
                ...
                { "sharedDeviceCachedUsers", n => { SharedDeviceCachedUsers = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.SharedAppleDeviceUser>(global::AITGraph.Sdk.Models.SharedAppleDeviceUser.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceGuardLocalSystemAuthorityCredentialGuardState>("deviceGuardLocalSystemAuthorityCredentialGuardState", DeviceGuardLocalSystemAuthorityCredentialGuardState);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceGuardVirtualizationBasedSecurityHardwareRequirementState>("deviceGuardVirtualizationBasedSecurityHardwareRequirementState", DeviceGuardVirtualizationBasedSecurityHardwareRequirementState);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceGuardVirtualizationBasedSecurityState>("deviceGuardVirtualizationBasedSecurityState", DeviceGuardVirtualizationBasedSecurityState);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceLicensingStatus>("deviceLicensingStatus", DeviceLicensingStatus);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.SharedAppleDeviceUser>("sharedDeviceCachedUsers", SharedDeviceCachedUsers);
