...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class MacOSCredentialSingleSignOnExtension : global::AITGraph.Sdk.Models.MacOSSingleSignOnExtension, IParsable
    {
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.KeyTypedValuePair>? Configurations { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.KeyTypedValuePair> Configurations { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.MacOSCredentialSingleSignOnExtension"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.MacOSCredentialSingleSignOnExtension"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.MacOSCredentialSingleSignOnExtension CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.MacOSCredentialSingleSignOnExtension();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "configurations", n => { Configurations = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.KeyTypedValuePair>(global::AITGraph.Sdk.Models.KeyTypedValuePair.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.KeyTypedValuePair>("configurations", Configurations);
