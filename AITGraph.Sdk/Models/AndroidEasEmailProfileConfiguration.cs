...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AndroidEasEmailProfileConfiguration : global::AITGraph.Sdk.Models.DeviceConfiguration, IParsable
    {
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.EmailSyncSchedule? EmailSyncSchedule { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.AndroidCertificateProfileBase? IdentityCertificate { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AndroidCertificateProfileBase IdentityCertificate { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.AndroidCertificateProfileBase? SmimeSigningCertificate { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AndroidCertificateProfileBase SmimeSigningCertificate { get; set; }
#endif
        ...
        public global::AITGraph.Sdk.Models.DomainNameSource? UserDomainNameSource { get; set; }
        /// <summary>Android username source.</summary>
        public global::AITGraph.Sdk.Models.AndroidUsernameSource? UsernameSource { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.AndroidEasEmailProfileConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AndroidEasEmailProfileConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.AndroidEasEmailProfileConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AndroidEasEmailProfileConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "emailSyncSchedule", n => { EmailSyncSchedule = n.GetEnumValue<global::AITGraph.Sdk.Models.EmailSyncSchedule>(); } },
                { "hostName", n => { HostName = n.GetStringValue(); } },
                { "identityCertificate", n => { IdentityCertificate = n.GetObjectValue<global::AITGraph.Sdk.Models.AndroidCertificateProfileBase>(global::AITGraph.Sdk.Models.AndroidCertificateProfileBase.CreateFromDiscriminatorValue); } },
                { "requireSmime", n => { RequireSmime = n.GetBoolValue(); } },
                { "requireSsl", n => { RequireSsl = n.GetBoolValue(); } },
                { "smimeSigningCertificate", n => { SmimeSigningCertificate = n.GetObjectValue<global::AITGraph.Sdk.Models.AndroidCertificateProfileBase>(global::AITGraph.Sdk.Models.AndroidCertificateProfileBase.CreateFromDiscriminatorValue); } },
                ...
                { "userDomainNameSource", n => { UserDomainNameSource = n.GetEnumValue<global::AITGraph.Sdk.Models.DomainNameSource>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.EmailSyncSchedule>("emailSyncSchedule", EmailSyncSchedule);
            writer.WriteStringValue("hostName", HostName);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AndroidCertificateProfileBase>("identityCertificate", IdentityCertificate);
            writer.WriteBoolValue("requireSmime", RequireSmime);
            writer.WriteBoolValue("requireSsl", RequireSsl);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AndroidCertificateProfileBase>("smimeSigningCertificate", SmimeSigningCertificate);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DomainNameSource>("userDomainNameSource", UserDomainNameSource);
