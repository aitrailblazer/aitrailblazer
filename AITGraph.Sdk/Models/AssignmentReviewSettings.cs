...
namespace AITGraph.Sdk.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::AITGraph.Sdk.Models.AccessReviewTimeoutBehavior? AccessReviewTimeoutBehavior { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.UserSet>? Reviewers { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.UserSet> Reviewers { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.AssignmentReviewSettings"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AssignmentReviewSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.AssignmentReviewSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AssignmentReviewSettings();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "accessReviewTimeoutBehavior", n => { AccessReviewTimeoutBehavior = n.GetEnumValue<global::AITGraph.Sdk.Models.AccessReviewTimeoutBehavior>(); } },
                ...
                { "reviewers", n => { Reviewers = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.UserSet>(global::AITGraph.Sdk.Models.UserSet.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AccessReviewTimeoutBehavior>("accessReviewTimeoutBehavior", AccessReviewTimeoutBehavior);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.UserSet>("reviewers", Reviewers);
