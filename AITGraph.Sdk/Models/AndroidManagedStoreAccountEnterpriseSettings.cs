...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AndroidManagedStoreAccountEnterpriseSettings : global::AITGraph.Sdk.Models.Entity, IParsable
    {
        ...
        public global::AITGraph.Sdk.Models.AndroidManagedStoreAccountBindStatus? BindStatus { get; set; }
        /// <summary>Company codes for AndroidManagedStoreAccountEnterpriseSettings</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.AndroidEnrollmentCompanyCode>? CompanyCodes { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AndroidEnrollmentCompanyCode> CompanyCodes { get; set; }
#endif
        ...
        public global::AITGraph.Sdk.Models.AndroidManagedStoreAccountEnrollmentTarget? EnrollmentTarget { get; set; }
        ...
        public global::AITGraph.Sdk.Models.AndroidManagedStoreAccountAppSyncStatus? LastAppSyncStatus { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AndroidManagedStoreAccountEnterpriseSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.AndroidManagedStoreAccountEnterpriseSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AndroidManagedStoreAccountEnterpriseSettings();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "bindStatus", n => { BindStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.AndroidManagedStoreAccountBindStatus>(); } },
                { "companyCodes", n => { CompanyCodes = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AndroidEnrollmentCompanyCode>(global::AITGraph.Sdk.Models.AndroidEnrollmentCompanyCode.CreateFromDiscriminatorValue)?.AsList(); } },
                { "deviceOwnerManagementEnabled", n => { DeviceOwnerManagementEnabled = n.GetBoolValue(); } },
                { "enrollmentTarget", n => { EnrollmentTarget = n.GetEnumValue<global::AITGraph.Sdk.Models.AndroidManagedStoreAccountEnrollmentTarget>(); } },
                { "lastAppSyncDateTime", n => { LastAppSyncDateTime = n.GetDateTimeOffsetValue(); } },
                { "lastAppSyncStatus", n => { LastAppSyncStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.AndroidManagedStoreAccountAppSyncStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AndroidManagedStoreAccountBindStatus>("bindStatus", BindStatus);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AndroidEnrollmentCompanyCode>("companyCodes", CompanyCodes);
            writer.WriteBoolValue("deviceOwnerManagementEnabled", DeviceOwnerManagementEnabled);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AndroidManagedStoreAccountEnrollmentTarget>("enrollmentTarget", EnrollmentTarget);
            writer.WriteDateTimeOffsetValue("lastAppSyncDateTime", LastAppSyncDateTime);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AndroidManagedStoreAccountAppSyncStatus>("lastAppSyncStatus", LastAppSyncStatus);
