...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class Invitation : global::AITGraph.Sdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The user created as part of the invitation creation. Read-Only</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.User? InvitedUser { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.User InvitedUser { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.InvitedUserMessageInfo? InvitedUserMessageInfo { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.InvitedUserMessageInfo InvitedUserMessageInfo { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Invitation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.Invitation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Invitation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "invitedUser", n => { InvitedUser = n.GetObjectValue<global::AITGraph.Sdk.Models.User>(global::AITGraph.Sdk.Models.User.CreateFromDiscriminatorValue); } },
                ...
                { "invitedUserMessageInfo", n => { InvitedUserMessageInfo = n.GetObjectValue<global::AITGraph.Sdk.Models.InvitedUserMessageInfo>(global::AITGraph.Sdk.Models.InvitedUserMessageInfo.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.User>("invitedUser", InvitedUser);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.InvitedUserMessageInfo>("invitedUserMessageInfo", InvitedUserMessageInfo);
