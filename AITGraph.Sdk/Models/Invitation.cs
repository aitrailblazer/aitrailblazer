...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.InvitedUserMessageInfo? InvitedUserMessageInfo { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.InvitedUserMessageInfo InvitedUserMessageInfo { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"invitedUserMessageInfo", n => { InvitedUserMessageInfo = n.GetObjectValue<AITGraph.Sdk.Models.InvitedUserMessageInfo>(AITGraph.Sdk.Models.InvitedUserMessageInfo.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.InvitedUserMessageInfo>("invitedUserMessageInfo", InvitedUserMessageInfo);
