...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ServerProcessedContent? ServerProcessedContent { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ServerProcessedContent ServerProcessedContent { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"serverProcessedContent", n => { ServerProcessedContent = n.GetObjectValue<AITGraph.Sdk.Models.ServerProcessedContent>(AITGraph.Sdk.Models.ServerProcessedContent.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ServerProcessedContent>("serverProcessedContent", ServerProcessedContent);
