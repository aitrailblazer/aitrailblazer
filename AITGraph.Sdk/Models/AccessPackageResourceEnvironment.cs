...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ConnectionInfo? ConnectionInfo { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ConnectionInfo ConnectionInfo { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"connectionInfo", n => { ConnectionInfo = n.GetObjectValue<AITGraph.Sdk.Models.ConnectionInfo>(AITGraph.Sdk.Models.ConnectionInfo.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ConnectionInfo>("connectionInfo", ConnectionInfo);
