...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.MicrosoftTunnelConfiguration? MicrosoftTunnelConfiguration { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.MicrosoftTunnelConfiguration MicrosoftTunnelConfiguration { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"microsoftTunnelConfiguration", n => { MicrosoftTunnelConfiguration = n.GetObjectValue<AITGraph.Sdk.Models.MicrosoftTunnelConfiguration>(AITGraph.Sdk.Models.MicrosoftTunnelConfiguration.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.MicrosoftTunnelConfiguration>("microsoftTunnelConfiguration", MicrosoftTunnelConfiguration);
