...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ExternalConnectors.UrlMatchInfo? UrlMatchInfo { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ExternalConnectors.UrlMatchInfo UrlMatchInfo { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"urlMatchInfo", n => { UrlMatchInfo = n.GetObjectValue<AITGraph.Sdk.Models.ExternalConnectors.UrlMatchInfo>(AITGraph.Sdk.Models.ExternalConnectors.UrlMatchInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ExternalConnectors.UrlMatchInfo>("urlMatchInfo", UrlMatchInfo);
        }
    }
}
