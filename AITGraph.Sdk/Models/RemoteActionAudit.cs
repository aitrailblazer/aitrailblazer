...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class RemoteActionAudit : global::AITGraph.Sdk.Models.Entity, IParsable
    {
        /// <summary>Remote actions Intune supports.</summary>
        public global::AITGraph.Sdk.Models.RemoteAction? Action { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.RemoteActionAudit"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.RemoteActionAudit CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.RemoteActionAudit();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "action", n => { Action = n.GetEnumValue<global::AITGraph.Sdk.Models.RemoteAction>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.RemoteAction>("action", Action);
