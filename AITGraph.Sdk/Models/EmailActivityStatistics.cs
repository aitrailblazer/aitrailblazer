...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class EmailActivityStatistics : global::AITGraph.Sdk.Models.ActivityStatistics, IParsable
    #pragma warning restore CS1591
    {
        ...
        public TimeSpan? ReadEmail { get; set; }
        /// <summary>Total hours spent writing and sending email. The value is represented in ISO 8601 format for durations.</summary>
        public TimeSpan? SentEmail { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.EmailActivityStatistics"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.EmailActivityStatistics"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.EmailActivityStatistics CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.EmailActivityStatistics();
        }
        /// <summary>
