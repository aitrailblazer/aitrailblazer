...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class MacOSSoftwareUpdateAccountSummary : global::AITGraph.Sdk.Models.Entity, IParsable
    {
        /// <summary>Summary of the updates by category.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.MacOSSoftwareUpdateCategorySummary>? CategorySummaries { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.MacOSSoftwareUpdateCategorySummary> CategorySummaries { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.MacOSSoftwareUpdateAccountSummary"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.MacOSSoftwareUpdateAccountSummary CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.MacOSSoftwareUpdateAccountSummary();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "categorySummaries", n => { CategorySummaries = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.MacOSSoftwareUpdateCategorySummary>(global::AITGraph.Sdk.Models.MacOSSoftwareUpdateCategorySummary.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.MacOSSoftwareUpdateCategorySummary>("categorySummaries", CategorySummaries);
