...
#nullable enable
        public async Task<AITGraph.Sdk.Models.Drive?> GetAsync(Action<RequestConfiguration<DriveRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<AITGraph.Sdk.Models.Drive> GetAsync(Action<RequestConfiguration<DriveRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<AITGraph.Sdk.Models.Drive>(requestInfo, AITGraph.Sdk.Models.Drive.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieve the properties and relationships of a Drive resource. A Drive is the top-level container for a file system, such as OneDrive or SharePoint document libraries.
        /// </summary>
