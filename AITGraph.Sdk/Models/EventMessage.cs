...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class EventMessage : global::AITGraph.Sdk.Models.Message, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The end time of the requested meeting.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.DateTimeTimeZone? EndDateTime { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.DateTimeTimeZone EndDateTime { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.Event? Event { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.Event Event { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.MeetingMessageType? MeetingMessageType { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.EventMessage"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.EventMessage"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.EventMessage CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::AITGraph.Sdk.Models.EventMessage(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "endDateTime", n => { EndDateTime = n.GetObjectValue<global::AITGraph.Sdk.Models.DateTimeTimeZone>(global::AITGraph.Sdk.Models.DateTimeTimeZone.CreateFromDiscriminatorValue); } },
                { "event", n => { Event = n.GetObjectValue<global::AITGraph.Sdk.Models.Event>(global::AITGraph.Sdk.Models.Event.CreateFromDiscriminatorValue); } },
                ...
                { "meetingMessageType", n => { MeetingMessageType = n.GetEnumValue<global::AITGraph.Sdk.Models.MeetingMessageType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.DateTimeTimeZone>("endDateTime", EndDateTime);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.Event>("event", Event);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.MeetingMessageType>("meetingMessageType", MeetingMessageType);
