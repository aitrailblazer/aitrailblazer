...
#nullable enable
        public List<global::AITGraph.Sdk.Models.AccessReviewApplyAction>? ApplyActions { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AccessReviewApplyAction> ApplyActions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.AccessReviewRecommendationInsightSetting>? RecommendationInsightSettings { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AccessReviewRecommendationInsightSetting> RecommendationInsightSettings { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.AccessReviewScheduleSettings"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AccessReviewScheduleSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.AccessReviewScheduleSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AccessReviewScheduleSettings();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "applyActions", n => { ApplyActions = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessReviewApplyAction>(global::AITGraph.Sdk.Models.AccessReviewApplyAction.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "recommendationInsightSettings", n => { RecommendationInsightSettings = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessReviewRecommendationInsightSetting>(global::AITGraph.Sdk.Models.AccessReviewRecommendationInsightSetting.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessReviewApplyAction>("applyActions", ApplyActions);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AccessReviewRecommendationInsightSetting>("recommendationInsightSettings", RecommendationInsightSettings);
