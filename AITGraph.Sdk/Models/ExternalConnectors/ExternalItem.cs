...
namespace AITGraph.Sdk.Models.ExternalConnectors {
    public class ExternalItem : AITGraph.Sdk.Models.Entity, IParsable {
...
#nullable enable
        public List<AITGraph.Sdk.Models.ExternalConnectors.Acl>? Acl { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.ExternalConnectors.Acl> Acl { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ExternalConnectors.Properties? Properties { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ExternalConnectors.Properties Properties { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"acl", n => { Acl = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.ExternalConnectors.Acl>(AITGraph.Sdk.Models.ExternalConnectors.Acl.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"properties", n => { Properties = n.GetObjectValue<AITGraph.Sdk.Models.ExternalConnectors.Properties>(AITGraph.Sdk.Models.ExternalConnectors.Properties.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.ExternalConnectors.Acl>("acl", Acl);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ExternalConnectors.Properties>("properties", Properties);
        }
    }
}
