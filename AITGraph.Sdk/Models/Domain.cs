...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class Domain : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.DirectoryObject>? DomainNameReferences { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.DirectoryObject> DomainNameReferences { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.InternalDomainFederation>? FederationConfiguration { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.InternalDomainFederation> FederationConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.DomainDnsRecord>? ServiceConfigurationRecords { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.DomainDnsRecord> ServiceConfigurationRecords { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.SharedEmailDomainInvitation>? SharedEmailDomainInvitations { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.SharedEmailDomainInvitation> SharedEmailDomainInvitations { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.DomainState? State { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.DomainState State { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.DomainDnsRecord>? VerificationDnsRecords { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.DomainDnsRecord> VerificationDnsRecords { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Domain"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.Domain CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Domain();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "domainNameReferences", n => { DomainNameReferences = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.DirectoryObject>(global::AITGraph.Sdk.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
                { "federationConfiguration", n => { FederationConfiguration = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.InternalDomainFederation>(global::AITGraph.Sdk.Models.InternalDomainFederation.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "serviceConfigurationRecords", n => { ServiceConfigurationRecords = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.DomainDnsRecord>(global::AITGraph.Sdk.Models.DomainDnsRecord.CreateFromDiscriminatorValue)?.AsList(); } },
                { "sharedEmailDomainInvitations", n => { SharedEmailDomainInvitations = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.SharedEmailDomainInvitation>(global::AITGraph.Sdk.Models.SharedEmailDomainInvitation.CreateFromDiscriminatorValue)?.AsList(); } },
                { "state", n => { State = n.GetObjectValue<global::AITGraph.Sdk.Models.DomainState>(global::AITGraph.Sdk.Models.DomainState.CreateFromDiscriminatorValue); } },
                { "supportedServices", n => { SupportedServices = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "verificationDnsRecords", n => { VerificationDnsRecords = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.DomainDnsRecord>(global::AITGraph.Sdk.Models.DomainDnsRecord.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.DirectoryObject>("domainNameReferences", DomainNameReferences);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.InternalDomainFederation>("federationConfiguration", FederationConfiguration);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.DomainDnsRecord>("serviceConfigurationRecords", ServiceConfigurationRecords);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.SharedEmailDomainInvitation>("sharedEmailDomainInvitations", SharedEmailDomainInvitations);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.DomainState>("state", State);
            writer.WriteCollectionOfPrimitiveValues<string>("supportedServices", SupportedServices);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.DomainDnsRecord>("verificationDnsRecords", VerificationDnsRecords);
        }
    }
}
