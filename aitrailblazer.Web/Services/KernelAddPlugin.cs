...
namespace AITrailblazer.net.Services
{
    ...
    public class KernelAddPLugin
    {
        ...
        public Kernel TimePlugin(Kernel kernel)
        {
            ...
            kernel.Plugins.AddFromFunctions("time_plugin_ai",
                    new[]
                    {
                        ...
                        KernelFunctionFactory.CreateFromMethod(
                            method: new Func<string>(_timeFunctions.GetDateAWeekAgoForAI),
                            functionName: "get_date_a_week_ago_ai",
                            description: "Retrieve the date exactly one week ago formatted for AI interactions."
                        ),
                        KernelFunctionFactory.CreateFromMethod(
                            method: new Func<DateTime, string>(_timeFunctions.GetDayOfWeekForDateForAI),
                            functionName: "get_day_of_week_for_date_ai",
                            description: "Retrieve the day of the week for a specific date formatted for AI interactions."
                        ),
                        KernelFunctionFactory.CreateFromMethod(
                            method: new Func<int, string>(_timeFunctions.GetDateWithOffsetForAI),
                            functionName: "get_date_with_offset_ai",
                            description: "Retrieve a date with a specific offset in days from today, formatted for AI interactions."
                        ),
                        KernelFunctionFactory.CreateFromMethod(
                            method: new Func<string, string>(_timeFunctions.GetNextWeekdayForAI),
                            functionName: "get_next_weekday_ai",
                            description: "Retrieve the date of the next specified weekday, formatted for AI interactions."
                        ),
                        KernelFunctionFactory.CreateFromMethod(
                            method: new Func<int, string>(_timeFunctions.GetDateWithWeekOffsetForAI),
                            functionName: "get_date_with_week_offset_ai",
                            description: "Retrieve a date with a specific offset in weeks from today, formatted for AI interactions."
                        ),
                        KernelFunctionFactory.CreateFromMethod(
                            method: new Func<int, string>(_timeFunctions.GetDateWithMonthOffsetForAI),
                            functionName: "get_date_with_month_offset_ai",
                            description: "Retrieve a date with a specific offset in months from today, formatted for AI interactions."
                        ),
                        KernelFunctionFactory.CreateFromMethod(
                            method: new Func<string>(_timeFunctions.GetTomorrowForAI),
                            functionName: "get_tomorrow_ai",
                            description: "Retrieve tomorrow's date, formatted for AI interactions."
                        ),
                        KernelFunctionFactory.CreateFromMethod(
                            method: new Func<string>(_timeFunctions.GetYesterdayForAI),
                            functionName: "get_yesterday_ai",
                            description: "Retrieve yesterday's date, formatted for AI interactions."
                        ),
                        KernelFunctionFactory.CreateFromMethod(
                            method: new Func<DateTime, DateTime, string>(_timeFunctions.DateDifferenceWeeksForAI),
                            functionName: "date_difference_weeks_ai",
                            description: "Calculate the difference in weeks between two dates, formatted for AI interactions."
                        ),
                        KernelFunctionFactory.CreateFromMethod(
                            method: new Func<DateTime, DateTime, string>(_timeFunctions.DateDifferenceMonthsForAI),
                            functionName: "date_difference_months_ai",
                            description: "Calculate the difference in months between two dates, formatted for AI interactions."
                        ),
                        KernelFunctionFactory.CreateFromMethod(
                            method: new Func<DateTime, DateTime, string>(_timeFunctions.DateDifferenceYearsForAI),
                            functionName: "date_difference_years_ai",
                            description: "Calculate the difference in years between two dates, formatted for AI interactions."
                        ),
                        KernelFunctionFactory.CreateFromMethod(
                            method: new Func<string, string>(_timeFunctions.ParseRelativeDateForAI),
                            functionName: "parse_relative_date_ai",
                            description: "Parse a relative date expression and return the corresponding date, formatted for AI interactions."
                        )
