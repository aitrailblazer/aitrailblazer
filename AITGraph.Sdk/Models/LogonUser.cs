...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.UserAccountSecurityType? AccountType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.LogonType?>? LogonTypes { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.LogonType?> LogonTypes { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.LogonUser"/> and sets the default values.
        /// </summary>
        public LogonUser()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.LogonUser"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.LogonUser CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.LogonUser();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "accountType", n => { AccountType = n.GetEnumValue<global::AITGraph.Sdk.Models.UserAccountSecurityType>(); } },
                { "firstSeenDateTime", n => { FirstSeenDateTime = n.GetDateTimeOffsetValue(); } },
                { "lastSeenDateTime", n => { LastSeenDateTime = n.GetDateTimeOffsetValue(); } },
                { "logonId", n => { LogonId = n.GetStringValue(); } },
                { "logonTypes", n => { LogonTypes = n.GetCollectionOfEnumValues<global::AITGraph.Sdk.Models.LogonType>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.UserAccountSecurityType>("accountType", AccountType);
            writer.WriteDateTimeOffsetValue("firstSeenDateTime", FirstSeenDateTime);
            writer.WriteDateTimeOffsetValue("lastSeenDateTime", LastSeenDateTime);
            writer.WriteStringValue("logonId", LogonId);
            writer.WriteCollectionOfEnumValues<global::AITGraph.Sdk.Models.LogonType>("logonTypes", LogonTypes);
