...
#nullable restore
        ...
        public AITGraph.Sdk.Models.Importance? Importance { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Location? Location { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Location Location { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AITGraph.Sdk.Models.Location>? Locations { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.Location> Locations { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ResponseStatus? ResponseStatus { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ResponseStatus ResponseStatus { get; set; }
#endif
        /// <summary>The sensitivity property</summary>
        public AITGraph.Sdk.Models.Sensitivity? Sensitivity { get; set; }
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"location", n => { Location = n.GetObjectValue<AITGraph.Sdk.Models.Location>(AITGraph.Sdk.Models.Location.CreateFromDiscriminatorValue); } },
                {"locations", n => { Locations = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.Location>(AITGraph.Sdk.Models.Location.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"responseStatus", n => { ResponseStatus = n.GetObjectValue<AITGraph.Sdk.Models.ResponseStatus>(AITGraph.Sdk.Models.ResponseStatus.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Location>("location", Location);
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.Location>("locations", Locations);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ResponseStatus>("responseStatus", ResponseStatus);
