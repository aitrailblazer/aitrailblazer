...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.FileHash? FileHash { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.FileHash FileHash { get; set; }
#endif
        /// <summary>The integrity level of the process. Possible values are: unknown, untrusted, low, medium, high, system.</summary>
        public global::AITGraph.Sdk.Models.ProcessIntegrityLevel? IntegrityLevel { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.Process"/> and sets the default values.
        /// </summary>
        public Process()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Process"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.Process CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Process();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "fileHash", n => { FileHash = n.GetObjectValue<global::AITGraph.Sdk.Models.FileHash>(global::AITGraph.Sdk.Models.FileHash.CreateFromDiscriminatorValue); } },
                { "integrityLevel", n => { IntegrityLevel = n.GetEnumValue<global::AITGraph.Sdk.Models.ProcessIntegrityLevel>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.FileHash>("fileHash", FileHash);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ProcessIntegrityLevel>("integrityLevel", IntegrityLevel);
