...
namespace AITGraph.Sdk.Models.WindowsUpdates {
    public class ComplianceChange : AITGraph.Sdk.Models.Entity, IParsable {
...
#nullable enable
        public AITGraph.Sdk.Models.WindowsUpdates.UpdatePolicy? UpdatePolicy { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.WindowsUpdates.UpdatePolicy UpdatePolicy { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"updatePolicy", n => { UpdatePolicy = n.GetObjectValue<AITGraph.Sdk.Models.WindowsUpdates.UpdatePolicy>(AITGraph.Sdk.Models.WindowsUpdates.UpdatePolicy.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.WindowsUpdates.UpdatePolicy>("updatePolicy", UpdatePolicy);
        }
    }
}
