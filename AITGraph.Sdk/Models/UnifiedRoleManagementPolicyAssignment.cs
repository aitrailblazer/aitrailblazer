...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class UnifiedRoleManagementPolicyAssignment : global::AITGraph.Sdk.Models.Entity, IParsable
...
#nullable enable
        public global::AITGraph.Sdk.Models.UnifiedRoleManagementPolicy? Policy { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.UnifiedRoleManagementPolicy Policy { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.UnifiedRoleManagementPolicyAssignment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.UnifiedRoleManagementPolicyAssignment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.UnifiedRoleManagementPolicyAssignment();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "policy", n => { Policy = n.GetObjectValue<global::AITGraph.Sdk.Models.UnifiedRoleManagementPolicy>(global::AITGraph.Sdk.Models.UnifiedRoleManagementPolicy.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.UnifiedRoleManagementPolicy>("policy", Policy);
