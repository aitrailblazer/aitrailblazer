...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.PermissionScope>? Oauth2PermissionScopes { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.PermissionScope> Oauth2PermissionScopes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.PreAuthorizedApplication>? PreAuthorizedApplications { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.PreAuthorizedApplication> PreAuthorizedApplications { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.ApiApplication"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.ApiApplication"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.ApiApplication CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.ApiApplication();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "oauth2PermissionScopes", n => { Oauth2PermissionScopes = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.PermissionScope>(global::AITGraph.Sdk.Models.PermissionScope.CreateFromDiscriminatorValue)?.AsList(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "preAuthorizedApplications", n => { PreAuthorizedApplications = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.PreAuthorizedApplication>(global::AITGraph.Sdk.Models.PreAuthorizedApplication.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.PermissionScope>("oauth2PermissionScopes", Oauth2PermissionScopes);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.PreAuthorizedApplication>("preAuthorizedApplications", PreAuthorizedApplications);
