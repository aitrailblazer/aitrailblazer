...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class DeviceManagementAutopilotEvent : global::AITGraph.Sdk.Models.Entity, IParsable
    {
        ...
        public global::AITGraph.Sdk.Models.WindowsAutopilotDeploymentState? AccountSetupStatus { get; set; }
        ...
        /// <summary>Deployment states for Autopilot devices</summary>
        public global::AITGraph.Sdk.Models.WindowsAutopilotDeploymentState? DeploymentState { get; set; }
...
#nullable restore
        ...
        /// <summary>Deployment states for Autopilot devices</summary>
        public global::AITGraph.Sdk.Models.WindowsAutopilotDeploymentState? DeviceSetupStatus { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.WindowsAutopilotEnrollmentType? EnrollmentType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.DeviceManagementAutopilotPolicyStatusDetail>? PolicyStatusDetails { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.DeviceManagementAutopilotPolicyStatusDetail> PolicyStatusDetails { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.DeviceManagementAutopilotEvent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.DeviceManagementAutopilotEvent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.DeviceManagementAutopilotEvent();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "accountSetupStatus", n => { AccountSetupStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.WindowsAutopilotDeploymentState>(); } },
                ...
                { "deploymentState", n => { DeploymentState = n.GetEnumValue<global::AITGraph.Sdk.Models.WindowsAutopilotDeploymentState>(); } },
                ...
                { "deviceSetupStatus", n => { DeviceSetupStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.WindowsAutopilotDeploymentState>(); } },
                ...
                { "enrollmentType", n => { EnrollmentType = n.GetEnumValue<global::AITGraph.Sdk.Models.WindowsAutopilotEnrollmentType>(); } },
                { "eventDateTime", n => { EventDateTime = n.GetDateTimeOffsetValue(); } },
                { "managedDeviceName", n => { ManagedDeviceName = n.GetStringValue(); } },
                { "osVersion", n => { OsVersion = n.GetStringValue(); } },
                { "policyStatusDetails", n => { PolicyStatusDetails = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.DeviceManagementAutopilotPolicyStatusDetail>(global::AITGraph.Sdk.Models.DeviceManagementAutopilotPolicyStatusDetail.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WindowsAutopilotDeploymentState>("accountSetupStatus", AccountSetupStatus);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WindowsAutopilotDeploymentState>("deploymentState", DeploymentState);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WindowsAutopilotDeploymentState>("deviceSetupStatus", DeviceSetupStatus);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WindowsAutopilotEnrollmentType>("enrollmentType", EnrollmentType);
            writer.WriteDateTimeOffsetValue("eventDateTime", EventDateTime);
            writer.WriteStringValue("managedDeviceName", ManagedDeviceName);
            writer.WriteStringValue("osVersion", OsVersion);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.DeviceManagementAutopilotPolicyStatusDetail>("policyStatusDetails", PolicyStatusDetails);
