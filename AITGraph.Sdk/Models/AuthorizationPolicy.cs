...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AuthorizationPolicy : global::AITGraph.Sdk.Models.PolicyBase, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::AITGraph.Sdk.Models.AllowInvitesFrom? AllowInvitesFrom { get; set; }
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.DefaultUserRoleOverride>? DefaultUserRoleOverrides { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.DefaultUserRoleOverride> DefaultUserRoleOverrides { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.DefaultUserRolePermissions? DefaultUserRolePermissions { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.DefaultUserRolePermissions DefaultUserRolePermissions { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.AuthorizationPolicy"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AuthorizationPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.AuthorizationPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AuthorizationPolicy();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "allowInvitesFrom", n => { AllowInvitesFrom = n.GetEnumValue<global::AITGraph.Sdk.Models.AllowInvitesFrom>(); } },
                ...
                { "defaultUserRoleOverrides", n => { DefaultUserRoleOverrides = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.DefaultUserRoleOverride>(global::AITGraph.Sdk.Models.DefaultUserRoleOverride.CreateFromDiscriminatorValue)?.AsList(); } },
                { "defaultUserRolePermissions", n => { DefaultUserRolePermissions = n.GetObjectValue<global::AITGraph.Sdk.Models.DefaultUserRolePermissions>(global::AITGraph.Sdk.Models.DefaultUserRolePermissions.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AllowInvitesFrom>("allowInvitesFrom", AllowInvitesFrom);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.DefaultUserRoleOverride>("defaultUserRoleOverrides", DefaultUserRoleOverrides);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.DefaultUserRolePermissions>("defaultUserRolePermissions", DefaultUserRolePermissions);
