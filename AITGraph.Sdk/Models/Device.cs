...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class Device : global::AITGraph.Sdk.Models.DirectoryObject, IParsable
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.AlternativeSecurityId>? AlternativeSecurityIds { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AlternativeSecurityId> AlternativeSecurityIds { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.Command>? Commands { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.Command> Commands { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.OnPremisesExtensionAttributes? ExtensionAttributes { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.OnPremisesExtensionAttributes ExtensionAttributes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.DirectoryObject>? RegisteredOwners { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.DirectoryObject> RegisteredOwners { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.DirectoryObject>? RegisteredUsers { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.DirectoryObject> RegisteredUsers { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.Device"/> and sets the default values.
        /// </summary>
        public Device() : base()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Device"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.Device CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Device();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "alternativeSecurityIds", n => { AlternativeSecurityIds = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AlternativeSecurityId>(global::AITGraph.Sdk.Models.AlternativeSecurityId.CreateFromDiscriminatorValue)?.AsList(); } },
                { "approximateLastSignInDateTime", n => { ApproximateLastSignInDateTime = n.GetDateTimeOffsetValue(); } },
                { "commands", n => { Commands = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.Command>(global::AITGraph.Sdk.Models.Command.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "extensionAttributes", n => { ExtensionAttributes = n.GetObjectValue<global::AITGraph.Sdk.Models.OnPremisesExtensionAttributes>(global::AITGraph.Sdk.Models.OnPremisesExtensionAttributes.CreateFromDiscriminatorValue); } },
                ...
                { "registeredOwners", n => { RegisteredOwners = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.DirectoryObject>(global::AITGraph.Sdk.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
                { "registeredUsers", n => { RegisteredUsers = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.DirectoryObject>(global::AITGraph.Sdk.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AlternativeSecurityId>("alternativeSecurityIds", AlternativeSecurityIds);
            writer.WriteDateTimeOffsetValue("approximateLastSignInDateTime", ApproximateLastSignInDateTime);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.Command>("commands", Commands);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.OnPremisesExtensionAttributes>("extensionAttributes", ExtensionAttributes);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.DirectoryObject>("registeredOwners", RegisteredOwners);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.DirectoryObject>("registeredUsers", RegisteredUsers);
