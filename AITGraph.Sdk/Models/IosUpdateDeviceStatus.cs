...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class IosUpdateDeviceStatus : global::AITGraph.Sdk.Models.Entity, IParsable
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.IosUpdatesInstallStatus? InstallStatus { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.ComplianceStatus? Status { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.IosUpdateDeviceStatus"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.IosUpdateDeviceStatus CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.IosUpdateDeviceStatus();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "installStatus", n => { InstallStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.IosUpdatesInstallStatus>(); } },
                { "lastReportedDateTime", n => { LastReportedDateTime = n.GetDateTimeOffsetValue(); } },
                { "osVersion", n => { OsVersion = n.GetStringValue(); } },
                { "platform", n => { Platform = n.GetIntValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::AITGraph.Sdk.Models.ComplianceStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.IosUpdatesInstallStatus>("installStatus", InstallStatus);
            writer.WriteDateTimeOffsetValue("lastReportedDateTime", LastReportedDateTime);
            writer.WriteStringValue("osVersion", OsVersion);
            writer.WriteIntValue("platform", Platform);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ComplianceStatus>("status", Status);
