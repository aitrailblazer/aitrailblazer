...
#nullable enable
        public List<global::AITGraph.Sdk.Models.DayOfWeekObject?>? DaysOfWeek { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.DayOfWeekObject?> DaysOfWeek { get; set; }
#endif
        ...
        public global::AITGraph.Sdk.Models.DayOfWeekObject? FirstDayOfWeek { get; set; }
        ...
        public global::AITGraph.Sdk.Models.WeekIndex? Index { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.RecurrencePatternType? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.RecurrencePattern"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.RecurrencePattern"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.RecurrencePattern CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.RecurrencePattern();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "daysOfWeek", n => { DaysOfWeek = n.GetCollectionOfEnumValues<global::AITGraph.Sdk.Models.DayOfWeekObject>()?.AsList(); } },
                { "firstDayOfWeek", n => { FirstDayOfWeek = n.GetEnumValue<global::AITGraph.Sdk.Models.DayOfWeekObject>(); } },
                { "index", n => { Index = n.GetEnumValue<global::AITGraph.Sdk.Models.WeekIndex>(); } },
                { "interval", n => { Interval = n.GetIntValue(); } },
                { "month", n => { Month = n.GetIntValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::AITGraph.Sdk.Models.RecurrencePatternType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::AITGraph.Sdk.Models.DayOfWeekObject>("daysOfWeek", DaysOfWeek);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DayOfWeekObject>("firstDayOfWeek", FirstDayOfWeek);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WeekIndex>("index", Index);
            writer.WriteIntValue("interval", Interval);
            writer.WriteIntValue("month", Month);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.RecurrencePatternType>("type", Type);
