...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class HostSecurityProfile : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.LogonUser>? LogonUsers { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.LogonUser> LogonUsers { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.NetworkInterface>? NetworkInterfaces { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.NetworkInterface> NetworkInterfaces { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.HostSecurityProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.HostSecurityProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.HostSecurityProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "logonUsers", n => { LogonUsers = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.LogonUser>(global::AITGraph.Sdk.Models.LogonUser.CreateFromDiscriminatorValue)?.AsList(); } },
                { "netBiosName", n => { NetBiosName = n.GetStringValue(); } },
                { "networkInterfaces", n => { NetworkInterfaces = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.NetworkInterface>(global::AITGraph.Sdk.Models.NetworkInterface.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.LogonUser>("logonUsers", LogonUsers);
            writer.WriteStringValue("netBiosName", NetBiosName);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.NetworkInterface>("networkInterfaces", NetworkInterfaces);
