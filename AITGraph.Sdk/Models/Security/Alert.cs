...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.Security.DetectionSource? DetectionSource { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.Security.AlertEvidence>? Evidence { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.Security.AlertEvidence> Evidence { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.Security.ServiceSource? ServiceSource { get; set; }
        /// <summary>The severity property</summary>
        public global::AITGraph.Sdk.Models.Security.AlertSeverity? Severity { get; set; }
        /// <summary>The status property</summary>
        public global::AITGraph.Sdk.Models.Security.AlertStatus? Status { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Security.Alert"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.Security.Alert CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Security.Alert();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "detectionSource", n => { DetectionSource = n.GetEnumValue<global::AITGraph.Sdk.Models.Security.DetectionSource>(); } },
                ...
                { "evidence", n => { Evidence = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.Security.AlertEvidence>(global::AITGraph.Sdk.Models.Security.AlertEvidence.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "serviceSource", n => { ServiceSource = n.GetEnumValue<global::AITGraph.Sdk.Models.Security.ServiceSource>(); } },
                { "severity", n => { Severity = n.GetEnumValue<global::AITGraph.Sdk.Models.Security.AlertSeverity>(); } },
                { "status", n => { Status = n.GetEnumValue<global::AITGraph.Sdk.Models.Security.AlertStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Security.DetectionSource>("detectionSource", DetectionSource);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.Security.AlertEvidence>("evidence", Evidence);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Security.ServiceSource>("serviceSource", ServiceSource);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Security.AlertSeverity>("severity", Severity);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Security.AlertStatus>("status", Status);
