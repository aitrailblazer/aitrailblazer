...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Security.UserAccount? UserAccount { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Security.UserAccount UserAccount { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"userAccount", n => { UserAccount = n.GetObjectValue<AITGraph.Sdk.Models.Security.UserAccount>(AITGraph.Sdk.Models.Security.UserAccount.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Security.UserAccount>("userAccount", UserAccount);
        }
    }
}
