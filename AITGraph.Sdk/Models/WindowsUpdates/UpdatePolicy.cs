...
namespace AITGraph.Sdk.Models.WindowsUpdates {
    public class UpdatePolicy : AITGraph.Sdk.Models.Entity, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.WindowsUpdates.DeploymentSettings? DeploymentSettings { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.WindowsUpdates.DeploymentSettings DeploymentSettings { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"deploymentSettings", n => { DeploymentSettings = n.GetObjectValue<AITGraph.Sdk.Models.WindowsUpdates.DeploymentSettings>(AITGraph.Sdk.Models.WindowsUpdates.DeploymentSettings.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.WindowsUpdates.DeploymentSettings>("deploymentSettings", DeploymentSettings);
        }
    }
}
