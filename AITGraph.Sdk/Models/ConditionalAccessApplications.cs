...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class ConditionalAccessApplications : IAdditionalDataHolder, IParsable
...
#nullable enable
        public global::AITGraph.Sdk.Models.ConditionalAccessFilter? ApplicationFilter { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.ConditionalAccessFilter ApplicationFilter { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.ConditionalAccessApplications"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.ConditionalAccessApplications"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.ConditionalAccessApplications CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.ConditionalAccessApplications();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "applicationFilter", n => { ApplicationFilter = n.GetObjectValue<global::AITGraph.Sdk.Models.ConditionalAccessFilter>(global::AITGraph.Sdk.Models.ConditionalAccessFilter.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.ConditionalAccessFilter>("applicationFilter", ApplicationFilter);
