...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class MicrosoftTunnelConfiguration : global::AITGraph.Sdk.Models.Entity, IParsable
    {
        /// <summary>Additional settings that may be applied to the server</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.KeyValuePair>? AdvancedSettings { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.KeyValuePair> AdvancedSettings { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.MicrosoftTunnelConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.MicrosoftTunnelConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.MicrosoftTunnelConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "advancedSettings", n => { AdvancedSettings = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.KeyValuePair>(global::AITGraph.Sdk.Models.KeyValuePair.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.KeyValuePair>("advancedSettings", AdvancedSettings);
