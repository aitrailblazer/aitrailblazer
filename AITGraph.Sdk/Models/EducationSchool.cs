...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class EducationSchool : global::AITGraph.Sdk.Models.EducationOrganization, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.AdministrativeUnit? AdministrativeUnit { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AdministrativeUnit AdministrativeUnit { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.EducationUser>? Users { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.EducationUser> Users { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.EducationSchool"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.EducationSchool"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.EducationSchool CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.EducationSchool();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "administrativeUnit", n => { AdministrativeUnit = n.GetObjectValue<global::AITGraph.Sdk.Models.AdministrativeUnit>(global::AITGraph.Sdk.Models.AdministrativeUnit.CreateFromDiscriminatorValue); } },
                ...
                { "users", n => { Users = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.EducationUser>(global::AITGraph.Sdk.Models.EducationUser.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AdministrativeUnit>("administrativeUnit", AdministrativeUnit);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.EducationUser>("users", Users);
        }
    }
}
