...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class CloudPcExportJob : global::AITGraph.Sdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::AITGraph.Sdk.Models.CloudPcExportJobStatus? ExportJobStatus { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.CloudPcReportName? ReportName { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.CloudPcExportJob"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.CloudPcExportJob CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.CloudPcExportJob();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "exportJobStatus", n => { ExportJobStatus = n.GetEnumValue<global::AITGraph.Sdk.Models.CloudPcExportJobStatus>(); } },
                { "exportUrl", n => { ExportUrl = n.GetStringValue(); } },
                { "filter", n => { Filter = n.GetStringValue(); } },
                { "format", n => { Format = n.GetStringValue(); } },
                { "reportName", n => { ReportName = n.GetEnumValue<global::AITGraph.Sdk.Models.CloudPcReportName>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.CloudPcExportJobStatus>("exportJobStatus", ExportJobStatus);
            writer.WriteStringValue("exportUrl", ExportUrl);
            writer.WriteStringValue("filter", Filter);
            writer.WriteStringValue("format", Format);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.CloudPcReportName>("reportName", ReportName);
