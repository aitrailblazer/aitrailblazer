...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class DirectoryAudit : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.KeyValue>? AdditionalDetails { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.KeyValue> AdditionalDetails { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.AuditActivityInitiator? InitiatedBy { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AuditActivityInitiator InitiatedBy { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.OperationResult? Result { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.TargetResource>? TargetResources { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.TargetResource> TargetResources { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.DirectoryAudit"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.DirectoryAudit CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.DirectoryAudit();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "additionalDetails", n => { AdditionalDetails = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.KeyValue>(global::AITGraph.Sdk.Models.KeyValue.CreateFromDiscriminatorValue)?.AsList(); } },
                { "category", n => { Category = n.GetStringValue(); } },
                { "correlationId", n => { CorrelationId = n.GetStringValue(); } },
                { "initiatedBy", n => { InitiatedBy = n.GetObjectValue<global::AITGraph.Sdk.Models.AuditActivityInitiator>(global::AITGraph.Sdk.Models.AuditActivityInitiator.CreateFromDiscriminatorValue); } },
                { "loggedByService", n => { LoggedByService = n.GetStringValue(); } },
                { "operationType", n => { OperationType = n.GetStringValue(); } },
                { "result", n => { Result = n.GetEnumValue<global::AITGraph.Sdk.Models.OperationResult>(); } },
                { "resultReason", n => { ResultReason = n.GetStringValue(); } },
                { "targetResources", n => { TargetResources = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.TargetResource>(global::AITGraph.Sdk.Models.TargetResource.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.KeyValue>("additionalDetails", AdditionalDetails);
            writer.WriteStringValue("category", Category);
            writer.WriteStringValue("correlationId", CorrelationId);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AuditActivityInitiator>("initiatedBy", InitiatedBy);
            writer.WriteStringValue("loggedByService", LoggedByService);
            writer.WriteStringValue("operationType", OperationType);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.OperationResult>("result", Result);
            writer.WriteStringValue("resultReason", ResultReason);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.TargetResource>("targetResources", TargetResources);
