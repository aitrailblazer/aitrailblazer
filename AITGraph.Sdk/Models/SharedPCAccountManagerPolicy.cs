...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class SharedPCAccountManagerPolicy : IAdditionalDataHolder, IParsable
    {
        ...
        public global::AITGraph.Sdk.Models.SharedPCAccountDeletionPolicyType? AccountDeletionPolicy { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.SharedPCAccountManagerPolicy"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.SharedPCAccountManagerPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.SharedPCAccountManagerPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.SharedPCAccountManagerPolicy();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "accountDeletionPolicy", n => { AccountDeletionPolicy = n.GetEnumValue<global::AITGraph.Sdk.Models.SharedPCAccountDeletionPolicyType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.SharedPCAccountDeletionPolicyType>("accountDeletionPolicy", AccountDeletionPolicy);
