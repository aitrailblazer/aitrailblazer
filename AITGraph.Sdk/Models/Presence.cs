...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.OutOfOfficeSettings? OutOfOfficeSettings { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.OutOfOfficeSettings OutOfOfficeSettings { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"outOfOfficeSettings", n => { OutOfOfficeSettings = n.GetObjectValue<AITGraph.Sdk.Models.OutOfOfficeSettings>(AITGraph.Sdk.Models.OutOfOfficeSettings.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.OutOfOfficeSettings>("outOfOfficeSettings", OutOfOfficeSettings);
