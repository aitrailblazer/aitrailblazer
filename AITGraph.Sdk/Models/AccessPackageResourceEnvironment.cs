...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AccessPackageResourceEnvironment : global::AITGraph.Sdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.ConnectionInfo? ConnectionInfo { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.ConnectionInfo ConnectionInfo { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AccessPackageResourceEnvironment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.AccessPackageResourceEnvironment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AccessPackageResourceEnvironment();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "connectionInfo", n => { ConnectionInfo = n.GetObjectValue<global::AITGraph.Sdk.Models.ConnectionInfo>(global::AITGraph.Sdk.Models.ConnectionInfo.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.ConnectionInfo>("connectionInfo", ConnectionInfo);
