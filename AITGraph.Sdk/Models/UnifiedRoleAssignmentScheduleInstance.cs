...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class UnifiedRoleAssignmentScheduleInstance : global::AITGraph.Sdk.Models.UnifiedRoleScheduleInstanceBase, IParsable
...
#nullable enable
        public global::AITGraph.Sdk.Models.UnifiedRoleEligibilityScheduleInstance? ActivatedUsing { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.UnifiedRoleEligibilityScheduleInstance ActivatedUsing { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.UnifiedRoleAssignmentScheduleInstance"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.UnifiedRoleAssignmentScheduleInstance CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.UnifiedRoleAssignmentScheduleInstance();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "activatedUsing", n => { ActivatedUsing = n.GetObjectValue<global::AITGraph.Sdk.Models.UnifiedRoleEligibilityScheduleInstance>(global::AITGraph.Sdk.Models.UnifiedRoleEligibilityScheduleInstance.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.UnifiedRoleEligibilityScheduleInstance>("activatedUsing", ActivatedUsing);
