...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.Label?>? Labels { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.Label?> Labels { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.PropertyType? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.Property"/> and sets the default values.
        /// </summary>
        public Property()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Property"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.Property CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Property();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "labels", n => { Labels = n.GetCollectionOfEnumValues<global::AITGraph.Sdk.Models.Label>()?.AsList(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::AITGraph.Sdk.Models.PropertyType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::AITGraph.Sdk.Models.Label>("labels", Labels);
            writer.WriteStringValue("name", Name);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.PropertyType>("type", Type);
