...
#nullable restore
        ...
        public AITGraph.Sdk.Models.Security.DefenderAvStatus? DefenderAvStatus { get; set; }
...
#nullable restore
        ...
        public AITGraph.Sdk.Models.Security.OnboardingStatus? OnboardingStatus { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.Security.VmMetadata? VmMetadata { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Security.VmMetadata VmMetadata { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"vmMetadata", n => { VmMetadata = n.GetObjectValue<AITGraph.Sdk.Models.Security.VmMetadata>(AITGraph.Sdk.Models.Security.VmMetadata.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Security.VmMetadata>("vmMetadata", VmMetadata);
        }
    }
}
