...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AppleVpnConfiguration : global::AITGraph.Sdk.Models.DeviceConfiguration, IParsable
    {
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.AppleVpnConnectionType? ConnectionType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.VpnOnDemandRule>? OnDemandRules { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.VpnOnDemandRule> OnDemandRules { get; set; }
#endif
        ...
        public global::AITGraph.Sdk.Models.VpnProviderType? ProviderType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.VpnServer? Server { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.VpnServer Server { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.AppleVpnConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AppleVpnConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.AppleVpnConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::AITGraph.Sdk.Models.AppleVpnConfiguration(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "connectionType", n => { ConnectionType = n.GetEnumValue<global::AITGraph.Sdk.Models.AppleVpnConnectionType>(); } },
                ...
                { "onDemandRules", n => { OnDemandRules = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.VpnOnDemandRule>(global::AITGraph.Sdk.Models.VpnOnDemandRule.CreateFromDiscriminatorValue)?.AsList(); } },
                { "optInToDeviceIdSharing", n => { OptInToDeviceIdSharing = n.GetBoolValue(); } },
                { "providerType", n => { ProviderType = n.GetEnumValue<global::AITGraph.Sdk.Models.VpnProviderType>(); } },
                ...
                { "server", n => { Server = n.GetObjectValue<global::AITGraph.Sdk.Models.VpnServer>(global::AITGraph.Sdk.Models.VpnServer.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.AppleVpnConnectionType>("connectionType", ConnectionType);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.VpnOnDemandRule>("onDemandRules", OnDemandRules);
            writer.WriteBoolValue("optInToDeviceIdSharing", OptInToDeviceIdSharing);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.VpnProviderType>("providerType", ProviderType);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.VpnServer>("server", Server);
        }
    }
}
