...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AITGraph.Sdk.Models.CertificateBasedAuthConfiguration>? CertificateBasedAuthConfiguration { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.CertificateBasedAuthConfiguration> CertificateBasedAuthConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.CertificateConnectorSetting? CertificateConnectorSetting { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.CertificateConnectorSetting CertificateConnectorSetting { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.DirectorySizeQuota? DirectorySizeQuota { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.DirectorySizeQuota DirectorySizeQuota { get; set; }
#endif
...
#nullable restore
        ...
        public AITGraph.Sdk.Models.PartnerTenantType? PartnerTenantType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.PrivacyProfile? PrivacyProfile { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.PrivacyProfile PrivacyProfile { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"certificateBasedAuthConfiguration", n => { CertificateBasedAuthConfiguration = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.CertificateBasedAuthConfiguration>(AITGraph.Sdk.Models.CertificateBasedAuthConfiguration.CreateFromDiscriminatorValue)?.ToList(); } },
                {"certificateConnectorSetting", n => { CertificateConnectorSetting = n.GetObjectValue<AITGraph.Sdk.Models.CertificateConnectorSetting>(AITGraph.Sdk.Models.CertificateConnectorSetting.CreateFromDiscriminatorValue); } },
                ...
                {"directorySizeQuota", n => { DirectorySizeQuota = n.GetObjectValue<AITGraph.Sdk.Models.DirectorySizeQuota>(AITGraph.Sdk.Models.DirectorySizeQuota.CreateFromDiscriminatorValue); } },
                ...
                {"privacyProfile", n => { PrivacyProfile = n.GetObjectValue<AITGraph.Sdk.Models.PrivacyProfile>(AITGraph.Sdk.Models.PrivacyProfile.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.CertificateBasedAuthConfiguration>("certificateBasedAuthConfiguration", CertificateBasedAuthConfiguration);
            writer.WriteObjectValue<AITGraph.Sdk.Models.CertificateConnectorSetting>("certificateConnectorSetting", CertificateConnectorSetting);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.DirectorySizeQuota>("directorySizeQuota", DirectorySizeQuota);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.PrivacyProfile>("privacyProfile", PrivacyProfile);
