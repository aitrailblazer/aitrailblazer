...
namespace AITGraph.Sdk.Models.Ediscovery
{
    ...
    public partial class CaseExportOperation : global::AITGraph.Sdk.Models.Ediscovery.CaseOperation, IParsable
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.Ediscovery.ExportOptions? ExportOptions { get; set; }
        ...
        public global::AITGraph.Sdk.Models.Ediscovery.ExportFileStructure? ExportStructure { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.Ediscovery.ReviewSet? ReviewSet { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.Ediscovery.ReviewSet ReviewSet { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Ediscovery.CaseExportOperation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.Ediscovery.CaseExportOperation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Ediscovery.CaseExportOperation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "exportOptions", n => { ExportOptions = n.GetEnumValue<global::AITGraph.Sdk.Models.Ediscovery.ExportOptions>(); } },
                { "exportStructure", n => { ExportStructure = n.GetEnumValue<global::AITGraph.Sdk.Models.Ediscovery.ExportFileStructure>(); } },
                { "outputFolderId", n => { OutputFolderId = n.GetStringValue(); } },
                { "outputName", n => { OutputName = n.GetStringValue(); } },
                { "reviewSet", n => { ReviewSet = n.GetObjectValue<global::AITGraph.Sdk.Models.Ediscovery.ReviewSet>(global::AITGraph.Sdk.Models.Ediscovery.ReviewSet.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Ediscovery.ExportOptions>("exportOptions", ExportOptions);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.Ediscovery.ExportFileStructure>("exportStructure", ExportStructure);
            writer.WriteStringValue("outputFolderId", OutputFolderId);
            writer.WriteStringValue("outputName", OutputName);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.Ediscovery.ReviewSet>("reviewSet", ReviewSet);
        }
    }
}
