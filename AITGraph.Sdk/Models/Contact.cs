...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class Contact : global::AITGraph.Sdk.Models.OutlookItem, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.TypedEmailAddress>? EmailAddresses { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.TypedEmailAddress> EmailAddresses { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.PhysicalAddress>? PostalAddresses { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.PhysicalAddress> PostalAddresses { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.Contact"/> and sets the default values.
        /// </summary>
        public Contact() : base()
        {
        ...
        public static new global::AITGraph.Sdk.Models.Contact CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Contact();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "emailAddresses", n => { EmailAddresses = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.TypedEmailAddress>(global::AITGraph.Sdk.Models.TypedEmailAddress.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "postalAddresses", n => { PostalAddresses = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.PhysicalAddress>(global::AITGraph.Sdk.Models.PhysicalAddress.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.TypedEmailAddress>("emailAddresses", EmailAddresses);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.PhysicalAddress>("postalAddresses", PostalAddresses);
