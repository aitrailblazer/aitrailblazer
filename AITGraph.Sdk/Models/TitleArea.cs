...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.TitleAreaLayoutType? Layout { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.ServerProcessedContent? ServerProcessedContent { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.ServerProcessedContent ServerProcessedContent { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.TitleAreaTextAlignmentType? TextAlignment { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.TitleArea"/> and sets the default values.
        /// </summary>
        public TitleArea()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.TitleArea"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.TitleArea CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.TitleArea();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "layout", n => { Layout = n.GetEnumValue<global::AITGraph.Sdk.Models.TitleAreaLayoutType>(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "serverProcessedContent", n => { ServerProcessedContent = n.GetObjectValue<global::AITGraph.Sdk.Models.ServerProcessedContent>(global::AITGraph.Sdk.Models.ServerProcessedContent.CreateFromDiscriminatorValue); } },
                ...
                { "textAlignment", n => { TextAlignment = n.GetEnumValue<global::AITGraph.Sdk.Models.TitleAreaTextAlignmentType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.TitleAreaLayoutType>("layout", Layout);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.ServerProcessedContent>("serverProcessedContent", ServerProcessedContent);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.TitleAreaTextAlignmentType>("textAlignment", TextAlignment);
