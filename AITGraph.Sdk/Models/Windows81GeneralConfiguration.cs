...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class Windows81GeneralConfiguration : global::AITGraph.Sdk.Models.DeviceConfiguration, IParsable
    {
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.InternetSiteSecurityLevel? BrowserInternetSecurityLevel { get; set; }
        /// <summary>Possible values for site security level.</summary>
        public global::AITGraph.Sdk.Models.SiteSecurityLevel? BrowserIntranetSecurityLevel { get; set; }
...
#nullable restore
        ...
        /// <summary>Possible values for site security level.</summary>
        public global::AITGraph.Sdk.Models.SiteSecurityLevel? BrowserTrustedSitesSecurityLevel { get; set; }
        ...
        public global::AITGraph.Sdk.Models.UpdateClassification? MinimumAutoInstallClassification { get; set; }
        ...
        /// <summary>Possible values for automatic update classification.</summary>
        public global::AITGraph.Sdk.Models.UpdateClassification? UpdatesMinimumAutoInstallClassification { get; set; }
        ...
        public global::AITGraph.Sdk.Models.WindowsUserAccountControlSettings? UserAccountControlSettings { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.Windows81GeneralConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Windows81GeneralConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.Windows81GeneralConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Windows81GeneralConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "browserInternetSecurityLevel", n => { BrowserInternetSecurityLevel = n.GetEnumValue<global::AITGraph.Sdk.Models.InternetSiteSecurityLevel>(); } },
                { "browserIntranetSecurityLevel", n => { BrowserIntranetSecurityLevel = n.GetEnumValue<global::AITGraph.Sdk.Models.SiteSecurityLevel>(); } },
                ...
                { "browserTrustedSitesSecurityLevel", n => { BrowserTrustedSitesSecurityLevel = n.GetEnumValue<global::AITGraph.Sdk.Models.SiteSecurityLevel>(); } },
                ...
                { "minimumAutoInstallClassification", n => { MinimumAutoInstallClassification = n.GetEnumValue<global::AITGraph.Sdk.Models.UpdateClassification>(); } },
                ...
                { "updatesMinimumAutoInstallClassification", n => { UpdatesMinimumAutoInstallClassification = n.GetEnumValue<global::AITGraph.Sdk.Models.UpdateClassification>(); } },
                { "updatesRequireAutomaticUpdates", n => { UpdatesRequireAutomaticUpdates = n.GetBoolValue(); } },
                { "userAccountControlSettings", n => { UserAccountControlSettings = n.GetEnumValue<global::AITGraph.Sdk.Models.WindowsUserAccountControlSettings>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.InternetSiteSecurityLevel>("browserInternetSecurityLevel", BrowserInternetSecurityLevel);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.SiteSecurityLevel>("browserIntranetSecurityLevel", BrowserIntranetSecurityLevel);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.SiteSecurityLevel>("browserTrustedSitesSecurityLevel", BrowserTrustedSitesSecurityLevel);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.UpdateClassification>("minimumAutoInstallClassification", MinimumAutoInstallClassification);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.UpdateClassification>("updatesMinimumAutoInstallClassification", UpdatesMinimumAutoInstallClassification);
            writer.WriteBoolValue("updatesRequireAutomaticUpdates", UpdatesRequireAutomaticUpdates);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.WindowsUserAccountControlSettings>("userAccountControlSettings", UserAccountControlSettings);
