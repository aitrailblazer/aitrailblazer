...
#nullable restore
        ...
        public static Entity CreateFromDiscriminatorValue(IParseNode parseNode) {
            ...
            return mappingValue switch {
                ...
                "#microsoft.graph.deviceManagement" => new AITGraph.Sdk.Models.DeviceManagement.DeviceManagement(),
                "#microsoft.graph.deviceManagement.alertRecord" => new AlertRecord(),
                "#microsoft.graph.deviceManagement.alertRule" => new AlertRule(),
                "#microsoft.graph.deviceManagement.monitoring" => new Monitoring(),
                ...
                "#microsoft.graph.ediscovery.case" => new AITGraph.Sdk.Models.Ediscovery.Case(),
                ...
                "#microsoft.graph.ediscovery.caseOperation" => new AITGraph.Sdk.Models.Ediscovery.CaseOperation(),
                "#microsoft.graph.ediscovery.caseSettings" => new CaseSettings(),
                "#microsoft.graph.ediscovery.custodian" => new Custodian(),
                "#microsoft.graph.ediscovery.dataSource" => new AITGraph.Sdk.Models.Ediscovery.DataSource(),
                "#microsoft.graph.ediscovery.dataSourceContainer" => new AITGraph.Sdk.Models.Ediscovery.DataSourceContainer(),
                ...
                "#microsoft.graph.ediscovery.siteSource" => new AITGraph.Sdk.Models.Ediscovery.SiteSource(),
                "#microsoft.graph.ediscovery.sourceCollection" => new SourceCollection(),
                "#microsoft.graph.ediscovery.tag" => new AITGraph.Sdk.Models.Ediscovery.Tag(),
                "#microsoft.graph.ediscovery.tagOperation" => new TagOperation(),
                "#microsoft.graph.ediscovery.unifiedGroupSource" => new AITGraph.Sdk.Models.Ediscovery.UnifiedGroupSource(),
                "#microsoft.graph.ediscovery.userSource" => new AITGraph.Sdk.Models.Ediscovery.UserSource(),
                ...
                "#microsoft.graph.externalConnectors.connectionOperation" => new AITGraph.Sdk.Models.ExternalConnectors.ConnectionOperation(),
                ...
                "#microsoft.graph.externalConnectors.externalConnection" => new AITGraph.Sdk.Models.ExternalConnectors.ExternalConnection(),
                "#microsoft.graph.externalConnectors.externalGroup" => new AITGraph.Sdk.Models.ExternalConnectors.ExternalGroup(),
                "#microsoft.graph.externalConnectors.externalItem" => new AITGraph.Sdk.Models.ExternalConnectors.ExternalItem(),
                "#microsoft.graph.externalConnectors.identity" => new AITGraph.Sdk.Models.ExternalConnectors.Identity(),
                "#microsoft.graph.externalConnectors.schema" => new AITGraph.Sdk.Models.ExternalConnectors.Schema(),
                ...
                "#microsoft.graph.identityGovernance.taskDefinition" => new TaskDefinition(),
                ...
                "#microsoft.graph.managedTenants.auditEvent" => new AITGraph.Sdk.Models.ManagedTenants.AuditEvent(),
                ...
                "#microsoft.graph.managedTenants.deviceCompliancePolicySettingStateSummary" => new AITGraph.Sdk.Models.ManagedTenants.DeviceCompliancePolicySettingStateSummary(),
                ...
                "#microsoft.graph.managedTenants.managementTemplate" => new ManagementTemplate(),
                ...
                "#microsoft.graph.managedTenants.windowsDeviceMalwareState" => new AITGraph.Sdk.Models.ManagedTenants.WindowsDeviceMalwareState(),
                "#microsoft.graph.managedTenants.windowsProtectionState" => new AITGraph.Sdk.Models.ManagedTenants.WindowsProtectionState(),
                ...
                "#microsoft.graph.security" => new AITGraph.Sdk.Models.Security.Security(),
                "#microsoft.graph.security.alert" => new AITGraph.Sdk.Models.Security.Alert(),
                "#microsoft.graph.security.case" => new AITGraph.Sdk.Models.Security.Case(),
                "#microsoft.graph.security.caseOperation" => new AITGraph.Sdk.Models.Security.CaseOperation(),
                "#microsoft.graph.security.casesRoot" => new CasesRoot(),
                "#microsoft.graph.security.dataSet" => new DataSet(),
                "#microsoft.graph.security.dataSource" => new AITGraph.Sdk.Models.Security.DataSource(),
                "#microsoft.graph.security.dataSourceContainer" => new AITGraph.Sdk.Models.Security.DataSourceContainer(),
                ...
                "#microsoft.graph.security.file" => new AITGraph.Sdk.Models.Security.FileObject(),
                ...
                "#microsoft.graph.security.informationProtection" => new AITGraph.Sdk.Models.Security.InformationProtection(),
                ...
                "#microsoft.graph.security.policyBase" => new AITGraph.Sdk.Models.Security.PolicyBase(),
                "#microsoft.graph.security.retentionEvent" => new RetentionEvent(),
                "#microsoft.graph.security.retentionEventType" => new RetentionEventType(),
                "#microsoft.graph.security.retentionLabel" => new RetentionLabel(),
                "#microsoft.graph.security.search" => new AITGraph.Sdk.Models.Security.Search(),
                "#microsoft.graph.security.security" => new AITGraph.Sdk.Models.Security.Security(),
                "#microsoft.graph.security.sensitivityLabel" => new AITGraph.Sdk.Models.Security.SensitivityLabel(),
                "#microsoft.graph.security.siteSource" => new AITGraph.Sdk.Models.Security.SiteSource(),
                "#microsoft.graph.security.tag" => new AITGraph.Sdk.Models.Security.Tag(),
                "#microsoft.graph.security.threatSubmission" => new ThreatSubmission(),
                ...
                "#microsoft.graph.security.unifiedGroupSource" => new AITGraph.Sdk.Models.Security.UnifiedGroupSource(),
                "#microsoft.graph.security.urlThreatSubmission" => new UrlThreatSubmission(),
                "#microsoft.graph.security.userSource" => new AITGraph.Sdk.Models.Security.UserSource(),
                ...
                "#microsoft.graph.tenantAdmin.settings" => new AITGraph.Sdk.Models.TenantAdmin.Settings(),
                "#microsoft.graph.tenantAdmin.sharepoint" => new Sharepoint(),
                ...
                "#microsoft.graph.termStore.group" => new AITGraph.Sdk.Models.TermStore.Group(),
                ...
                "#microsoft.graph.windowsUpdates.catalog" => new Catalog(),
                ...
                "#microsoft.graph.windowsUpdates.updatePolicy" => new UpdatePolicy(),
