...
namespace AITGraph.Sdk.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::AITGraph.Sdk.Models.RegistryHive? Hive { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.RegistryOperation? Operation { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.RegistryValueType? ValueType { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.RegistryKeyState"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.RegistryKeyState"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.RegistryKeyState CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.RegistryKeyState();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "hive", n => { Hive = n.GetEnumValue<global::AITGraph.Sdk.Models.RegistryHive>(); } },
                ...
                { "operation", n => { Operation = n.GetEnumValue<global::AITGraph.Sdk.Models.RegistryOperation>(); } },
                { "processId", n => { ProcessId = n.GetIntValue(); } },
                { "valueData", n => { ValueData = n.GetStringValue(); } },
                { "valueName", n => { ValueName = n.GetStringValue(); } },
                { "valueType", n => { ValueType = n.GetEnumValue<global::AITGraph.Sdk.Models.RegistryValueType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.RegistryHive>("hive", Hive);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.RegistryOperation>("operation", Operation);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.RegistryValueType>("valueType", ValueType);
