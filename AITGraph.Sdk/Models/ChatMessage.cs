...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.ChannelIdentity? ChannelIdentity { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.ChannelIdentity ChannelIdentity { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"channelIdentity", n => { ChannelIdentity = n.GetObjectValue<AITGraph.Sdk.Models.ChannelIdentity>(AITGraph.Sdk.Models.ChannelIdentity.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.ChannelIdentity>("channelIdentity", ChannelIdentity);
