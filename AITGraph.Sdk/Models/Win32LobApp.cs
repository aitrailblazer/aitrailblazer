...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class Win32LobApp : global::AITGraph.Sdk.Models.MobileLobApp, IParsable
    {
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.Win32LobAppDetection>? DetectionRules { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.Win32LobAppDetection> DetectionRules { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.Win32LobAppInstallExperience? InstallExperience { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.Win32LobAppInstallExperience InstallExperience { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.Win32LobAppMsiInformation? MsiInformation { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.Win32LobAppMsiInformation MsiInformation { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.Win32LobAppRequirement>? RequirementRules { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.Win32LobAppRequirement> RequirementRules { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.Win32LobAppReturnCode>? ReturnCodes { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.Win32LobAppReturnCode> ReturnCodes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.Win32LobAppRule>? Rules { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.Win32LobAppRule> Rules { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.Win32LobApp"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.Win32LobApp"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.Win32LobApp CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Win32LobApp();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "detectionRules", n => { DetectionRules = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.Win32LobAppDetection>(global::AITGraph.Sdk.Models.Win32LobAppDetection.CreateFromDiscriminatorValue)?.AsList(); } },
                { "displayVersion", n => { DisplayVersion = n.GetStringValue(); } },
                { "installCommandLine", n => { InstallCommandLine = n.GetStringValue(); } },
                { "installExperience", n => { InstallExperience = n.GetObjectValue<global::AITGraph.Sdk.Models.Win32LobAppInstallExperience>(global::AITGraph.Sdk.Models.Win32LobAppInstallExperience.CreateFromDiscriminatorValue); } },
                ...
                { "msiInformation", n => { MsiInformation = n.GetObjectValue<global::AITGraph.Sdk.Models.Win32LobAppMsiInformation>(global::AITGraph.Sdk.Models.Win32LobAppMsiInformation.CreateFromDiscriminatorValue); } },
                { "requirementRules", n => { RequirementRules = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.Win32LobAppRequirement>(global::AITGraph.Sdk.Models.Win32LobAppRequirement.CreateFromDiscriminatorValue)?.AsList(); } },
                { "returnCodes", n => { ReturnCodes = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.Win32LobAppReturnCode>(global::AITGraph.Sdk.Models.Win32LobAppReturnCode.CreateFromDiscriminatorValue)?.AsList(); } },
                { "rules", n => { Rules = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.Win32LobAppRule>(global::AITGraph.Sdk.Models.Win32LobAppRule.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.Win32LobAppDetection>("detectionRules", DetectionRules);
            writer.WriteStringValue("displayVersion", DisplayVersion);
            writer.WriteStringValue("installCommandLine", InstallCommandLine);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.Win32LobAppInstallExperience>("installExperience", InstallExperience);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.Win32LobAppMsiInformation>("msiInformation", MsiInformation);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.Win32LobAppRequirement>("requirementRules", RequirementRules);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.Win32LobAppReturnCode>("returnCodes", ReturnCodes);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.Win32LobAppRule>("rules", Rules);
