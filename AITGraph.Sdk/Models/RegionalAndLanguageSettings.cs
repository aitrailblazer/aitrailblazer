...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.RegionalFormatOverrides? RegionalFormatOverrides { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.RegionalFormatOverrides RegionalFormatOverrides { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.TranslationPreferences? TranslationPreferences { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.TranslationPreferences TranslationPreferences { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"regionalFormatOverrides", n => { RegionalFormatOverrides = n.GetObjectValue<AITGraph.Sdk.Models.RegionalFormatOverrides>(AITGraph.Sdk.Models.RegionalFormatOverrides.CreateFromDiscriminatorValue); } },
                {"translationPreferences", n => { TranslationPreferences = n.GetObjectValue<AITGraph.Sdk.Models.TranslationPreferences>(AITGraph.Sdk.Models.TranslationPreferences.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.RegionalFormatOverrides>("regionalFormatOverrides", RegionalFormatOverrides);
            writer.WriteObjectValue<AITGraph.Sdk.Models.TranslationPreferences>("translationPreferences", TranslationPreferences);
        }
    }
}
