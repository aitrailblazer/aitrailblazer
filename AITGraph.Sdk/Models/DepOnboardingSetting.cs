...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class DepOnboardingSetting : global::AITGraph.Sdk.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.DepIOSEnrollmentProfile? DefaultIosEnrollmentProfile { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.DepIOSEnrollmentProfile DefaultIosEnrollmentProfile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.DepMacOSEnrollmentProfile? DefaultMacOsEnrollmentProfile { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.DepMacOSEnrollmentProfile DefaultMacOsEnrollmentProfile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.EnrollmentProfile>? EnrollmentProfiles { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.EnrollmentProfile> EnrollmentProfiles { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.ImportedAppleDeviceIdentity>? ImportedAppleDeviceIdentities { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.ImportedAppleDeviceIdentity> ImportedAppleDeviceIdentities { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.DepTokenType? TokenType { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.DepOnboardingSetting"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.DepOnboardingSetting CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.DepOnboardingSetting();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "defaultIosEnrollmentProfile", n => { DefaultIosEnrollmentProfile = n.GetObjectValue<global::AITGraph.Sdk.Models.DepIOSEnrollmentProfile>(global::AITGraph.Sdk.Models.DepIOSEnrollmentProfile.CreateFromDiscriminatorValue); } },
                { "defaultMacOsEnrollmentProfile", n => { DefaultMacOsEnrollmentProfile = n.GetObjectValue<global::AITGraph.Sdk.Models.DepMacOSEnrollmentProfile>(global::AITGraph.Sdk.Models.DepMacOSEnrollmentProfile.CreateFromDiscriminatorValue); } },
                { "enrollmentProfiles", n => { EnrollmentProfiles = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.EnrollmentProfile>(global::AITGraph.Sdk.Models.EnrollmentProfile.CreateFromDiscriminatorValue)?.AsList(); } },
                { "importedAppleDeviceIdentities", n => { ImportedAppleDeviceIdentities = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.ImportedAppleDeviceIdentity>(global::AITGraph.Sdk.Models.ImportedAppleDeviceIdentity.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "tokenType", n => { TokenType = n.GetEnumValue<global::AITGraph.Sdk.Models.DepTokenType>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.DepIOSEnrollmentProfile>("defaultIosEnrollmentProfile", DefaultIosEnrollmentProfile);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.DepMacOSEnrollmentProfile>("defaultMacOsEnrollmentProfile", DefaultMacOsEnrollmentProfile);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.EnrollmentProfile>("enrollmentProfiles", EnrollmentProfiles);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.ImportedAppleDeviceIdentity>("importedAppleDeviceIdentities", ImportedAppleDeviceIdentities);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DepTokenType>("tokenType", TokenType);
        }
    }
}
