...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.MacOSSingleSignOnExtension? MacOSSingleSignOnExtension { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.MacOSSingleSignOnExtension MacOSSingleSignOnExtension { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.SingleSignOnExtension? SingleSignOnExtension { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.SingleSignOnExtension SingleSignOnExtension { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"macOSSingleSignOnExtension", n => { MacOSSingleSignOnExtension = n.GetObjectValue<AITGraph.Sdk.Models.MacOSSingleSignOnExtension>(AITGraph.Sdk.Models.MacOSSingleSignOnExtension.CreateFromDiscriminatorValue); } },
                ...
                {"singleSignOnExtension", n => { SingleSignOnExtension = n.GetObjectValue<AITGraph.Sdk.Models.SingleSignOnExtension>(AITGraph.Sdk.Models.SingleSignOnExtension.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.MacOSSingleSignOnExtension>("macOSSingleSignOnExtension", MacOSSingleSignOnExtension);
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.SingleSignOnExtension>("singleSignOnExtension", SingleSignOnExtension);
