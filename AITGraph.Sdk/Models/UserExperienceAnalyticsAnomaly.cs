...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class UserExperienceAnalyticsAnomaly : global::AITGraph.Sdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.UserExperienceAnalyticsAnomalyType? AnomalyType { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.UserExperienceAnalyticsAnomalySeverity? Severity { get; set; }
        /// <summary>Indicates the state of the anomaly. Eg: anomaly severity can be new, active, disabled, removed or other.</summary>
        public global::AITGraph.Sdk.Models.UserExperienceAnalyticsAnomalyState? State { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.UserExperienceAnalyticsAnomaly"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.UserExperienceAnalyticsAnomaly CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.UserExperienceAnalyticsAnomaly();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "anomalyType", n => { AnomalyType = n.GetEnumValue<global::AITGraph.Sdk.Models.UserExperienceAnalyticsAnomalyType>(); } },
                ...
                { "severity", n => { Severity = n.GetEnumValue<global::AITGraph.Sdk.Models.UserExperienceAnalyticsAnomalySeverity>(); } },
                { "state", n => { State = n.GetEnumValue<global::AITGraph.Sdk.Models.UserExperienceAnalyticsAnomalyState>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.UserExperienceAnalyticsAnomalyType>("anomalyType", AnomalyType);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.UserExperienceAnalyticsAnomalySeverity>("severity", Severity);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.UserExperienceAnalyticsAnomalyState>("state", State);
        }
    }
}
