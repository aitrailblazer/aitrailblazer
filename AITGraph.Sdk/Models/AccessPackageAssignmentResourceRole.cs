...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.AccessPackageResourceRole? AccessPackageResourceRole { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.AccessPackageResourceRole AccessPackageResourceRole { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.AccessPackageResourceScope? AccessPackageResourceScope { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.AccessPackageResourceScope AccessPackageResourceScope { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.AccessPackageSubject? AccessPackageSubject { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.AccessPackageSubject AccessPackageSubject { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"accessPackageResourceRole", n => { AccessPackageResourceRole = n.GetObjectValue<AITGraph.Sdk.Models.AccessPackageResourceRole>(AITGraph.Sdk.Models.AccessPackageResourceRole.CreateFromDiscriminatorValue); } },
                {"accessPackageResourceScope", n => { AccessPackageResourceScope = n.GetObjectValue<AITGraph.Sdk.Models.AccessPackageResourceScope>(AITGraph.Sdk.Models.AccessPackageResourceScope.CreateFromDiscriminatorValue); } },
                {"accessPackageSubject", n => { AccessPackageSubject = n.GetObjectValue<AITGraph.Sdk.Models.AccessPackageSubject>(AITGraph.Sdk.Models.AccessPackageSubject.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.AccessPackageResourceRole>("accessPackageResourceRole", AccessPackageResourceRole);
            writer.WriteObjectValue<AITGraph.Sdk.Models.AccessPackageResourceScope>("accessPackageResourceScope", AccessPackageResourceScope);
            writer.WriteObjectValue<AITGraph.Sdk.Models.AccessPackageSubject>("accessPackageSubject", AccessPackageSubject);
