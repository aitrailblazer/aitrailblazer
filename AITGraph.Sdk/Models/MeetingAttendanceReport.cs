...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class MeetingAttendanceReport : global::AITGraph.Sdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>List of attendance records of an attendance report. Read-only.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.AttendanceRecord>? AttendanceRecords { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.AttendanceRecord> AttendanceRecords { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.MeetingAttendanceReport"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.MeetingAttendanceReport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.MeetingAttendanceReport();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "attendanceRecords", n => { AttendanceRecords = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.AttendanceRecord>(global::AITGraph.Sdk.Models.AttendanceRecord.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.AttendanceRecord>("attendanceRecords", AttendanceRecords);
