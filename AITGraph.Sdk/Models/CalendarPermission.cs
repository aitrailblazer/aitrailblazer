...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.EmailAddress? EmailAddress { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.EmailAddress EmailAddress { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"emailAddress", n => { EmailAddress = n.GetObjectValue<AITGraph.Sdk.Models.EmailAddress>(AITGraph.Sdk.Models.EmailAddress.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.EmailAddress>("emailAddress", EmailAddress);
