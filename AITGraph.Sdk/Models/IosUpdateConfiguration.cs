...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class IosUpdateConfiguration : global::AITGraph.Sdk.Models.DeviceConfiguration, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.DayOfWeekObject?>? ScheduledInstallDays { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.DayOfWeekObject?> ScheduledInstallDays { get; set; }
#endif
        /// <summary>Update schedule type for iOS software updates.</summary>
        public global::AITGraph.Sdk.Models.IosSoftwareUpdateScheduleType? UpdateScheduleType { get; set; }
        /// <summary>UTC Time Offset indicated in minutes</summary>
        public int? UtcTimeOffsetInMinutes { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.IosUpdateConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.IosUpdateConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.IosUpdateConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.IosUpdateConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "scheduledInstallDays", n => { ScheduledInstallDays = n.GetCollectionOfEnumValues<global::AITGraph.Sdk.Models.DayOfWeekObject>()?.AsList(); } },
                { "updateScheduleType", n => { UpdateScheduleType = n.GetEnumValue<global::AITGraph.Sdk.Models.IosSoftwareUpdateScheduleType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::AITGraph.Sdk.Models.DayOfWeekObject>("scheduledInstallDays", ScheduledInstallDays);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.IosSoftwareUpdateScheduleType>("updateScheduleType", UpdateScheduleType);
