...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class DepIOSEnrollmentProfile : global::AITGraph.Sdk.Models.DepEnrollmentBaseProfile, IParsable
    {
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.ITunesPairingMode? ITunesPairingMode { get; set; }
        /// <summary>Management certificates for Apple Configurator</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.ManagementCertificateWithThumbprint>? ManagementCertificates { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.ManagementCertificateWithThumbprint> ManagementCertificates { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.DepIOSEnrollmentProfile"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.DepIOSEnrollmentProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.DepIOSEnrollmentProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.DepIOSEnrollmentProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "iTunesPairingMode", n => { ITunesPairingMode = n.GetEnumValue<global::AITGraph.Sdk.Models.ITunesPairingMode>(); } },
                { "managementCertificates", n => { ManagementCertificates = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.ManagementCertificateWithThumbprint>(global::AITGraph.Sdk.Models.ManagementCertificateWithThumbprint.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ITunesPairingMode>("iTunesPairingMode", ITunesPairingMode);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.ManagementCertificateWithThumbprint>("managementCertificates", ManagementCertificates);
