...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class RecordOperation : global::AITGraph.Sdk.Models.CommsOperation, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::AITGraph.Sdk.Models.RecordCompletionReason? CompletionReason { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.RecordOperation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.RecordOperation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.RecordOperation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "completionReason", n => { CompletionReason = n.GetEnumValue<global::AITGraph.Sdk.Models.RecordCompletionReason>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.RecordCompletionReason>("completionReason", CompletionReason);
