...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class WindowsKioskMultipleApps : global::AITGraph.Sdk.Models.WindowsKioskAppConfiguration, IParsable
    {
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.WindowsKioskAppBase>? Apps { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.WindowsKioskAppBase> Apps { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.WindowsKioskMultipleApps"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.WindowsKioskMultipleApps"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.WindowsKioskMultipleApps CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.WindowsKioskMultipleApps();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "apps", n => { Apps = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.WindowsKioskAppBase>(global::AITGraph.Sdk.Models.WindowsKioskAppBase.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.WindowsKioskAppBase>("apps", Apps);
