...
// email_plugin -> 
// get_recent_messages_async_ai GetRecentMessagesAsync EmailViewBasicModel ->
// ShowEmailsAsync -> PureEmailResult

// User --> GetRecentMessagesPureEmailViewBasicModelAsync
// EmailViewBasicPureConstructorModel
...
public sealed class EmailResult
{
    ...
    /// </summary>
    [JsonProperty("emails")]
    public List<EmailViewBasicModel> Emails { get; set; } = new List<EmailViewBasicModel>();
}

/// <summary>
/// Represents a basic email view model.
/// </summary>
public class EmailViewBasicModel
{
    [JsonProperty("id")]
    ...
    // Constructors
    public EmailViewBasicModel() { }

    public EmailViewBasicModel(Message message)
    {
        if (message == null)
        {
    ...
    private string LimitTextToLinesAndCharacters(string text, int maxLines, int maxChars)
    {
        ...
        // Limit lines to the maxLines number
        var limitedLines = lines.Take(maxLines).ToList();

        // Join lines back into a string and limit characters to maxChars
        var result = string.Join(Environment.NewLine, limitedLines);

        // Ensure the result does not exceed maxChars
...
/// <summary>
/// Represents recipient information.
/// </summary>
public class RecipientInfo
{
    ...
    // Parameterless constructor for scenarios where recipient is null
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RecipientInfo"/> class using a <see cref="Recipient"/> object.
    /// </summary>
    ...
    public RecipientInfo(Recipient? recipient)
    {
        ...
        {
            Name = recipient.EmailAddress.Name ?? string.Empty;
            EmailAddress = recipient.EmailAddress.Address ?? string.Empty;
        }
    }
}
