...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class ProtectOnlineMeetingAction : global::AITGraph.Sdk.Models.LabelActionBase, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The allowedForwarders property</summary>
        public global::AITGraph.Sdk.Models.OnlineMeetingForwarders? AllowedForwarders { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.ProtectOnlineMeetingAction"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.ProtectOnlineMeetingAction"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.ProtectOnlineMeetingAction CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.ProtectOnlineMeetingAction();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedForwarders", n => { AllowedForwarders = n.GetEnumValue<global::AITGraph.Sdk.Models.OnlineMeetingForwarders>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.OnlineMeetingForwarders>("allowedForwarders", AllowedForwarders);
