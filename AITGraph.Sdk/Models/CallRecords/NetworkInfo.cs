...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.CallRecords.NetworkConnectionType? ConnectionType { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.CallRecords.NetworkTransportProtocol? NetworkTransportProtocol { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.CallRecords.TraceRouteHop>? TraceRouteHops { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.CallRecords.TraceRouteHop> TraceRouteHops { get; set; }
#endif
        /// <summary>The wifiBand property</summary>
        public global::AITGraph.Sdk.Models.CallRecords.WifiBand? WifiBand { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.CallRecords.WifiRadioType? WifiRadioType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.CallRecords.NetworkInfo"/> and sets the default values.
        /// </summary>
        public NetworkInfo()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.CallRecords.NetworkInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.CallRecords.NetworkInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.CallRecords.NetworkInfo();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "connectionType", n => { ConnectionType = n.GetEnumValue<global::AITGraph.Sdk.Models.CallRecords.NetworkConnectionType>(); } },
                ...
                { "networkTransportProtocol", n => { NetworkTransportProtocol = n.GetEnumValue<global::AITGraph.Sdk.Models.CallRecords.NetworkTransportProtocol>(); } },
                ...
                { "traceRouteHops", n => { TraceRouteHops = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.CallRecords.TraceRouteHop>(global::AITGraph.Sdk.Models.CallRecords.TraceRouteHop.CreateFromDiscriminatorValue)?.AsList(); } },
                { "wifiBand", n => { WifiBand = n.GetEnumValue<global::AITGraph.Sdk.Models.CallRecords.WifiBand>(); } },
                ...
                { "wifiRadioType", n => { WifiRadioType = n.GetEnumValue<global::AITGraph.Sdk.Models.CallRecords.WifiRadioType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.CallRecords.NetworkConnectionType>("connectionType", ConnectionType);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.CallRecords.NetworkTransportProtocol>("networkTransportProtocol", NetworkTransportProtocol);
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.CallRecords.TraceRouteHop>("traceRouteHops", TraceRouteHops);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.CallRecords.WifiBand>("wifiBand", WifiBand);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.CallRecords.WifiRadioType>("wifiRadioType", WifiRadioType);
