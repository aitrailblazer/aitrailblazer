...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.LoginPageLayoutConfiguration? LoginPageLayoutConfiguration { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.LoginPageLayoutConfiguration LoginPageLayoutConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.LoginPageTextVisibilitySettings? LoginPageTextVisibilitySettings { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.LoginPageTextVisibilitySettings LoginPageTextVisibilitySettings { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"loginPageLayoutConfiguration", n => { LoginPageLayoutConfiguration = n.GetObjectValue<AITGraph.Sdk.Models.LoginPageLayoutConfiguration>(AITGraph.Sdk.Models.LoginPageLayoutConfiguration.CreateFromDiscriminatorValue); } },
                {"loginPageTextVisibilitySettings", n => { LoginPageTextVisibilitySettings = n.GetObjectValue<AITGraph.Sdk.Models.LoginPageTextVisibilitySettings>(AITGraph.Sdk.Models.LoginPageTextVisibilitySettings.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.LoginPageLayoutConfiguration>("loginPageLayoutConfiguration", LoginPageLayoutConfiguration);
            writer.WriteObjectValue<AITGraph.Sdk.Models.LoginPageTextVisibilitySettings>("loginPageTextVisibilitySettings", LoginPageTextVisibilitySettings);
