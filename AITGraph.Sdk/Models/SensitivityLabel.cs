...
namespace AITGraph.Sdk.Models {
    public class SensitivityLabel : Entity, IParsable {
        ...
        public AITGraph.Sdk.Models.ApplicationMode? ApplicationMode { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AITGraph.Sdk.Models.AutoLabeling? AutoLabeling { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.AutoLabeling AutoLabeling { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"autoLabeling", n => { AutoLabeling = n.GetObjectValue<AITGraph.Sdk.Models.AutoLabeling>(AITGraph.Sdk.Models.AutoLabeling.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.AutoLabeling>("autoLabeling", AutoLabeling);
