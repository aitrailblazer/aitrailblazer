...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class DeviceManagementConfigurationPolicyTemplate : global::AITGraph.Sdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.DeviceManagementTemplateLifecycleState? LifecycleState { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.DeviceManagementConfigurationSettingTemplate>? SettingTemplates { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.DeviceManagementConfigurationSettingTemplate> SettingTemplates { get; set; }
#endif
        ...
        public global::AITGraph.Sdk.Models.DeviceManagementConfigurationTemplateFamily? TemplateFamily { get; set; }
        /// <summary>Template version. Valid values 1 to 2147483647. This property is read-only.</summary>
        public int? Version { get; private set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.DeviceManagementConfigurationPolicyTemplate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.DeviceManagementConfigurationPolicyTemplate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.DeviceManagementConfigurationPolicyTemplate();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "lifecycleState", n => { LifecycleState = n.GetEnumValue<global::AITGraph.Sdk.Models.DeviceManagementTemplateLifecycleState>(); } },
                ...
                { "settingTemplates", n => { SettingTemplates = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.DeviceManagementConfigurationSettingTemplate>(global::AITGraph.Sdk.Models.DeviceManagementConfigurationSettingTemplate.CreateFromDiscriminatorValue)?.AsList(); } },
                { "technologies", n => { Technologies = n.GetEnumValue<global::AITGraph.Sdk.Models.DeviceManagementConfigurationTechnologies>(); } },
                { "templateFamily", n => { TemplateFamily = n.GetEnumValue<global::AITGraph.Sdk.Models.DeviceManagementConfigurationTemplateFamily>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceManagementTemplateLifecycleState>("lifecycleState", LifecycleState);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceManagementConfigurationPlatforms>("platforms", Platforms);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.DeviceManagementConfigurationSettingTemplate>("settingTemplates", SettingTemplates);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceManagementConfigurationTechnologies>("technologies", Technologies);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.DeviceManagementConfigurationTemplateFamily>("templateFamily", TemplateFamily);
        }
    }
}
