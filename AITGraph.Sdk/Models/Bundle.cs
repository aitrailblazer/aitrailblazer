...
#nullable enable
        public AITGraph.Sdk.Models.Album? Album { get; set; }
#nullable restore
#else
        public AITGraph.Sdk.Models.Album Album { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"album", n => { Album = n.GetObjectValue<AITGraph.Sdk.Models.Album>(AITGraph.Sdk.Models.Album.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AITGraph.Sdk.Models.Album>("album", Album);
