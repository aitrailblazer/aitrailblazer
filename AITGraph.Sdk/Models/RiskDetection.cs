...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class RiskDetection : global::AITGraph.Sdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::AITGraph.Sdk.Models.ActivityType? Activity { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.RiskDetectionTimingType? DetectionTimingType { get; set; }
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.RiskLevel? RiskLevel { get; set; }
        ...
        public global::AITGraph.Sdk.Models.RiskEventType? RiskType { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.RiskDetection"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.RiskDetection CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.RiskDetection();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "activity", n => { Activity = n.GetEnumValue<global::AITGraph.Sdk.Models.ActivityType>(); } },
                ...
                { "detectionTimingType", n => { DetectionTimingType = n.GetEnumValue<global::AITGraph.Sdk.Models.RiskDetectionTimingType>(); } },
                ...
                { "riskLevel", n => { RiskLevel = n.GetEnumValue<global::AITGraph.Sdk.Models.RiskLevel>(); } },
                { "riskState", n => { RiskState = n.GetEnumValue<global::AITGraph.Sdk.Models.RiskState>(); } },
                { "riskType", n => { RiskType = n.GetEnumValue<global::AITGraph.Sdk.Models.RiskEventType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.ActivityType>("activity", Activity);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.RiskDetectionTimingType>("detectionTimingType", DetectionTimingType);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.RiskLevel>("riskLevel", RiskLevel);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.RiskState>("riskState", RiskState);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.RiskEventType>("riskType", RiskType);
