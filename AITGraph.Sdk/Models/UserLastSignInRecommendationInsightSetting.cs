...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class UserLastSignInRecommendationInsightSetting : global::AITGraph.Sdk.Models.AccessReviewRecommendationInsightSetting, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::AITGraph.Sdk.Models.UserSignInRecommendationScope? SignInScope { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.UserLastSignInRecommendationInsightSetting"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.UserLastSignInRecommendationInsightSetting"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.UserLastSignInRecommendationInsightSetting CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.UserLastSignInRecommendationInsightSetting();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "signInScope", n => { SignInScope = n.GetEnumValue<global::AITGraph.Sdk.Models.UserSignInRecommendationScope>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.UserSignInRecommendationScope>("signInScope", SignInScope);
        }
    }
}
