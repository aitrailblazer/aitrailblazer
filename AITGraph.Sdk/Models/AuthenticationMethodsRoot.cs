...
#nullable enable
        public List<AITGraph.Sdk.Models.UserRegistrationDetails>? UserRegistrationDetails { get; set; }
#nullable restore
#else
        public List<AITGraph.Sdk.Models.UserRegistrationDetails> UserRegistrationDetails { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"userRegistrationDetails", n => { UserRegistrationDetails = n.GetCollectionOfObjectValues<AITGraph.Sdk.Models.UserRegistrationDetails>(AITGraph.Sdk.Models.UserRegistrationDetails.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<AITGraph.Sdk.Models.UserRegistrationDetails>("userRegistrationDetails", UserRegistrationDetails);
        }
    }
}
