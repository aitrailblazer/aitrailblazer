...
namespace AITGraph.Sdk.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::AITGraph.Sdk.Models.BroadcastMeetingAudience? AllowedAudience { get; set; }
        /// <summary>Caption settings of a Teams live event.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.BroadcastMeetingCaptionSettings? Captions { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.BroadcastMeetingCaptionSettings Captions { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.BroadcastMeetingSettings"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.BroadcastMeetingSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.BroadcastMeetingSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.BroadcastMeetingSettings();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedAudience", n => { AllowedAudience = n.GetEnumValue<global::AITGraph.Sdk.Models.BroadcastMeetingAudience>(); } },
                { "captions", n => { Captions = n.GetObjectValue<global::AITGraph.Sdk.Models.BroadcastMeetingCaptionSettings>(global::AITGraph.Sdk.Models.BroadcastMeetingCaptionSettings.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.BroadcastMeetingAudience>("allowedAudience", AllowedAudience);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.BroadcastMeetingCaptionSettings>("captions", Captions);
