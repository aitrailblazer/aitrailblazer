...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class Calendar : global::AITGraph.Sdk.Models.Entity, IParsable
...
#nullable enable
        public List<global::AITGraph.Sdk.Models.OnlineMeetingProviderType?>? AllowedOnlineMeetingProviders { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.OnlineMeetingProviderType?> AllowedOnlineMeetingProviders { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.CalendarPermission>? CalendarPermissions { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.CalendarPermission> CalendarPermissions { get; set; }
#endif
...
#nullable restore
        ...
        public global::AITGraph.Sdk.Models.CalendarColor? Color { get; set; }
        ...
        public global::AITGraph.Sdk.Models.OnlineMeetingProviderType? DefaultOnlineMeetingProvider { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.EmailAddress? Owner { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.EmailAddress Owner { get; set; }
#endif
...
#nullable restore
        ...
        public static new global::AITGraph.Sdk.Models.Calendar CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.Calendar();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedOnlineMeetingProviders", n => { AllowedOnlineMeetingProviders = n.GetCollectionOfEnumValues<global::AITGraph.Sdk.Models.OnlineMeetingProviderType>()?.AsList(); } },
                { "calendarGroupId", n => { CalendarGroupId = n.GetStringValue(); } },
                { "calendarPermissions", n => { CalendarPermissions = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.CalendarPermission>(global::AITGraph.Sdk.Models.CalendarPermission.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "color", n => { Color = n.GetEnumValue<global::AITGraph.Sdk.Models.CalendarColor>(); } },
                { "defaultOnlineMeetingProvider", n => { DefaultOnlineMeetingProvider = n.GetEnumValue<global::AITGraph.Sdk.Models.OnlineMeetingProviderType>(); } },
                ...
                { "owner", n => { Owner = n.GetObjectValue<global::AITGraph.Sdk.Models.EmailAddress>(global::AITGraph.Sdk.Models.EmailAddress.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::AITGraph.Sdk.Models.OnlineMeetingProviderType>("allowedOnlineMeetingProviders", AllowedOnlineMeetingProviders);
            writer.WriteStringValue("calendarGroupId", CalendarGroupId);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.CalendarPermission>("calendarPermissions", CalendarPermissions);
            ...
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.CalendarColor>("color", Color);
            writer.WriteEnumValue<global::AITGraph.Sdk.Models.OnlineMeetingProviderType>("defaultOnlineMeetingProvider", DefaultOnlineMeetingProvider);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.EmailAddress>("owner", Owner);
