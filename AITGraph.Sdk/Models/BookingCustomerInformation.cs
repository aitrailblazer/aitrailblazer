...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class BookingCustomerInformation : global::AITGraph.Sdk.Models.BookingCustomerInformationBase, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.BookingQuestionAnswer>? CustomQuestionAnswers { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.BookingQuestionAnswer> CustomQuestionAnswers { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.BookingCustomerInformation"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.BookingCustomerInformation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.BookingCustomerInformation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.BookingCustomerInformation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "customQuestionAnswers", n => { CustomQuestionAnswers = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.BookingQuestionAnswer>(global::AITGraph.Sdk.Models.BookingQuestionAnswer.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.BookingQuestionAnswer>("customQuestionAnswers", CustomQuestionAnswers);
