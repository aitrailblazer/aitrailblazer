...
namespace AITGraph.Sdk.Models
{
    ...
    public partial class AndroidEnterpriseWiFiConfiguration : global::AITGraph.Sdk.Models.AndroidWiFiConfiguration, IParsable
    {
...
#nullable enable
        public global::AITGraph.Sdk.Models.AndroidCertificateProfileBase? IdentityCertificateForClientAuthentication { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AndroidCertificateProfileBase IdentityCertificateForClientAuthentication { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.AndroidTrustedRootCertificate? RootCertificateForServerValidation { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AndroidTrustedRootCertificate RootCertificateForServerValidation { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.AndroidEnterpriseWiFiConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.AndroidEnterpriseWiFiConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::AITGraph.Sdk.Models.AndroidEnterpriseWiFiConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.AndroidEnterpriseWiFiConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "identityCertificateForClientAuthentication", n => { IdentityCertificateForClientAuthentication = n.GetObjectValue<global::AITGraph.Sdk.Models.AndroidCertificateProfileBase>(global::AITGraph.Sdk.Models.AndroidCertificateProfileBase.CreateFromDiscriminatorValue); } },
                ...
                { "rootCertificateForServerValidation", n => { RootCertificateForServerValidation = n.GetObjectValue<global::AITGraph.Sdk.Models.AndroidTrustedRootCertificate>(global::AITGraph.Sdk.Models.AndroidTrustedRootCertificate.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AndroidCertificateProfileBase>("identityCertificateForClientAuthentication", IdentityCertificateForClientAuthentication);
            ...
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AndroidTrustedRootCertificate>("rootCertificateForServerValidation", RootCertificateForServerValidation);
