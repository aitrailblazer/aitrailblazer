...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.UserSimulationEventInfo>? SimulationEvents { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.UserSimulationEventInfo> SimulationEvents { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AITGraph.Sdk.Models.AttackSimulationUser? SimulationUser { get; set; }
#nullable restore
#else
        public global::AITGraph.Sdk.Models.AttackSimulationUser SimulationUser { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AITGraph.Sdk.Models.UserTrainingEventInfo>? TrainingEvents { get; set; }
#nullable restore
#else
        public List<global::AITGraph.Sdk.Models.UserTrainingEventInfo> TrainingEvents { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::AITGraph.Sdk.Models.UserSimulationDetails"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::AITGraph.Sdk.Models.UserSimulationDetails"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AITGraph.Sdk.Models.UserSimulationDetails CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AITGraph.Sdk.Models.UserSimulationDetails();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "simulationEvents", n => { SimulationEvents = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.UserSimulationEventInfo>(global::AITGraph.Sdk.Models.UserSimulationEventInfo.CreateFromDiscriminatorValue)?.AsList(); } },
                { "simulationUser", n => { SimulationUser = n.GetObjectValue<global::AITGraph.Sdk.Models.AttackSimulationUser>(global::AITGraph.Sdk.Models.AttackSimulationUser.CreateFromDiscriminatorValue); } },
                { "trainingEvents", n => { TrainingEvents = n.GetCollectionOfObjectValues<global::AITGraph.Sdk.Models.UserTrainingEventInfo>(global::AITGraph.Sdk.Models.UserTrainingEventInfo.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.UserSimulationEventInfo>("simulationEvents", SimulationEvents);
            writer.WriteObjectValue<global::AITGraph.Sdk.Models.AttackSimulationUser>("simulationUser", SimulationUser);
            writer.WriteCollectionOfObjectValues<global::AITGraph.Sdk.Models.UserTrainingEventInfo>("trainingEvents", TrainingEvents);
