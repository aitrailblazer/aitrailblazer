...
namespace AITGraph.Sdk.Models {
    ...
    /// </summary>
    public class DeviceManagementConfigurationChoiceSettingValueDefinitionTemplate : IAdditionalDataHolder, IParsable {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Choice Setting Allowed Options</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<DeviceManagementConfigurationOptionDefinitionTemplate>? AllowedOptions { get; set; }
#nullable restore
#else
        public List<DeviceManagementConfigurationOptionDefinitionTemplate> AllowedOptions { get; set; }
#endif
